...
public class __darwin_pthread_handler_rec {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        cgl_h.C_POINTER.withName("__routine"),
        cgl_h.C_POINTER.withName("__arg"),
        cgl_h.C_POINTER.withName("__next")
    ...
    public static class __routine {
        ...
        private static final MethodHandle UP$MH = cgl_h.upcallHandle(__routine.Function.class, "apply", $DESC);
