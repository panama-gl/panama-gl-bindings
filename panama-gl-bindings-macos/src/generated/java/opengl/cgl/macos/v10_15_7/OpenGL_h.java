...
public class OpenGL_h  {

    static {
        System.loadLibrary("GL");
    }

    static final SymbolLookup LIBRARIES = RuntimeHelper.lookup();    /* package-private */ OpenGL_h() {}
    ...
    public static int CGLSetCurrentContext ( Addressable ctx) {
        var mh$ = RuntimeHelper.requireNonNull(constants$0.CGLSetCurrentContext$MH, "CGLSetCurrentContext");
        try {
    ...
    public static MemoryAddress CGLGetCurrentContext () {
        var mh$ = RuntimeHelper.requireNonNull(constants$0.CGLGetCurrentContext$MH, "CGLGetCurrentContext");
        try {
    ...
    public static MemoryAddress CGLGetShareGroup ( Addressable ctx) {
        var mh$ = RuntimeHelper.requireNonNull(constants$0.CGLGetShareGroup$MH, "CGLGetShareGroup");
        try {
    ...
    public static MemoryAddress CGLGetDeviceFromGLRenderer ( int rendererID) {
        var mh$ = RuntimeHelper.requireNonNull(constants$0.CGLGetDeviceFromGLRenderer$MH, "CGLGetDeviceFromGLRenderer");
        try {
            return (jdk.incubator.foreign.MemoryAddress)mh$.invokeExact(rendererID);
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
        }
    }
    ...
    public static int CGLTexImageIOSurface2D ( Addressable ctx,  int target,  int internal_format,  int width,  int height,  int format,  int type,  Addressable ioSurface,  int plane) {
        var mh$ = RuntimeHelper.requireNonNull(constants$0.CGLTexImageIOSurface2D$MH, "CGLTexImageIOSurface2D");
        try {
            return (int)mh$.invokeExact(ctx.address(), target, internal_format, width, height, format, type, ioSurface.address(), plane);
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
        }
    }
    ...
    public static int CGLChoosePixelFormat ( Addressable attribs,  Addressable pix,  Addressable npix) {
        var mh$ = RuntimeHelper.requireNonNull(constants$0.CGLChoosePixelFormat$MH, "CGLChoosePixelFormat");
        try {
            return (int)mh$.invokeExact(attribs.address(), pix.address(), npix.address());
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
        }
    }
    ...
    public static int CGLDestroyPixelFormat ( Addressable pix) {
        var mh$ = RuntimeHelper.requireNonNull(constants$1.CGLDestroyPixelFormat$MH, "CGLDestroyPixelFormat");
        try {
            return (int)mh$.invokeExact(pix.address());
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
        }
    }
    ...
    public static int CGLDescribePixelFormat ( Addressable pix,  int pix_num,  int attrib,  Addressable value) {
        var mh$ = RuntimeHelper.requireNonNull(constants$1.CGLDescribePixelFormat$MH, "CGLDescribePixelFormat");
        try {
            return (int)mh$.invokeExact(pix.address(), pix_num, attrib, value.address());
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
        }
    }
    ...
    public static void CGLReleasePixelFormat ( Addressable pix) {
        var mh$ = RuntimeHelper.requireNonNull(constants$1.CGLReleasePixelFormat$MH, "CGLReleasePixelFormat");
        try {
            mh$.invokeExact(pix.address());
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
        }
    }
    ...
    public static MemoryAddress CGLRetainPixelFormat ( Addressable pix) {
        var mh$ = RuntimeHelper.requireNonNull(constants$1.CGLRetainPixelFormat$MH, "CGLRetainPixelFormat");
        try {
            return (jdk.incubator.foreign.MemoryAddress)mh$.invokeExact(pix.address());
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
        }
    }
    ...
    public static int CGLGetPixelFormatRetainCount ( Addressable pix) {
        var mh$ = RuntimeHelper.requireNonNull(constants$1.CGLGetPixelFormatRetainCount$MH, "CGLGetPixelFormatRetainCount");
        try {
            return (int)mh$.invokeExact(pix.address());
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
    ...
    public static int CGLQueryRendererInfo ( int display_mask,  Addressable rend,  Addressable nrend) {
        var mh$ = RuntimeHelper.requireNonNull(constants$1.CGLQueryRendererInfo$MH, "CGLQueryRendererInfo");
        try {
            return (int)mh$.invokeExact(display_mask, rend.address(), nrend.address());
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
        }
    }
    ...
    public static int CGLDestroyRendererInfo ( Addressable rend) {
        var mh$ = RuntimeHelper.requireNonNull(constants$2.CGLDestroyRendererInfo$MH, "CGLDestroyRendererInfo");
        try {
            return (int)mh$.invokeExact(rend.address());
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
        }
    }
    ...
    public static int CGLDescribeRenderer ( Addressable rend,  int rend_num,  int prop,  Addressable value) {
        var mh$ = RuntimeHelper.requireNonNull(constants$2.CGLDescribeRenderer$MH, "CGLDescribeRenderer");
        try {
            return (int)mh$.invokeExact(rend.address(), rend_num, prop, value.address());
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
        }
    }
    ...
    public static int CGLCreateContext ( Addressable pix,  Addressable share,  Addressable ctx) {
        var mh$ = RuntimeHelper.requireNonNull(constants$2.CGLCreateContext$MH, "CGLCreateContext");
        try {
            return (int)mh$.invokeExact(pix.address(), share.address(), ctx.address());
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
        }
    }
    ...
    public static int CGLDestroyContext ( Addressable ctx) {
        var mh$ = RuntimeHelper.requireNonNull(constants$2.CGLDestroyContext$MH, "CGLDestroyContext");
        try {
            return (int)mh$.invokeExact(ctx.address());
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
    ...
    public static int CGLCopyContext ( Addressable src,  Addressable dst,  int mask) {
        var mh$ = RuntimeHelper.requireNonNull(constants$2.CGLCopyContext$MH, "CGLCopyContext");
        try {
            return (int)mh$.invokeExact(src.address(), dst.address(), mask);
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
        }
    }
    ...
    public static MemoryAddress CGLRetainContext ( Addressable ctx) {
        var mh$ = RuntimeHelper.requireNonNull(constants$2.CGLRetainContext$MH, "CGLRetainContext");
        try {
            return (jdk.incubator.foreign.MemoryAddress)mh$.invokeExact(ctx.address());
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
    ...
    public static void CGLReleaseContext ( Addressable ctx) {
        var mh$ = RuntimeHelper.requireNonNull(constants$3.CGLReleaseContext$MH, "CGLReleaseContext");
        try {
    ...
    public static int CGLGetContextRetainCount ( Addressable ctx) {
        var mh$ = RuntimeHelper.requireNonNull(constants$3.CGLGetContextRetainCount$MH, "CGLGetContextRetainCount");
        try {
            return (int)mh$.invokeExact(ctx.address());
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
    ...
    public static MemoryAddress CGLGetPixelFormat ( Addressable ctx) {
        var mh$ = RuntimeHelper.requireNonNull(constants$3.CGLGetPixelFormat$MH, "CGLGetPixelFormat");
        try {
            return (jdk.incubator.foreign.MemoryAddress)mh$.invokeExact(ctx.address());
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
    ...
    public static int CGLCreatePBuffer ( int width,  int height,  int target,  int internalFormat,  int max_level,  Addressable pbuffer) {
        var mh$ = RuntimeHelper.requireNonNull(constants$3.CGLCreatePBuffer$MH, "CGLCreatePBuffer");
        try {
            return (int)mh$.invokeExact(width, height, target, internalFormat, max_level, pbuffer.address());
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
        }
    }
    ...
    public static int CGLDestroyPBuffer ( Addressable pbuffer) {
        var mh$ = RuntimeHelper.requireNonNull(constants$3.CGLDestroyPBuffer$MH, "CGLDestroyPBuffer");
        try {
            return (int)mh$.invokeExact(pbuffer.address());
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
        }
    }
    ...
    public static int CGLDescribePBuffer ( Addressable obj,  Addressable width,  Addressable height,  Addressable target,  Addressable internalFormat,  Addressable mipmap) {
        var mh$ = RuntimeHelper.requireNonNull(constants$3.CGLDescribePBuffer$MH, "CGLDescribePBuffer");
        try {
            return (int)mh$.invokeExact(obj.address(), width.address(), height.address(), target.address(), internalFormat.address(), mipmap.address());
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
        }
    }
    ...
    public static int CGLTexImagePBuffer ( Addressable ctx,  Addressable pbuffer,  int source) {
        var mh$ = RuntimeHelper.requireNonNull(constants$4.CGLTexImagePBuffer$MH, "CGLTexImagePBuffer");
        try {
            return (int)mh$.invokeExact(ctx.address(), pbuffer.address(), source);
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
        }
    }
    ...
    public static MemoryAddress CGLRetainPBuffer ( Addressable pbuffer) {
        var mh$ = RuntimeHelper.requireNonNull(constants$4.CGLRetainPBuffer$MH, "CGLRetainPBuffer");
        try {
            return (jdk.incubator.foreign.MemoryAddress)mh$.invokeExact(pbuffer.address());
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
        }
    }
    ...
    public static void CGLReleasePBuffer ( Addressable pbuffer) {
        var mh$ = RuntimeHelper.requireNonNull(constants$4.CGLReleasePBuffer$MH, "CGLReleasePBuffer");
        try {
            mh$.invokeExact(pbuffer.address());
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
        }
    }
    ...
    public static int CGLGetPBufferRetainCount ( Addressable pbuffer) {
        var mh$ = RuntimeHelper.requireNonNull(constants$4.CGLGetPBufferRetainCount$MH, "CGLGetPBufferRetainCount");
        try {
            return (int)mh$.invokeExact(pbuffer.address());
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
    ...
    public static int CGLSetOffScreen ( Addressable ctx,  int width,  int height,  int rowbytes,  Addressable baseaddr) {
        var mh$ = RuntimeHelper.requireNonNull(constants$4.CGLSetOffScreen$MH, "CGLSetOffScreen");
        try {
            return (int)mh$.invokeExact(ctx.address(), width, height, rowbytes, baseaddr.address());
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
        }
    }
    ...
    public static int CGLGetOffScreen ( Addressable ctx,  Addressable width,  Addressable height,  Addressable rowbytes,  Addressable baseaddr) {
        var mh$ = RuntimeHelper.requireNonNull(constants$4.CGLGetOffScreen$MH, "CGLGetOffScreen");
        try {
            return (int)mh$.invokeExact(ctx.address(), width.address(), height.address(), rowbytes.address(), baseaddr.address());
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
        }
    }
    ...
    public static int CGLSetFullScreen ( Addressable ctx) {
        var mh$ = RuntimeHelper.requireNonNull(constants$5.CGLSetFullScreen$MH, "CGLSetFullScreen");
        try {
            return (int)mh$.invokeExact(ctx.address());
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
    ...
    public static int CGLSetFullScreenOnDisplay ( Addressable ctx,  int display_mask) {
        var mh$ = RuntimeHelper.requireNonNull(constants$5.CGLSetFullScreenOnDisplay$MH, "CGLSetFullScreenOnDisplay");
        try {
            return (int)mh$.invokeExact(ctx.address(), display_mask);
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
        }
    }
    ...
    public static int CGLSetPBuffer ( Addressable ctx,  Addressable pbuffer,  int face,  int level,  int screen) {
        var mh$ = RuntimeHelper.requireNonNull(constants$5.CGLSetPBuffer$MH, "CGLSetPBuffer");
        try {
            return (int)mh$.invokeExact(ctx.address(), pbuffer.address(), face, level, screen);
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
        }
    }
    ...
    public static int CGLGetPBuffer ( Addressable ctx,  Addressable pbuffer,  Addressable face,  Addressable level,  Addressable screen) {
        var mh$ = RuntimeHelper.requireNonNull(constants$5.CGLGetPBuffer$MH, "CGLGetPBuffer");
        try {
            return (int)mh$.invokeExact(ctx.address(), pbuffer.address(), face.address(), level.address(), screen.address());
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
        }
    }
    ...
    public static int CGLClearDrawable ( Addressable ctx) {
        var mh$ = RuntimeHelper.requireNonNull(constants$5.CGLClearDrawable$MH, "CGLClearDrawable");
        try {
            return (int)mh$.invokeExact(ctx.address());
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
    ...
    public static int CGLFlushDrawable ( Addressable ctx) {
        var mh$ = RuntimeHelper.requireNonNull(constants$5.CGLFlushDrawable$MH, "CGLFlushDrawable");
        try {
            return (int)mh$.invokeExact(ctx.address());
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
    ...
    public static int CGLEnable ( Addressable ctx,  int pname) {
        var mh$ = RuntimeHelper.requireNonNull(constants$6.CGLEnable$MH, "CGLEnable");
        try {
            return (int)mh$.invokeExact(ctx.address(), pname);
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
        }
    }
    ...
    public static int CGLDisable ( Addressable ctx,  int pname) {
        var mh$ = RuntimeHelper.requireNonNull(constants$6.CGLDisable$MH, "CGLDisable");
        try {
            return (int)mh$.invokeExact(ctx.address(), pname);
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
    ...
    public static int CGLIsEnabled ( Addressable ctx,  int pname,  Addressable enable) {
        var mh$ = RuntimeHelper.requireNonNull(constants$6.CGLIsEnabled$MH, "CGLIsEnabled");
        try {
            return (int)mh$.invokeExact(ctx.address(), pname, enable.address());
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
        }
    }
    ...
    public static int CGLSetParameter ( Addressable ctx,  int pname,  Addressable params) {
        var mh$ = RuntimeHelper.requireNonNull(constants$6.CGLSetParameter$MH, "CGLSetParameter");
        try {
            return (int)mh$.invokeExact(ctx.address(), pname, params.address());
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
        }
    }
    ...
    public static int CGLGetParameter ( Addressable ctx,  int pname,  Addressable params) {
        var mh$ = RuntimeHelper.requireNonNull(constants$6.CGLGetParameter$MH, "CGLGetParameter");
        try {
            return (int)mh$.invokeExact(ctx.address(), pname, params.address());
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
    ...
    public static int CGLSetVirtualScreen ( Addressable ctx,  int screen) {
        var mh$ = RuntimeHelper.requireNonNull(constants$6.CGLSetVirtualScreen$MH, "CGLSetVirtualScreen");
        try {
            return (int)mh$.invokeExact(ctx.address(), screen);
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
        }
    }
    ...
    public static int CGLGetVirtualScreen ( Addressable ctx,  Addressable screen) {
        var mh$ = RuntimeHelper.requireNonNull(constants$7.CGLGetVirtualScreen$MH, "CGLGetVirtualScreen");
        try {
            return (int)mh$.invokeExact(ctx.address(), screen.address());
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
        }
    }
    ...
    public static int CGLUpdateContext ( Addressable ctx) {
        var mh$ = RuntimeHelper.requireNonNull(constants$7.CGLUpdateContext$MH, "CGLUpdateContext");
        try {
            return (int)mh$.invokeExact(ctx.address());
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
    ...
    public static int CGLSetGlobalOption ( int pname,  Addressable params) {
        var mh$ = RuntimeHelper.requireNonNull(constants$7.CGLSetGlobalOption$MH, "CGLSetGlobalOption");
        try {
            return (int)mh$.invokeExact(pname, params.address());
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
        }
    }
    ...
    public static int CGLGetGlobalOption ( int pname,  Addressable params) {
        var mh$ = RuntimeHelper.requireNonNull(constants$7.CGLGetGlobalOption$MH, "CGLGetGlobalOption");
        try {
            return (int)mh$.invokeExact(pname, params.address());
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
    ...
    public static int CGLSetOption ( int pname,  int param) {
        var mh$ = RuntimeHelper.requireNonNull(constants$7.CGLSetOption$MH, "CGLSetOption");
        try {
    ...
    public static int CGLGetOption ( int pname,  Addressable param) {
        var mh$ = RuntimeHelper.requireNonNull(constants$7.CGLGetOption$MH, "CGLGetOption");
        try {
            return (int)mh$.invokeExact(pname, param.address());
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
        }
    }
    ...
    public static int CGLLockContext ( Addressable ctx) {
        var mh$ = RuntimeHelper.requireNonNull(constants$8.CGLLockContext$MH, "CGLLockContext");
        try {
            return (int)mh$.invokeExact(ctx.address());
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
    ...
    public static int CGLUnlockContext ( Addressable ctx) {
        var mh$ = RuntimeHelper.requireNonNull(constants$8.CGLUnlockContext$MH, "CGLUnlockContext");
        try {
            return (int)mh$.invokeExact(ctx.address());
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
    ...
    public static void CGLGetVersion ( Addressable majorvers,  Addressable minorvers) {
        var mh$ = RuntimeHelper.requireNonNull(constants$8.CGLGetVersion$MH, "CGLGetVersion");
        try {
            mh$.invokeExact(majorvers.address(), minorvers.address());
        } catch (Throwable ex$) {
            throw new AssertionError("should not reach here", ex$);
        }
    }
    ...
    public static MemoryAddress CGLErrorString ( int error) {
        var mh$ = RuntimeHelper.requireNonNull(constants$8.CGLErrorString$MH, "CGLErrorString");
        try {
