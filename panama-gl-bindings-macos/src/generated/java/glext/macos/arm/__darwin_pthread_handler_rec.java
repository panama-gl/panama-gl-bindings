...
public class __darwin_pthread_handler_rec {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        glext_h.C_POINTER.withName("__routine"),
        glext_h.C_POINTER.withName("__arg"),
        glext_h.C_POINTER.withName("__next")
    ...
    public static class __routine {
        ...
        private static final MethodHandle UP$MH = glext_h.upcallHandle(__routine.Function.class, "apply", $DESC);
