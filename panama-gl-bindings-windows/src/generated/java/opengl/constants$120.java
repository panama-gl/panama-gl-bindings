...
class constants$120 {
    ...
    static final MethodHandle RtlFlushNonVolatileMemoryRanges$MH = RuntimeHelper.downcallHandle(
        ...
        constants$120.RtlFlushNonVolatileMemoryRanges$FUNC
    );
    ...
    static final MethodHandle RtlInitializeCorrelationVector$MH = RuntimeHelper.downcallHandle(
        ...
        constants$120.RtlInitializeCorrelationVector$FUNC
    );
    ...
    static final MethodHandle RtlIncrementCorrelationVector$MH = RuntimeHelper.downcallHandle(
        ...
        constants$120.RtlIncrementCorrelationVector$FUNC
    );
    ...
    static final MethodHandle RtlExtendCorrelationVector$MH = RuntimeHelper.downcallHandle(
        ...
        constants$120.RtlExtendCorrelationVector$FUNC
    );
    ...
    static final MethodHandle RtlValidateCorrelationVector$MH = RuntimeHelper.downcallHandle(
        ...
        constants$120.RtlValidateCorrelationVector$FUNC
    );
    ...
    static final MethodHandle CUSTOM_SYSTEM_EVENT_TRIGGER_INIT$MH = RuntimeHelper.downcallHandle(
        ...
        constants$120.CUSTOM_SYSTEM_EVENT_TRIGGER_INIT$FUNC
    );
}
