...
public interface glutTabletMotionFunc$callback {
    ...
    static MemorySegment allocate(glutTabletMotionFunc$callback fi, MemorySession session) {
        return RuntimeHelper.upcallStub(glutTabletMotionFunc$callback.class, fi, constants$734.glutTabletMotionFunc$callback$FUNC, session);
    }
    static glutTabletMotionFunc$callback ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int __x0, int __x1) -> {
            try {
                constants$734.glutTabletMotionFunc$callback$MH.invokeExact((Addressable)symbol, __x0, __x1);
            } catch (Throwable ex$) {
