...
class constants$564 {
    ...
    static final MethodHandle GetCalendarInfoEx$MH = RuntimeHelper.downcallHandle(
        "GetCalendarInfoEx",
        constants$564.GetCalendarInfoEx$FUNC
    );
    ...
    static final MethodHandle GetNumberFormatEx$MH = RuntimeHelper.downcallHandle(
        "GetNumberFormatEx",
        constants$564.GetNumberFormatEx$FUNC
    );
    ...
    static final MethodHandle GetCurrencyFormatEx$MH = RuntimeHelper.downcallHandle(
        "GetCurrencyFormatEx",
        constants$564.GetCurrencyFormatEx$FUNC
    );
    ...
    static final MethodHandle GetUserDefaultLocaleName$MH = RuntimeHelper.downcallHandle(
        ...
        constants$564.GetUserDefaultLocaleName$FUNC
    );
    ...
    static final MethodHandle GetSystemDefaultLocaleName$MH = RuntimeHelper.downcallHandle(
        ...
        constants$564.GetSystemDefaultLocaleName$FUNC
    );
    ...
    static final MethodHandle IsNLSDefinedString$MH = RuntimeHelper.downcallHandle(
        "IsNLSDefinedString",
        constants$564.IsNLSDefinedString$FUNC
    );
}
