...
public interface PROPENUMPROCEX {
    ...
    static MemorySegment allocate(PROPENUMPROCEX fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PROPENUMPROCEX.class, fi, constants$415.PROPENUMPROCEX$FUNC, session);
    }
    static PROPENUMPROCEX ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress __x0, java.lang.foreign.MemoryAddress __x1, java.lang.foreign.MemoryAddress __x2, long __x3) -> {
            try {
                return (int)constants$415.PROPENUMPROCEX$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)__x0, (java.lang.foreign.Addressable)__x1, (java.lang.foreign.Addressable)__x2, __x3);
            } catch (Throwable ex$) {
