...
public interface PFNWGLWAITFORSBCOMLPROC {
    ...
    static MemorySegment allocate(PFNWGLWAITFORSBCOMLPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNWGLWAITFORSBCOMLPROC.class, fi, constants$1407.PFNWGLWAITFORSBCOMLPROC$FUNC, session);
    }
    static PFNWGLWAITFORSBCOMLPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _hdc, long _target_sbc, java.lang.foreign.MemoryAddress _ust, java.lang.foreign.MemoryAddress _msc, java.lang.foreign.MemoryAddress _sbc) -> {
            try {
                return (int)constants$1407.PFNWGLWAITFORSBCOMLPROC$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_hdc, _target_sbc, (java.lang.foreign.Addressable)_ust, (java.lang.foreign.Addressable)_msc, (java.lang.foreign.Addressable)_sbc);
            } catch (Throwable ex$) {
