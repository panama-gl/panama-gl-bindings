...
class constants$133 {
    ...
    static final MethodHandle CreateDirectoryA$MH = RuntimeHelper.downcallHandle(
        "CreateDirectoryA",
        constants$133.CreateDirectoryA$FUNC
    );
    ...
    static final MethodHandle CreateDirectoryW$MH = RuntimeHelper.downcallHandle(
        "CreateDirectoryW",
        constants$133.CreateDirectoryW$FUNC
    );
    ...
    static final MethodHandle CreateFileA$MH = RuntimeHelper.downcallHandle(
        "CreateFileA",
        constants$133.CreateFileA$FUNC
    );
    ...
    static final MethodHandle CreateFileW$MH = RuntimeHelper.downcallHandle(
        "CreateFileW",
        constants$133.CreateFileW$FUNC
    );
    ...
    static final MethodHandle DefineDosDeviceW$MH = RuntimeHelper.downcallHandle(
        "DefineDosDeviceW",
        constants$133.DefineDosDeviceW$FUNC
    );
    ...
    static final MethodHandle DeleteFileA$MH = RuntimeHelper.downcallHandle(
        "DeleteFileA",
        constants$133.DeleteFileA$FUNC
    );
}
