...
public interface PFNWGLQUERYFRAMETRACKINGI3DPROC {
    ...
    static MemorySegment allocate(PFNWGLQUERYFRAMETRACKINGI3DPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNWGLQUERYFRAMETRACKINGI3DPROC.class, fi, constants$1393.PFNWGLQUERYFRAMETRACKINGI3DPROC$FUNC, session);
    }
    static PFNWGLQUERYFRAMETRACKINGI3DPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _pFrameCount, java.lang.foreign.MemoryAddress _pMissedFrames, java.lang.foreign.MemoryAddress _pLastMissedUsage) -> {
            try {
                return (int)constants$1393.PFNWGLQUERYFRAMETRACKINGI3DPROC$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_pFrameCount, (java.lang.foreign.Addressable)_pMissedFrames, (java.lang.foreign.Addressable)_pLastMissedUsage);
            } catch (Throwable ex$) {
