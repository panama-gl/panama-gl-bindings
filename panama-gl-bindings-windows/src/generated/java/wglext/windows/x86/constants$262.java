...
class constants$262 {
    ...
    static final MethodHandle GetCurrentUmsThread$MH = RuntimeHelper.downcallHandle(
        "GetCurrentUmsThread",
        constants$262.GetCurrentUmsThread$FUNC
    );
    ...
    static final MethodHandle GetNextUmsListItem$MH = RuntimeHelper.downcallHandle(
        "GetNextUmsListItem",
        constants$262.GetNextUmsListItem$FUNC
    );
    ...
    static final MethodHandle QueryUmsThreadInformation$MH = RuntimeHelper.downcallHandle(
        ...
        constants$262.QueryUmsThreadInformation$FUNC
    );
    ...
    static final MethodHandle SetUmsThreadInformation$MH = RuntimeHelper.downcallHandle(
        ...
        constants$262.SetUmsThreadInformation$FUNC
    );
    ...
    static final MethodHandle DeleteUmsThreadContext$MH = RuntimeHelper.downcallHandle(
        ...
        constants$262.DeleteUmsThreadContext$FUNC
    );
    ...
    static final MethodHandle CreateUmsThreadContext$MH = RuntimeHelper.downcallHandle(
        ...
        constants$262.CreateUmsThreadContext$FUNC
    );
}
