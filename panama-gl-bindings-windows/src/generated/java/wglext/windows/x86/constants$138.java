...
class constants$138 {
    ...
    static final MethodHandle GetDriveTypeA$MH = RuntimeHelper.downcallHandle(
        "GetDriveTypeA",
        constants$138.GetDriveTypeA$FUNC
    );
    ...
    static final MethodHandle GetDriveTypeW$MH = RuntimeHelper.downcallHandle(
        "GetDriveTypeW",
        constants$138.GetDriveTypeW$FUNC
    );
    ...
    static final MethodHandle GetFileAttributesA$MH = RuntimeHelper.downcallHandle(
        "GetFileAttributesA",
        constants$138.GetFileAttributesA$FUNC
    );
    ...
    static final MethodHandle GetFileAttributesW$MH = RuntimeHelper.downcallHandle(
        "GetFileAttributesW",
        constants$138.GetFileAttributesW$FUNC
    );
    ...
    static final MethodHandle GetFileAttributesExA$MH = RuntimeHelper.downcallHandle(
        ...
        constants$138.GetFileAttributesExA$FUNC
    );
    ...
    static final MethodHandle GetFileAttributesExW$MH = RuntimeHelper.downcallHandle(
        ...
        constants$138.GetFileAttributesExW$FUNC
    );
}
