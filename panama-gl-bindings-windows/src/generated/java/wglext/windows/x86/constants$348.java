...
class constants$348 {
    ...
    static final MethodHandle CreatePenIndirect$MH = RuntimeHelper.downcallHandle(
        "CreatePenIndirect",
        constants$348.CreatePenIndirect$FUNC
    );
    ...
    static final MethodHandle CreatePolyPolygonRgn$MH = RuntimeHelper.downcallHandle(
        ...
        constants$348.CreatePolyPolygonRgn$FUNC
    );
    ...
    static final MethodHandle CreatePatternBrush$MH = RuntimeHelper.downcallHandle(
        "CreatePatternBrush",
        constants$348.CreatePatternBrush$FUNC
    );
    ...
    static final MethodHandle CreateRectRgn$MH = RuntimeHelper.downcallHandle(
        "CreateRectRgn",
        constants$348.CreateRectRgn$FUNC
    );
    ...
    static final MethodHandle CreateRectRgnIndirect$MH = RuntimeHelper.downcallHandle(
        ...
        constants$348.CreateRectRgnIndirect$FUNC
    );
    ...
    static final MethodHandle CreateRoundRectRgn$MH = RuntimeHelper.downcallHandle(
        "CreateRoundRectRgn",
        constants$348.CreateRoundRectRgn$FUNC
    );
}
