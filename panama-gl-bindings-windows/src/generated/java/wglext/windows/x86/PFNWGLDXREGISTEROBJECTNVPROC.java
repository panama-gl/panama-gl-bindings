...
public interface PFNWGLDXREGISTEROBJECTNVPROC {
    ...
    static MemorySegment allocate(PFNWGLDXREGISTEROBJECTNVPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNWGLDXREGISTEROBJECTNVPROC.class, fi, constants$1394.PFNWGLDXREGISTEROBJECTNVPROC$FUNC, session);
    }
    static PFNWGLDXREGISTEROBJECTNVPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _hDevice, java.lang.foreign.MemoryAddress _dxObject, int _name, int _type, int _access) -> {
            try {
                return (java.lang.foreign.Addressable)(java.lang.foreign.MemoryAddress)constants$1394.PFNWGLDXREGISTEROBJECTNVPROC$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_hDevice, (java.lang.foreign.Addressable)_dxObject, _name, _type, _access);
            } catch (Throwable ex$) {
