...
class constants$456 {
    ...
    static final MethodHandle mouse_event$MH = RuntimeHelper.downcallHandle(
        "mouse_event",
        constants$456.mouse_event$FUNC
    );
    ...
    static final MethodHandle GetTouchInputInfo$MH = RuntimeHelper.downcallHandle(
        "GetTouchInputInfo",
        constants$456.GetTouchInputInfo$FUNC
    );
    ...
    static final MethodHandle CloseTouchInputHandle$MH = RuntimeHelper.downcallHandle(
        ...
        constants$456.CloseTouchInputHandle$FUNC
    );
    ...
    static final MethodHandle RegisterTouchWindow$MH = RuntimeHelper.downcallHandle(
        "RegisterTouchWindow",
        constants$456.RegisterTouchWindow$FUNC
    );
    ...
    static final MethodHandle UnregisterTouchWindow$MH = RuntimeHelper.downcallHandle(
        ...
        constants$456.UnregisterTouchWindow$FUNC
    );
}
