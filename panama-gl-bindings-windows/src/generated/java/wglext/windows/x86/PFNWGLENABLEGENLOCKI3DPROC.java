...
public interface PFNWGLENABLEGENLOCKI3DPROC {
    ...
    static MemorySegment allocate(PFNWGLENABLEGENLOCKI3DPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNWGLENABLEGENLOCKI3DPROC.class, fi, constants$1385.PFNWGLENABLEGENLOCKI3DPROC$FUNC, session);
    }
    static PFNWGLENABLEGENLOCKI3DPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _hDC) -> {
            try {
                return (int)constants$1385.PFNWGLENABLEGENLOCKI3DPROC$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_hDC);
            } catch (Throwable ex$) {
