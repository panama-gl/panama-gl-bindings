...
public interface PFNWGLENUMERATEVIDEODEVICESNVPROC {
    ...
    static MemorySegment allocate(PFNWGLENUMERATEVIDEODEVICESNVPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNWGLENUMERATEVIDEODEVICESNVPROC.class, fi, constants$1398.PFNWGLENUMERATEVIDEODEVICESNVPROC$FUNC, session);
    }
    static PFNWGLENUMERATEVIDEODEVICESNVPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _hDc, java.lang.foreign.MemoryAddress _phDeviceList) -> {
            try {
                return (int)constants$1398.PFNWGLENUMERATEVIDEODEVICESNVPROC$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_hDc, (java.lang.foreign.Addressable)_phDeviceList);
            } catch (Throwable ex$) {
