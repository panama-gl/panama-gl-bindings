...
class constants$544 {
    ...
    static final MethodHandle LCMapStringW$MH = RuntimeHelper.downcallHandle(
        "LCMapStringW",
        constants$544.LCMapStringW$FUNC
    );
    ...
    static final MethodHandle LCMapStringA$MH = RuntimeHelper.downcallHandle(
        "LCMapStringA",
        constants$544.LCMapStringA$FUNC
    );
    ...
    static final MethodHandle GetLocaleInfoW$MH = RuntimeHelper.downcallHandle(
        "GetLocaleInfoW",
        constants$544.GetLocaleInfoW$FUNC
    );
    ...
    static final MethodHandle GetLocaleInfoA$MH = RuntimeHelper.downcallHandle(
        "GetLocaleInfoA",
        constants$544.GetLocaleInfoA$FUNC
    );
    ...
    static final MethodHandle SetLocaleInfoA$MH = RuntimeHelper.downcallHandle(
        "SetLocaleInfoA",
        constants$544.SetLocaleInfoA$FUNC
    );
    ...
    static final MethodHandle SetLocaleInfoW$MH = RuntimeHelper.downcallHandle(
        "SetLocaleInfoW",
        constants$544.SetLocaleInfoW$FUNC
    );
}
