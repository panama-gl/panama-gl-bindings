...
class constants$422 {
    ...
    static final MethodHandle GetMessageA$MH = RuntimeHelper.downcallHandle(
        "GetMessageA",
        constants$422.GetMessageA$FUNC
    );
    ...
    static final MethodHandle GetMessageW$MH = RuntimeHelper.downcallHandle(
        "GetMessageW",
        constants$422.GetMessageW$FUNC
    );
    ...
    static final MethodHandle TranslateMessage$MH = RuntimeHelper.downcallHandle(
        "TranslateMessage",
        constants$422.TranslateMessage$FUNC
    );
    ...
    static final MethodHandle DispatchMessageA$MH = RuntimeHelper.downcallHandle(
        "DispatchMessageA",
        constants$422.DispatchMessageA$FUNC
    );
    ...
    static final MethodHandle DispatchMessageW$MH = RuntimeHelper.downcallHandle(
        "DispatchMessageW",
        constants$422.DispatchMessageW$FUNC
    );
    ...
    static final MethodHandle SetMessageQueue$MH = RuntimeHelper.downcallHandle(
        "SetMessageQueue",
        constants$422.SetMessageQueue$FUNC
    );
}
