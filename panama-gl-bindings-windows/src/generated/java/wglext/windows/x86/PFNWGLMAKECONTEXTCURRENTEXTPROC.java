...
public interface PFNWGLMAKECONTEXTCURRENTEXTPROC {
    ...
    static MemorySegment allocate(PFNWGLMAKECONTEXTCURRENTEXTPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNWGLMAKECONTEXTCURRENTEXTPROC.class, fi, constants$1379.PFNWGLMAKECONTEXTCURRENTEXTPROC$FUNC, session);
    }
    static PFNWGLMAKECONTEXTCURRENTEXTPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _hDrawDC, java.lang.foreign.MemoryAddress _hReadDC, java.lang.foreign.MemoryAddress _hglrc) -> {
            try {
                return (int)constants$1379.PFNWGLMAKECONTEXTCURRENTEXTPROC$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_hDrawDC, (java.lang.foreign.Addressable)_hReadDC, (java.lang.foreign.Addressable)_hglrc);
            } catch (Throwable ex$) {
