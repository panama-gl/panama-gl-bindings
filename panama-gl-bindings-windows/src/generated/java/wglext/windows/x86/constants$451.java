...
class constants$451 {
    ...
    static final MethodHandle CharNextExA$MH = RuntimeHelper.downcallHandle(
        "CharNextExA",
        constants$451.CharNextExA$FUNC
    );
    ...
    static final MethodHandle CharPrevExA$MH = RuntimeHelper.downcallHandle(
        "CharPrevExA",
        constants$451.CharPrevExA$FUNC
    );
    ...
    static final MethodHandle IsCharAlphaA$MH = RuntimeHelper.downcallHandle(
        "IsCharAlphaA",
        constants$451.IsCharAlphaA$FUNC
    );
    ...
    static final MethodHandle IsCharAlphaW$MH = RuntimeHelper.downcallHandle(
        "IsCharAlphaW",
        constants$451.IsCharAlphaW$FUNC
    );
    ...
    static final MethodHandle IsCharAlphaNumericA$MH = RuntimeHelper.downcallHandle(
        "IsCharAlphaNumericA",
        constants$451.IsCharAlphaNumericA$FUNC
    );
    ...
    static final MethodHandle IsCharAlphaNumericW$MH = RuntimeHelper.downcallHandle(
        "IsCharAlphaNumericW",
        constants$451.IsCharAlphaNumericW$FUNC
    );
}
