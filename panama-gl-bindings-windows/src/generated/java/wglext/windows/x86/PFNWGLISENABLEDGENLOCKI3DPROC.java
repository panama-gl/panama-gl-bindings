...
public interface PFNWGLISENABLEDGENLOCKI3DPROC {
    ...
    static MemorySegment allocate(PFNWGLISENABLEDGENLOCKI3DPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNWGLISENABLEDGENLOCKI3DPROC.class, fi, constants$1386.PFNWGLISENABLEDGENLOCKI3DPROC$FUNC, session);
    }
    static PFNWGLISENABLEDGENLOCKI3DPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _hDC, java.lang.foreign.MemoryAddress _pFlag) -> {
            try {
                return (int)constants$1386.PFNWGLISENABLEDGENLOCKI3DPROC$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_hDC, (java.lang.foreign.Addressable)_pFlag);
            } catch (Throwable ex$) {
