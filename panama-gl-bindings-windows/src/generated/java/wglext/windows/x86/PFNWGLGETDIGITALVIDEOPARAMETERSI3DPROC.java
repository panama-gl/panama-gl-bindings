...
public interface PFNWGLGETDIGITALVIDEOPARAMETERSI3DPROC {
    ...
    static MemorySegment allocate(PFNWGLGETDIGITALVIDEOPARAMETERSI3DPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNWGLGETDIGITALVIDEOPARAMETERSI3DPROC.class, fi, constants$1383.PFNWGLGETDIGITALVIDEOPARAMETERSI3DPROC$FUNC, session);
    }
    static PFNWGLGETDIGITALVIDEOPARAMETERSI3DPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _hDC, int _iAttribute, java.lang.foreign.MemoryAddress _piValue) -> {
            try {
                return (int)constants$1383.PFNWGLGETDIGITALVIDEOPARAMETERSI3DPROC$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_hDC, _iAttribute, (java.lang.foreign.Addressable)_piValue);
            } catch (Throwable ex$) {
