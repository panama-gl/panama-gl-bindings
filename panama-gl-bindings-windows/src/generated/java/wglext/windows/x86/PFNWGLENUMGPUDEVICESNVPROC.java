...
public interface PFNWGLENUMGPUDEVICESNVPROC {
    ...
    static MemorySegment allocate(PFNWGLENUMGPUDEVICESNVPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNWGLENUMGPUDEVICESNVPROC.class, fi, constants$1397.PFNWGLENUMGPUDEVICESNVPROC$FUNC, session);
    }
    static PFNWGLENUMGPUDEVICESNVPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _hGpu, int _iDeviceIndex, java.lang.foreign.MemoryAddress _lpGpuDevice) -> {
            try {
                return (int)constants$1397.PFNWGLENUMGPUDEVICESNVPROC$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_hGpu, _iDeviceIndex, (java.lang.foreign.Addressable)_lpGpuDevice);
            } catch (Throwable ex$) {
