...
class constants$769 {
    ...
    static final MethodHandle PFN_CERT_STORE_PROV_DELETE_CRL$MH = RuntimeHelper.downcallHandle(
        constants$769.PFN_CERT_STORE_PROV_DELETE_CRL$FUNC
    );
    ...
    static final MethodHandle PFN_CERT_STORE_PROV_SET_CRL_PROPERTY$MH = RuntimeHelper.downcallHandle(
        constants$769.PFN_CERT_STORE_PROV_SET_CRL_PROPERTY$FUNC
    );
    ...
    static final MethodHandle PFN_CERT_STORE_PROV_READ_CTL$MH = RuntimeHelper.downcallHandle(
        constants$769.PFN_CERT_STORE_PROV_READ_CTL$FUNC
    );
