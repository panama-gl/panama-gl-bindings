...
public interface PFNWGLMAKECONTEXTCURRENTARBPROC {
    ...
    static MemorySegment allocate(PFNWGLMAKECONTEXTCURRENTARBPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNWGLMAKECONTEXTCURRENTARBPROC.class, fi, constants$1370.PFNWGLMAKECONTEXTCURRENTARBPROC$FUNC, session);
    }
    static PFNWGLMAKECONTEXTCURRENTARBPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _hDrawDC, java.lang.foreign.MemoryAddress _hReadDC, java.lang.foreign.MemoryAddress _hglrc) -> {
            try {
                return (int)constants$1370.PFNWGLMAKECONTEXTCURRENTARBPROC$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_hDrawDC, (java.lang.foreign.Addressable)_hReadDC, (java.lang.foreign.Addressable)_hglrc);
            } catch (Throwable ex$) {
