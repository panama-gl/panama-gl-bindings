...
public interface PFNWGLBINDSWAPBARRIERNVPROC {
    ...
    static MemorySegment allocate(PFNWGLBINDSWAPBARRIERNVPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNWGLBINDSWAPBARRIERNVPROC.class, fi, constants$1400.PFNWGLBINDSWAPBARRIERNVPROC$FUNC, session);
    }
    static PFNWGLBINDSWAPBARRIERNVPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _group, int _barrier) -> {
            try {
                return (int)constants$1400.PFNWGLBINDSWAPBARRIERNVPROC$MH.invokeExact((Addressable)symbol, _group, _barrier);
            } catch (Throwable ex$) {
