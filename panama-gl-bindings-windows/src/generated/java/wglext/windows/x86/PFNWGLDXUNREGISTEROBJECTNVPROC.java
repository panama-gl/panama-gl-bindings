...
public interface PFNWGLDXUNREGISTEROBJECTNVPROC {
    ...
    static MemorySegment allocate(PFNWGLDXUNREGISTEROBJECTNVPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNWGLDXUNREGISTEROBJECTNVPROC.class, fi, constants$1395.PFNWGLDXUNREGISTEROBJECTNVPROC$FUNC, session);
    }
    static PFNWGLDXUNREGISTEROBJECTNVPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _hDevice, java.lang.foreign.MemoryAddress _hObject) -> {
            try {
                return (int)constants$1395.PFNWGLDXUNREGISTEROBJECTNVPROC$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_hDevice, (java.lang.foreign.Addressable)_hObject);
            } catch (Throwable ex$) {
