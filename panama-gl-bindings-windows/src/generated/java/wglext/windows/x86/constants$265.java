...
class constants$265 {
    ...
    static final MethodHandle SetFileCompletionNotificationModes$MH = RuntimeHelper.downcallHandle(
        ...
        constants$265.SetFileCompletionNotificationModes$FUNC
    );
    ...
    static final MethodHandle Wow64GetThreadSelectorEntry$MH = RuntimeHelper.downcallHandle(
        ...
        constants$265.Wow64GetThreadSelectorEntry$FUNC
    );
    ...
    static final MethodHandle DebugSetProcessKillOnExit$MH = RuntimeHelper.downcallHandle(
        ...
        constants$265.DebugSetProcessKillOnExit$FUNC
    );
    ...
    static final MethodHandle DebugBreakProcess$MH = RuntimeHelper.downcallHandle(
        "DebugBreakProcess",
        constants$265.DebugBreakProcess$FUNC
    );
    ...
    static final MethodHandle GlobalDeleteAtom$MH = RuntimeHelper.downcallHandle(
        "GlobalDeleteAtom",
        constants$265.GlobalDeleteAtom$FUNC
    );
}
