...
public interface PFNWGLENUMGPUSNVPROC {
    ...
    static MemorySegment allocate(PFNWGLENUMGPUSNVPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNWGLENUMGPUSNVPROC.class, fi, constants$1397.PFNWGLENUMGPUSNVPROC$FUNC, session);
    }
    static PFNWGLENUMGPUSNVPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _iGpuIndex, java.lang.foreign.MemoryAddress _phGpu) -> {
            try {
                return (int)constants$1397.PFNWGLENUMGPUSNVPROC$MH.invokeExact((Addressable)symbol, _iGpuIndex, (java.lang.foreign.Addressable)_phGpu);
            } catch (Throwable ex$) {
