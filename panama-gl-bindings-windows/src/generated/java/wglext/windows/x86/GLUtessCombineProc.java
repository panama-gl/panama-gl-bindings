...
public interface GLUtessCombineProc {
    ...
    static MemorySegment allocate(GLUtessCombineProc fi, MemorySession session) {
        return RuntimeHelper.upcallStub(GLUtessCombineProc.class, fi, constants$1365.GLUtessCombineProc$FUNC, session);
    }
    static GLUtessCombineProc ofAddress(MemoryAddress addr, MemorySession session) {
        MemorySegment symbol = MemorySegment.ofAddress(addr, 0, session);
        return (java.lang.foreign.MemoryAddress __x0, java.lang.foreign.MemoryAddress __x1, java.lang.foreign.MemoryAddress __x2, java.lang.foreign.MemoryAddress __x3) -> {
            try {
                constants$1365.GLUtessCombineProc$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)__x0, (java.lang.foreign.Addressable)__x1, (java.lang.foreign.Addressable)__x2, (java.lang.foreign.Addressable)__x3);
            } catch (Throwable ex$) {
