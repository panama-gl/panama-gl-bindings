...
class constants$465 {
    ...
    static final MethodHandle SetCoalescableTimer$MH = RuntimeHelper.downcallHandle(
        "SetCoalescableTimer",
        constants$465.SetCoalescableTimer$FUNC
    );
    ...
    static final MethodHandle IsWindowUnicode$MH = RuntimeHelper.downcallHandle(
        "IsWindowUnicode",
        constants$465.IsWindowUnicode$FUNC
    );
    ...
    static final MethodHandle EnableWindow$MH = RuntimeHelper.downcallHandle(
        "EnableWindow",
        constants$465.EnableWindow$FUNC
    );
    ...
    static final MethodHandle IsWindowEnabled$MH = RuntimeHelper.downcallHandle(
        "IsWindowEnabled",
        constants$465.IsWindowEnabled$FUNC
    );
    ...
    static final MethodHandle LoadAcceleratorsA$MH = RuntimeHelper.downcallHandle(
        "LoadAcceleratorsA",
        constants$465.LoadAcceleratorsA$FUNC
    );
}
