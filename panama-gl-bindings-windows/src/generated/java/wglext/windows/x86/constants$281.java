...
class constants$281 {
    ...
    static final MethodHandle BackupWrite$MH = RuntimeHelper.downcallHandle(
        "BackupWrite",
        constants$281.BackupWrite$FUNC
    );
    ...
    static final MethodHandle CreateSemaphoreA$MH = RuntimeHelper.downcallHandle(
        "CreateSemaphoreA",
        constants$281.CreateSemaphoreA$FUNC
    );
    ...
    static final MethodHandle OpenSemaphoreA$MH = RuntimeHelper.downcallHandle(
        "OpenSemaphoreA",
        constants$281.OpenSemaphoreA$FUNC
    );
    ...
    static final MethodHandle CreateWaitableTimerA$MH = RuntimeHelper.downcallHandle(
        ...
        constants$281.CreateWaitableTimerA$FUNC
    );
    ...
    static final MethodHandle OpenWaitableTimerA$MH = RuntimeHelper.downcallHandle(
        "OpenWaitableTimerA",
        constants$281.OpenWaitableTimerA$FUNC
    );
}
