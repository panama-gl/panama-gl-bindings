...
class constants$495 {
    ...
    static final MethodHandle DrawFocusRect$MH = RuntimeHelper.downcallHandle(
        "DrawFocusRect",
        constants$495.DrawFocusRect$FUNC
    );
    ...
    static final MethodHandle SetRectEmpty$MH = RuntimeHelper.downcallHandle(
        "SetRectEmpty",
        constants$495.SetRectEmpty$FUNC
    );
}
