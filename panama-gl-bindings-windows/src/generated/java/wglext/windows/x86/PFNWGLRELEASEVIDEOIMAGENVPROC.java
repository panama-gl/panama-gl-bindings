...
public interface PFNWGLRELEASEVIDEOIMAGENVPROC {
    ...
    static MemorySegment allocate(PFNWGLRELEASEVIDEOIMAGENVPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNWGLRELEASEVIDEOIMAGENVPROC.class, fi, constants$1405.PFNWGLRELEASEVIDEOIMAGENVPROC$FUNC, session);
    }
    static PFNWGLRELEASEVIDEOIMAGENVPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _hPbuffer, int _iVideoBuffer) -> {
            try {
                return (int)constants$1405.PFNWGLRELEASEVIDEOIMAGENVPROC$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_hPbuffer, _iVideoBuffer);
            } catch (Throwable ex$) {
