...
public interface PFNWGLCREATEASSOCIATEDCONTEXTATTRIBSAMDPROC {
    ...
    static MemorySegment allocate(PFNWGLCREATEASSOCIATEDCONTEXTATTRIBSAMDPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNWGLCREATEASSOCIATEDCONTEXTATTRIBSAMDPROC.class, fi, constants$1376.PFNWGLCREATEASSOCIATEDCONTEXTATTRIBSAMDPROC$FUNC, session);
    }
    static PFNWGLCREATEASSOCIATEDCONTEXTATTRIBSAMDPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _id, java.lang.foreign.MemoryAddress _hShareContext, java.lang.foreign.MemoryAddress _attribList) -> {
            try {
                return (java.lang.foreign.Addressable)(java.lang.foreign.MemoryAddress)constants$1376.PFNWGLCREATEASSOCIATEDCONTEXTATTRIBSAMDPROC$MH.invokeExact((Addressable)symbol, _id, (java.lang.foreign.Addressable)_hShareContext, (java.lang.foreign.Addressable)_attribList);
            } catch (Throwable ex$) {
