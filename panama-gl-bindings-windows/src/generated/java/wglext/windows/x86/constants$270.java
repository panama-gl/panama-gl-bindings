...
class constants$270 {
    ...
    static final MethodHandle SetCommMask$MH = RuntimeHelper.downcallHandle(
        "SetCommMask",
        constants$270.SetCommMask$FUNC
    );
    ...
    static final MethodHandle SetCommState$MH = RuntimeHelper.downcallHandle(
        "SetCommState",
        constants$270.SetCommState$FUNC
    );
    ...
    static final MethodHandle SetCommTimeouts$MH = RuntimeHelper.downcallHandle(
        "SetCommTimeouts",
        constants$270.SetCommTimeouts$FUNC
    );
    ...
    static final MethodHandle TransmitCommChar$MH = RuntimeHelper.downcallHandle(
        "TransmitCommChar",
        constants$270.TransmitCommChar$FUNC
    );
    ...
    static final MethodHandle WaitCommEvent$MH = RuntimeHelper.downcallHandle(
        "WaitCommEvent",
        constants$270.WaitCommEvent$FUNC
    );
    ...
    static final MethodHandle OpenCommPort$MH = RuntimeHelper.downcallHandle(
        "OpenCommPort",
        constants$270.OpenCommPort$FUNC
    );
}
