...
public class _IMAGE_EPILOGUE_DYNAMIC_RELOCATION_HEADER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        wgl_h.align(wgl_h.C_LONG, 1).withName("EpilogueCount"),
        wgl_h.C_CHAR.withName("EpilogueByteCount"),
        wgl_h.C_CHAR.withName("BranchDescriptorElementSize"),
        wgl_h.align(wgl_h.C_SHORT, 1).withName("BranchDescriptorCount")
