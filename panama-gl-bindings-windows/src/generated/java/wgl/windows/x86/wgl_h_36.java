...
import static java.lang.foreign.ValueLayout.*;
 class wgl_h_36 extends wgl_h_35 {
    ...
    public static MemorySegment SZDDESYS_TOPIC() {
        return constants$1445.SZDDESYS_TOPIC$SEGMENT;
    }
    public static MemorySegment SZDDESYS_ITEM_TOPICS() {
        return constants$1445.SZDDESYS_ITEM_TOPICS$SEGMENT;
    }
    public static MemorySegment SZDDESYS_ITEM_SYSITEMS() {
        return constants$1445.SZDDESYS_ITEM_SYSITEMS$SEGMENT;
    }
    public static MemorySegment SZDDESYS_ITEM_RTNMSG() {
        return constants$1445.SZDDESYS_ITEM_RTNMSG$SEGMENT;
    }
    public static MemorySegment SZDDESYS_ITEM_STATUS() {
        return constants$1446.SZDDESYS_ITEM_STATUS$SEGMENT;
    }
    public static MemorySegment SZDDESYS_ITEM_FORMATS() {
        return constants$1446.SZDDESYS_ITEM_FORMATS$SEGMENT;
    }
    public static MemorySegment SZDDESYS_ITEM_HELP() {
        return constants$1446.SZDDESYS_ITEM_HELP$SEGMENT;
    }
    public static MemorySegment SZDDE_ITEM_ITEMLIST() {
        return constants$1446.SZDDE_ITEM_ITEMLIST$SEGMENT;
    }
    public static MemoryAddress CBR_BLOCK() {
        return constants$1446.CBR_BLOCK$ADDR;
    }
    ...
    public static MemorySegment ALL_TRANSPORTS() {
        return constants$1446.ALL_TRANSPORTS$SEGMENT;
    }
    public static MemorySegment MS_NBF() {
        return constants$1447.MS_NBF$SEGMENT;
    }
    ...
    public static MemoryAddress RPC_C_NO_CREDENTIALS() {
        return constants$1447.RPC_C_NO_CREDENTIALS$ADDR;
    }
    ...
    public static MemoryAddress RPC_CONTEXT_HANDLE_DEFAULT_GUARD() {
        return constants$1447.RPC_CONTEXT_HANDLE_DEFAULT_GUARD$ADDR;
    }
    ...
    public static MemoryAddress I_RRPCUNINITIALIZENDROLE_EXPORT_NAME() {
        return constants$1447.I_RRPCUNINITIALIZENDROLE_EXPORT_NAME$ADDR;
    }
    ...
    public static MemorySegment WC_NETADDRESS() {
        return constants$1447.WC_NETADDRESS$SEGMENT;
    }
    ...
    public static MemorySegment MS_DEF_PROV_A() {
        return constants$1447.MS_DEF_PROV_A$SEGMENT;
    }
    public static MemorySegment MS_DEF_PROV_W() {
        return constants$1448.MS_DEF_PROV_W$SEGMENT;
    }
    public static MemorySegment MS_DEF_PROV() {
        return constants$1448.MS_DEF_PROV$SEGMENT;
    }
    public static MemorySegment MS_ENHANCED_PROV_A() {
        return constants$1448.MS_ENHANCED_PROV_A$SEGMENT;
    }
    public static MemorySegment MS_ENHANCED_PROV_W() {
        return constants$1448.MS_ENHANCED_PROV_W$SEGMENT;
    }
    public static MemorySegment MS_ENHANCED_PROV() {
        return constants$1448.MS_ENHANCED_PROV$SEGMENT;
    }
    public static MemorySegment MS_STRONG_PROV_A() {
        return constants$1448.MS_STRONG_PROV_A$SEGMENT;
    }
    public static MemorySegment MS_STRONG_PROV_W() {
        return constants$1449.MS_STRONG_PROV_W$SEGMENT;
    }
    public static MemorySegment MS_STRONG_PROV() {
        return constants$1449.MS_STRONG_PROV$SEGMENT;
    }
    public static MemorySegment MS_DEF_RSA_SIG_PROV_A() {
        return constants$1449.MS_DEF_RSA_SIG_PROV_A$SEGMENT;
    }
}
