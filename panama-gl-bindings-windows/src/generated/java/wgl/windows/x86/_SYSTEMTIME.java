...
public class _SYSTEMTIME {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        wgl_h.C_SHORT.withName("wYear"),
        wgl_h.C_SHORT.withName("wMonth"),
        wgl_h.C_SHORT.withName("wDayOfWeek"),
        wgl_h.C_SHORT.withName("wDay"),
        wgl_h.C_SHORT.withName("wHour"),
        wgl_h.C_SHORT.withName("wMinute"),
        wgl_h.C_SHORT.withName("wSecond"),
        wgl_h.C_SHORT.withName("wMilliseconds")
