...
public class tagXFORM {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        wgl_h.C_FLOAT.withName("eM11"),
        wgl_h.C_FLOAT.withName("eM12"),
        wgl_h.C_FLOAT.withName("eM21"),
        wgl_h.C_FLOAT.withName("eM22"),
        wgl_h.C_FLOAT.withName("eDx"),
        wgl_h.C_FLOAT.withName("eDy")
    ).withName("tagXFORM");
