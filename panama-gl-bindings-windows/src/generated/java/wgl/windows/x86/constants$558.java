...
class constants$558 {
    ...
    static final MethodHandle GetStringScripts$MH = RuntimeHelper.downcallHandle(
        "GetStringScripts",
        constants$558.GetStringScripts$FUNC
    );
    ...
    static final MethodHandle GetLocaleInfoEx$MH = RuntimeHelper.downcallHandle(
        "GetLocaleInfoEx",
        constants$558.GetLocaleInfoEx$FUNC
    );
    ...
    static final MethodHandle GetCalendarInfoEx$MH = RuntimeHelper.downcallHandle(
        "GetCalendarInfoEx",
        constants$558.GetCalendarInfoEx$FUNC
    );
    ...
    static final MethodHandle GetNumberFormatEx$MH = RuntimeHelper.downcallHandle(
        "GetNumberFormatEx",
        constants$558.GetNumberFormatEx$FUNC
    );
    ...
    static final MethodHandle GetCurrencyFormatEx$MH = RuntimeHelper.downcallHandle(
        "GetCurrencyFormatEx",
        constants$558.GetCurrencyFormatEx$FUNC
    );
    ...
    static final MethodHandle GetUserDefaultLocaleName$MH = RuntimeHelper.downcallHandle(
        ...
        constants$558.GetUserDefaultLocaleName$FUNC
    );
}
