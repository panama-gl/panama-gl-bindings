...
public class PPM_IDLE_STATE_ACCOUNTING {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        wgl_h.C_LONG.withName("IdleTransitions"),
        wgl_h.C_LONG.withName("FailedTransitions"),
        wgl_h.C_LONG.withName("InvalidBucketIndex"),
        MemoryLayout.paddingLayout(4),
        wgl_h.C_LONG_LONG.withName("TotalTime"),
        MemoryLayout.sequenceLayout(6, wgl_h.C_LONG).withName("IdleTimeBuckets")
