...
public class _NOTIFYICONDATAW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(128, wgl_h.C_SHORT).withName("szTip"),
        wgl_h.C_LONG.withName("dwState"),
        wgl_h.C_LONG.withName("dwStateMask"),
        MemoryLayout.sequenceLayout(256, wgl_h.C_SHORT).withName("szInfo"),
        MemoryLayout.unionLayout(
            wgl_h.C_INT.withName("uTimeout"),
            wgl_h.C_INT.withName("uVersion")
        ).withName("$anon$1057:5"),
        MemoryLayout.sequenceLayout(64, wgl_h.C_SHORT).withName("szInfoTitle"),
