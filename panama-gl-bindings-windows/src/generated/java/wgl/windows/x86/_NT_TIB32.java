...
public class _NT_TIB32 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        wgl_h.C_LONG.withName("ExceptionList"),
        wgl_h.C_LONG.withName("StackBase"),
        wgl_h.C_LONG.withName("StackLimit"),
        wgl_h.C_LONG.withName("SubSystemTib"),
        MemoryLayout.unionLayout(
            wgl_h.C_LONG.withName("FiberData"),
            wgl_h.C_LONG.withName("Version")
        ).withName("$anon$11512:5"),
        wgl_h.C_LONG.withName("ArbitraryUserPointer"),
        wgl_h.C_LONG.withName("Self")
    ).withName("_NT_TIB32");
