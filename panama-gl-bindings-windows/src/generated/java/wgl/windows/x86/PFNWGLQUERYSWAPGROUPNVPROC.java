...
public interface PFNWGLQUERYSWAPGROUPNVPROC {
    ...
    static MemorySegment allocate(PFNWGLQUERYSWAPGROUPNVPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNWGLQUERYSWAPGROUPNVPROC.class, fi, constants$1409.PFNWGLQUERYSWAPGROUPNVPROC$FUNC, session);
    }
    static PFNWGLQUERYSWAPGROUPNVPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _hDC, java.lang.foreign.MemoryAddress _group, java.lang.foreign.MemoryAddress _barrier) -> {
            try {
                return (int)constants$1409.PFNWGLQUERYSWAPGROUPNVPROC$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_hDC, (java.lang.foreign.Addressable)_group, (java.lang.foreign.Addressable)_barrier);
            } catch (Throwable ex$) {
