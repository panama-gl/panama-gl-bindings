...
public interface PFNWGLGETGENLOCKSOURCEDELAYI3DPROC {
    ...
    static MemorySegment allocate(PFNWGLGETGENLOCKSOURCEDELAYI3DPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNWGLGETGENLOCKSOURCEDELAYI3DPROC.class, fi, constants$1397.PFNWGLGETGENLOCKSOURCEDELAYI3DPROC$FUNC, session);
    }
    static PFNWGLGETGENLOCKSOURCEDELAYI3DPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _hDC, java.lang.foreign.MemoryAddress _uDelay) -> {
            try {
                return (int)constants$1397.PFNWGLGETGENLOCKSOURCEDELAYI3DPROC$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_hDC, (java.lang.foreign.Addressable)_uDelay);
            } catch (Throwable ex$) {
