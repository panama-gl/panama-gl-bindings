...
public class tagSCROLLBARINFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        wgl_h.C_INT.withName("dxyLineButton"),
        wgl_h.C_INT.withName("xyThumbTop"),
        wgl_h.C_INT.withName("xyThumbBottom"),
        wgl_h.C_INT.withName("reserved"),
        MemoryLayout.sequenceLayout(6, wgl_h.C_LONG).withName("rgstate")
