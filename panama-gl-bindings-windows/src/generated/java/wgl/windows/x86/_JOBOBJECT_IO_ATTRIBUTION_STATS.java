...
public class _JOBOBJECT_IO_ATTRIBUTION_STATS {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        wgl_h.C_LONG_LONG.withName("IoCount"),
        wgl_h.C_LONG_LONG.withName("TotalNonOverlappedQueueTime"),
        wgl_h.C_LONG_LONG.withName("TotalNonOverlappedServiceTime"),
        wgl_h.C_LONG_LONG.withName("TotalSize")
