...
public class _EVENTLOGRECORD {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        wgl_h.C_LONG.withName("RecordNumber"),
        wgl_h.C_LONG.withName("TimeGenerated"),
        wgl_h.C_LONG.withName("TimeWritten"),
        wgl_h.C_LONG.withName("EventID"),
        wgl_h.C_SHORT.withName("EventType"),
        wgl_h.C_SHORT.withName("NumStrings"),
        wgl_h.C_SHORT.withName("EventCategory"),
        wgl_h.C_SHORT.withName("ReservedFlags"),
        wgl_h.C_LONG.withName("ClosingRecordNumber"),
        wgl_h.C_LONG.withName("StringOffset"),
        wgl_h.C_LONG.withName("UserSidLength"),
