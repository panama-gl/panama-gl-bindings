...
class constants$379 {
    ...
    static final MethodHandle TransparentBlt$MH = RuntimeHelper.downcallHandle(
        "TransparentBlt",
        constants$379.TransparentBlt$FUNC
    );
    ...
    static final MethodHandle GradientFill$MH = RuntimeHelper.downcallHandle(
        "GradientFill",
        constants$379.GradientFill$FUNC
    );
    ...
    static final MethodHandle GdiAlphaBlend$MH = RuntimeHelper.downcallHandle(
        "GdiAlphaBlend",
        constants$379.GdiAlphaBlend$FUNC
    );
    ...
    static final MethodHandle GdiTransparentBlt$MH = RuntimeHelper.downcallHandle(
        "GdiTransparentBlt",
        constants$379.GdiTransparentBlt$FUNC
    );
    ...
    static final MethodHandle GdiGradientFill$MH = RuntimeHelper.downcallHandle(
        "GdiGradientFill",
        constants$379.GdiGradientFill$FUNC
    );
    ...
    static final MethodHandle PlayMetaFileRecord$MH = RuntimeHelper.downcallHandle(
        "PlayMetaFileRecord",
        constants$379.PlayMetaFileRecord$FUNC
    );
}
