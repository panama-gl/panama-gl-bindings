...
class constants$552 {
    ...
    static final MethodHandle GetSystemDefaultLangID$MH = RuntimeHelper.downcallHandle(
        ...
        constants$552.GetSystemDefaultLangID$FUNC
    );
    ...
    static final MethodHandle GetSystemDefaultLCID$MH = RuntimeHelper.downcallHandle(
        ...
        constants$552.GetSystemDefaultLCID$FUNC
    );
    ...
    static final MethodHandle GetUserDefaultLCID$MH = RuntimeHelper.downcallHandle(
        "GetUserDefaultLCID",
        constants$552.GetUserDefaultLCID$FUNC
    );
    ...
    static final MethodHandle SetThreadUILanguage$MH = RuntimeHelper.downcallHandle(
        "SetThreadUILanguage",
        constants$552.SetThreadUILanguage$FUNC
    );
    ...
    static final MethodHandle GetThreadUILanguage$MH = RuntimeHelper.downcallHandle(
        "GetThreadUILanguage",
        constants$552.GetThreadUILanguage$FUNC
    );
    ...
    static final MethodHandle GetProcessPreferredUILanguages$MH = RuntimeHelper.downcallHandle(
        ...
        constants$552.GetProcessPreferredUILanguages$FUNC
    );
}
