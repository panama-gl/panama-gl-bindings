...
class constants$112 {
    ...
    static final MethodHandle RtlRestoreContext$MH = RuntimeHelper.downcallHandle(
        "RtlRestoreContext",
        constants$112.RtlRestoreContext$FUNC
    );
    ...
    static final MethodHandle RtlUnwindEx$MH = RuntimeHelper.downcallHandle(
        "RtlUnwindEx",
        constants$112.RtlUnwindEx$FUNC
    );
    ...
    static final MethodHandle RtlVirtualUnwind$MH = RuntimeHelper.downcallHandle(
        "RtlVirtualUnwind",
        constants$112.RtlVirtualUnwind$FUNC
    );
    ...
    static final MethodHandle RtlRaiseException$MH = RuntimeHelper.downcallHandle(
        "RtlRaiseException",
        constants$112.RtlRaiseException$FUNC
    );
    ...
    static final MethodHandle RtlPcToFileHeader$MH = RuntimeHelper.downcallHandle(
        "RtlPcToFileHeader",
        constants$112.RtlPcToFileHeader$FUNC
    );
    ...
    static final MethodHandle RtlCompareMemory$MH = RuntimeHelper.downcallHandle(
        "RtlCompareMemory",
        constants$112.RtlCompareMemory$FUNC
    );
}
