...
public interface PFNWGLGETCONTEXTGPUIDAMDPROC {
    ...
    static MemorySegment allocate(PFNWGLGETCONTEXTGPUIDAMDPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNWGLGETCONTEXTGPUIDAMDPROC.class, fi, constants$1384.PFNWGLGETCONTEXTGPUIDAMDPROC$FUNC, session);
    }
    static PFNWGLGETCONTEXTGPUIDAMDPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _hglrc) -> {
            try {
                return (int)constants$1384.PFNWGLGETCONTEXTGPUIDAMDPROC$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_hglrc);
            } catch (Throwable ex$) {
