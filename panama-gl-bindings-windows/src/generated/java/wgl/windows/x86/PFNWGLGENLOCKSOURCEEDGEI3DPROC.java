...
public interface PFNWGLGENLOCKSOURCEEDGEI3DPROC {
    ...
    static MemorySegment allocate(PFNWGLGENLOCKSOURCEEDGEI3DPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNWGLGENLOCKSOURCEEDGEI3DPROC.class, fi, constants$1396.PFNWGLGENLOCKSOURCEEDGEI3DPROC$FUNC, session);
    }
    static PFNWGLGENLOCKSOURCEEDGEI3DPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _hDC, int _uEdge) -> {
            try {
                return (int)constants$1396.PFNWGLGENLOCKSOURCEEDGEI3DPROC$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_hDC, _uEdge);
            } catch (Throwable ex$) {
