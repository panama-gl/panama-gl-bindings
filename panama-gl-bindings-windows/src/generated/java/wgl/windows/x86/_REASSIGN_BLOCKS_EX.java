...
public class _REASSIGN_BLOCKS_EX {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        wgl_h.align(wgl_h.C_SHORT, 1).withName("Reserved"),
        wgl_h.align(wgl_h.C_SHORT, 1).withName("Count"),
        MemoryLayout.sequenceLayout(1, wgl_h.align(_LARGE_INTEGER.layout(), 1)).withName("BlockNumber")
