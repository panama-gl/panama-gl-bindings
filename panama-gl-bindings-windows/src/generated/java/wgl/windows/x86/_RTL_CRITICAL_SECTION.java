...
public class _RTL_CRITICAL_SECTION {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        wgl_h.C_POINTER.withName("DebugInfo"),
        wgl_h.C_LONG.withName("LockCount"),
        wgl_h.C_LONG.withName("RecursionCount"),
        wgl_h.C_POINTER.withName("OwningThread"),
        wgl_h.C_POINTER.withName("LockSemaphore"),
        wgl_h.C_LONG_LONG.withName("SpinCount")
