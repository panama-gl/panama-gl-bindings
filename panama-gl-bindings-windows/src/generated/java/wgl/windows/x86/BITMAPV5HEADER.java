...
public class BITMAPV5HEADER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        wgl_h.C_LONG.withName("bV5Size"),
        wgl_h.C_LONG.withName("bV5Width"),
        wgl_h.C_LONG.withName("bV5Height"),
        wgl_h.C_SHORT.withName("bV5Planes"),
        wgl_h.C_SHORT.withName("bV5BitCount"),
        wgl_h.C_LONG.withName("bV5Compression"),
        wgl_h.C_LONG.withName("bV5SizeImage"),
        wgl_h.C_LONG.withName("bV5XPelsPerMeter"),
        wgl_h.C_LONG.withName("bV5YPelsPerMeter"),
        wgl_h.C_LONG.withName("bV5ClrUsed"),
        wgl_h.C_LONG.withName("bV5ClrImportant"),
        wgl_h.C_LONG.withName("bV5RedMask"),
        wgl_h.C_LONG.withName("bV5GreenMask"),
        wgl_h.C_LONG.withName("bV5BlueMask"),
        wgl_h.C_LONG.withName("bV5AlphaMask"),
        wgl_h.C_LONG.withName("bV5CSType"),
        tagICEXYZTRIPLE.layout().withName("bV5Endpoints"),
        wgl_h.C_LONG.withName("bV5GammaRed"),
        wgl_h.C_LONG.withName("bV5GammaGreen"),
        wgl_h.C_LONG.withName("bV5GammaBlue"),
        wgl_h.C_LONG.withName("bV5Intent"),
        wgl_h.C_LONG.withName("bV5ProfileData"),
        wgl_h.C_LONG.withName("bV5ProfileSize"),
        wgl_h.C_LONG.withName("bV5Reserved")
    ).withName("$anon$865:9");
