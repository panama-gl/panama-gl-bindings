...
class constants$813 {
    ...
    static final MethodHandle CryptVerifyTimeStampSignature$MH = RuntimeHelper.downcallHandle(
        ...
        constants$813.CryptVerifyTimeStampSignature$FUNC
    );
    ...
    static final MethodHandle PFN_CRYPT_OBJECT_LOCATOR_PROVIDER_FLUSH$MH = RuntimeHelper.downcallHandle(
        constants$813.PFN_CRYPT_OBJECT_LOCATOR_PROVIDER_FLUSH$FUNC
    );
    ...
    static final MethodHandle PFN_CRYPT_OBJECT_LOCATOR_PROVIDER_GET$MH = RuntimeHelper.downcallHandle(
        constants$813.PFN_CRYPT_OBJECT_LOCATOR_PROVIDER_GET$FUNC
    );
