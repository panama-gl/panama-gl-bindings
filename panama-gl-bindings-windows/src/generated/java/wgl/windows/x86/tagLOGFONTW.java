...
public class tagLOGFONTW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        wgl_h.C_LONG.withName("lfHeight"),
        wgl_h.C_LONG.withName("lfWidth"),
        wgl_h.C_LONG.withName("lfEscapement"),
        wgl_h.C_LONG.withName("lfOrientation"),
        wgl_h.C_LONG.withName("lfWeight"),
        wgl_h.C_CHAR.withName("lfItalic"),
        wgl_h.C_CHAR.withName("lfUnderline"),
        wgl_h.C_CHAR.withName("lfStrikeOut"),
        wgl_h.C_CHAR.withName("lfCharSet"),
        wgl_h.C_CHAR.withName("lfOutPrecision"),
        wgl_h.C_CHAR.withName("lfClipPrecision"),
        wgl_h.C_CHAR.withName("lfQuality"),
        wgl_h.C_CHAR.withName("lfPitchAndFamily"),
        MemoryLayout.sequenceLayout(32, wgl_h.C_SHORT).withName("lfFaceName")
