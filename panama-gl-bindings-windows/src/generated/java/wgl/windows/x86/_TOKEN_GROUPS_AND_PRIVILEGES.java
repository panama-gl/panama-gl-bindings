...
public class _TOKEN_GROUPS_AND_PRIVILEGES {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        wgl_h.C_LONG.withName("SidLength"),
        wgl_h.C_POINTER.withName("Sids"),
        wgl_h.C_LONG.withName("RestrictedSidCount"),
        wgl_h.C_LONG.withName("RestrictedSidLength"),
        wgl_h.C_POINTER.withName("RestrictedSids"),
        wgl_h.C_LONG.withName("PrivilegeCount"),
        wgl_h.C_LONG.withName("PrivilegeLength"),
