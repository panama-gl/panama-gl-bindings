...
public class _IMAGE_POLICY_ENTRY {
    ...
    public static class u {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
            wgl_h.C_POINTER.withName("None"),
            wgl_h.C_CHAR.withName("BoolValue"),
            wgl_h.C_CHAR.withName("Int8Value"),
            wgl_h.C_CHAR.withName("UInt8Value"),
            wgl_h.C_SHORT.withName("Int16Value"),
            wgl_h.C_SHORT.withName("UInt16Value"),
            wgl_h.C_INT.withName("Int32Value"),
            wgl_h.C_INT.withName("UInt32Value"),
            wgl_h.C_LONG_LONG.withName("Int64Value"),
            wgl_h.C_LONG_LONG.withName("UInt64Value"),
            wgl_h.C_POINTER.withName("AnsiStringValue"),
            wgl_h.C_POINTER.withName("UnicodeStringValue")
