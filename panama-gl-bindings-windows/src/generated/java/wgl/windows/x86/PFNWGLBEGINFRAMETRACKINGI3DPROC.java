...
public interface PFNWGLBEGINFRAMETRACKINGI3DPROC {
    ...
    static MemorySegment allocate(PFNWGLBEGINFRAMETRACKINGI3DPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNWGLBEGINFRAMETRACKINGI3DPROC.class, fi, constants$1401.PFNWGLBEGINFRAMETRACKINGI3DPROC$FUNC, session);
    }
    static PFNWGLBEGINFRAMETRACKINGI3DPROC ofAddress(MemoryAddress addr, MemorySession session) {
        MemorySegment symbol = MemorySegment.ofAddress(addr, 0, session);
        return () -> {
            try {
                return (int)constants$1401.PFNWGLBEGINFRAMETRACKINGI3DPROC$MH.invokeExact((Addressable)symbol);
            } catch (Throwable ex$) {
