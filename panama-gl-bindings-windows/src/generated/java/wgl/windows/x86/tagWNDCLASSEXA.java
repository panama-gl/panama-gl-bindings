...
public class tagWNDCLASSEXA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        wgl_h.C_INT.withName("style"),
        wgl_h.C_POINTER.withName("lpfnWndProc"),
        wgl_h.C_INT.withName("cbClsExtra"),
        wgl_h.C_INT.withName("cbWndExtra"),
        wgl_h.C_POINTER.withName("hInstance"),
        wgl_h.C_POINTER.withName("hIcon"),
        wgl_h.C_POINTER.withName("hCursor"),
        wgl_h.C_POINTER.withName("hbrBackground"),
        wgl_h.C_POINTER.withName("lpszMenuName"),
        wgl_h.C_POINTER.withName("lpszClassName"),
        wgl_h.C_POINTER.withName("hIconSm")
