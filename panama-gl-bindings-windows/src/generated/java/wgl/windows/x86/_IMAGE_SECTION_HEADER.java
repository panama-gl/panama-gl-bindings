...
public class _IMAGE_SECTION_HEADER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(8, wgl_h.C_CHAR).withName("Name"),
        _IMAGE_SECTION_HEADER.Misc.layout().withName("Misc"),
        wgl_h.C_LONG.withName("VirtualAddress"),
        wgl_h.C_LONG.withName("SizeOfRawData"),
        wgl_h.C_LONG.withName("PointerToRawData"),
        wgl_h.C_LONG.withName("PointerToRelocations"),
        wgl_h.C_LONG.withName("PointerToLinenumbers"),
    ...
    public static class Misc {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
            wgl_h.C_LONG.withName("PhysicalAddress"),
            wgl_h.C_LONG.withName("VirtualSize")
