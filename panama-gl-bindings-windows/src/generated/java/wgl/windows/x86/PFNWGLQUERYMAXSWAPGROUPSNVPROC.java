...
public interface PFNWGLQUERYMAXSWAPGROUPSNVPROC {
    ...
    static MemorySegment allocate(PFNWGLQUERYMAXSWAPGROUPSNVPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNWGLQUERYMAXSWAPGROUPSNVPROC.class, fi, constants$1409.PFNWGLQUERYMAXSWAPGROUPSNVPROC$FUNC, session);
    }
    static PFNWGLQUERYMAXSWAPGROUPSNVPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _hDC, java.lang.foreign.MemoryAddress _maxGroups, java.lang.foreign.MemoryAddress _maxBarriers) -> {
            try {
                return (int)constants$1409.PFNWGLQUERYMAXSWAPGROUPSNVPROC$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_hDC, (java.lang.foreign.Addressable)_maxGroups, (java.lang.foreign.Addressable)_maxBarriers);
            } catch (Throwable ex$) {
