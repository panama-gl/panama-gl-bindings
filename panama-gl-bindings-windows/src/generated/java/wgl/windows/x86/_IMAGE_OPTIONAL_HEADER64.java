...
public class _IMAGE_OPTIONAL_HEADER64 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        wgl_h.align(wgl_h.C_LONG_LONG, 4).withName("SizeOfStackReserve"),
        wgl_h.align(wgl_h.C_LONG_LONG, 4).withName("SizeOfStackCommit"),
        wgl_h.align(wgl_h.C_LONG_LONG, 4).withName("SizeOfHeapReserve"),
        wgl_h.align(wgl_h.C_LONG_LONG, 4).withName("SizeOfHeapCommit"),
