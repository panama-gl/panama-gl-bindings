...
public class _IMAGE_TLS_DIRECTORY64 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        wgl_h.align(wgl_h.C_LONG_LONG, 4).withName("StartAddressOfRawData"),
        wgl_h.align(wgl_h.C_LONG_LONG, 4).withName("EndAddressOfRawData"),
        wgl_h.align(wgl_h.C_LONG_LONG, 4).withName("AddressOfIndex"),
        wgl_h.align(wgl_h.C_LONG_LONG, 4).withName("AddressOfCallBacks"),
