...
public class PPM_WMI_PERF_STATES_EX {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        wgl_h.C_LONG.withName("MaxFrequency"),
        wgl_h.C_LONG.withName("CurrentState"),
        wgl_h.C_LONG.withName("MaxPerfState"),
        wgl_h.C_LONG.withName("MinPerfState"),
        wgl_h.C_LONG.withName("LowestPerfState"),
        wgl_h.C_LONG.withName("ThermalConstraint"),
        wgl_h.C_CHAR.withName("BusyAdjThreshold"),
        wgl_h.C_CHAR.withName("PolicyType"),
        wgl_h.C_CHAR.withName("Type"),
        wgl_h.C_CHAR.withName("Reserved"),
        wgl_h.C_LONG.withName("TimerInterval"),
        MemoryLayout.paddingLayout(4),
        wgl_h.C_POINTER.withName("TargetProcessors"),
        wgl_h.C_LONG.withName("PStateHandler"),
        wgl_h.C_LONG.withName("PStateContext"),
        wgl_h.C_LONG.withName("TStateHandler"),
        wgl_h.C_LONG.withName("TStateContext"),
        wgl_h.C_LONG.withName("FeedbackHandler"),
