...
class constants$802 {
    ...
    static final MethodHandle CertAddEncodedCertificateToSystemStoreW$MH = RuntimeHelper.downcallHandle(
        ...
        constants$802.CertAddEncodedCertificateToSystemStoreW$FUNC
    );
    ...
    static final MethodHandle FindCertsByIssuer$MH = RuntimeHelper.downcallHandle(
        "FindCertsByIssuer",
        constants$802.FindCertsByIssuer$FUNC
    );
    ...
    static final MethodHandle CryptQueryObject$MH = RuntimeHelper.downcallHandle(
        "CryptQueryObject",
        constants$802.CryptQueryObject$FUNC
    );
    ...
    static final MethodHandle CryptMemAlloc$MH = RuntimeHelper.downcallHandle(
        "CryptMemAlloc",
        constants$802.CryptMemAlloc$FUNC
    );
    ...
    static final MethodHandle CryptMemRealloc$MH = RuntimeHelper.downcallHandle(
        "CryptMemRealloc",
        constants$802.CryptMemRealloc$FUNC
    );
    ...
    static final MethodHandle CryptMemFree$MH = RuntimeHelper.downcallHandle(
        "CryptMemFree",
        constants$802.CryptMemFree$FUNC
    );
}
