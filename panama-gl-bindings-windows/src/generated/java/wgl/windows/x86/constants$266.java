...
class constants$266 {
    ...
    static final MethodHandle InitAtomTable$MH = RuntimeHelper.downcallHandle(
        "InitAtomTable",
        constants$266.InitAtomTable$FUNC
    );
    ...
    static final MethodHandle SetHandleCount$MH = RuntimeHelper.downcallHandle(
        "SetHandleCount",
        constants$266.SetHandleCount$FUNC
    );
    ...
    static final MethodHandle RequestDeviceWakeup$MH = RuntimeHelper.downcallHandle(
        "RequestDeviceWakeup",
        constants$266.RequestDeviceWakeup$FUNC
    );
    ...
    static final MethodHandle CancelDeviceWakeupRequest$MH = RuntimeHelper.downcallHandle(
        ...
        constants$266.CancelDeviceWakeupRequest$FUNC
    );
    ...
    static final MethodHandle GetDevicePowerState$MH = RuntimeHelper.downcallHandle(
        "GetDevicePowerState",
        constants$266.GetDevicePowerState$FUNC
    );
}
