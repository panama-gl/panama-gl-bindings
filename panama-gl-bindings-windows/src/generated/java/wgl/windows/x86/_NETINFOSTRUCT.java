...
public class _NETINFOSTRUCT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        wgl_h.C_LONG.withName("dwProviderVersion"),
        wgl_h.C_LONG.withName("dwStatus"),
        wgl_h.C_LONG.withName("dwCharacteristics"),
        wgl_h.C_LONG_LONG.withName("dwHandle"),
        wgl_h.C_SHORT.withName("wNetType"),
        MemoryLayout.paddingLayout(2),
        wgl_h.C_LONG.withName("dwPrinters"),
        wgl_h.C_LONG.withName("dwDrives"),
