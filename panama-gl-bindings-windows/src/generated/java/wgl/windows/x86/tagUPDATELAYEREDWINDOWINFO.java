...
public class tagUPDATELAYEREDWINDOWINFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        wgl_h.C_POINTER.withName("hdcDst"),
        wgl_h.C_POINTER.withName("pptDst"),
        wgl_h.C_POINTER.withName("psize"),
        wgl_h.C_POINTER.withName("hdcSrc"),
        wgl_h.C_POINTER.withName("pptSrc"),
        wgl_h.C_LONG.withName("crKey"),
        MemoryLayout.paddingLayout(4),
        wgl_h.C_POINTER.withName("pblend"),
        wgl_h.C_LONG.withName("dwFlags"),
        MemoryLayout.paddingLayout(4),
        wgl_h.C_POINTER.withName("prcDirty")
