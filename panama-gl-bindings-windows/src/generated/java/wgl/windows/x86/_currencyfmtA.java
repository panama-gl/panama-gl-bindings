...
public class _currencyfmtA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        wgl_h.C_INT.withName("NumDigits"),
        wgl_h.C_INT.withName("LeadingZero"),
        wgl_h.C_INT.withName("Grouping"),
        MemoryLayout.paddingLayout(4),
        wgl_h.C_POINTER.withName("lpDecimalSep"),
        wgl_h.C_POINTER.withName("lpThousandSep"),
        wgl_h.C_INT.withName("NegativeOrder"),
        wgl_h.C_INT.withName("PositiveOrder"),
        wgl_h.C_POINTER.withName("lpCurrencySymbol")
