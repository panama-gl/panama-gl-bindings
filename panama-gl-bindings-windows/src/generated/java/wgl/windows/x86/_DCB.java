...
public class _DCB {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        wgl_h.C_LONG.withName("DCBlength"),
        wgl_h.C_LONG.withName("BaudRate"),
        MemoryLayout.paddingLayout(4),
        wgl_h.C_SHORT.withName("wReserved"),
        wgl_h.C_SHORT.withName("XonLim"),
        wgl_h.C_SHORT.withName("XoffLim"),
        wgl_h.C_CHAR.withName("ByteSize"),
        wgl_h.C_CHAR.withName("Parity"),
        wgl_h.C_CHAR.withName("StopBits"),
        wgl_h.C_CHAR.withName("XonChar"),
        wgl_h.C_CHAR.withName("XoffChar"),
        wgl_h.C_CHAR.withName("ErrorChar"),
        wgl_h.C_CHAR.withName("EofChar"),
        wgl_h.C_CHAR.withName("EvtChar"),
