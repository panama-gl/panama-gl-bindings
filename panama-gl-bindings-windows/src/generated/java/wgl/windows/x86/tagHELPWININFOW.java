...
public class tagHELPWININFOW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        wgl_h.C_INT.withName("wStructSize"),
        wgl_h.C_INT.withName("x"),
        wgl_h.C_INT.withName("y"),
        wgl_h.C_INT.withName("dx"),
        wgl_h.C_INT.withName("dy"),
        wgl_h.C_INT.withName("wMax"),
        MemoryLayout.sequenceLayout(2, wgl_h.C_SHORT).withName("rgchMember")
