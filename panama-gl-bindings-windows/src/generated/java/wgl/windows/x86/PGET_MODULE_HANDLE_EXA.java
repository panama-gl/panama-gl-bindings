...
public interface PGET_MODULE_HANDLE_EXA {
    ...
    static MemorySegment allocate(PGET_MODULE_HANDLE_EXA fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PGET_MODULE_HANDLE_EXA.class, fi, constants$226.PGET_MODULE_HANDLE_EXA$FUNC, session);
    }
    static PGET_MODULE_HANDLE_EXA ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _dwFlags, java.lang.foreign.MemoryAddress _lpModuleName, java.lang.foreign.MemoryAddress _phModule) -> {
            try {
                return (int)constants$226.PGET_MODULE_HANDLE_EXA$MH.invokeExact((Addressable)symbol, _dwFlags, (java.lang.foreign.Addressable)_lpModuleName, (java.lang.foreign.Addressable)_phModule);
            } catch (Throwable ex$) {
