...
public class _SCRUB_DATA_OUTPUT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        wgl_h.C_LONG_LONG.withName("ErrorFileOffset"),
        wgl_h.C_LONG_LONG.withName("ErrorLength"),
        wgl_h.C_LONG_LONG.withName("NumberOfBytesRepaired"),
        wgl_h.C_LONG_LONG.withName("NumberOfBytesFailed"),
        wgl_h.C_LONG_LONG.withName("InternalFileReference"),
        wgl_h.C_SHORT.withName("ResumeContextLength"),
        wgl_h.C_SHORT.withName("ParityExtentDataOffset"),
        MemoryLayout.sequenceLayout(9, wgl_h.C_LONG).withName("Reserved"),
        wgl_h.C_LONG_LONG.withName("NumberOfMetadataBytesProcessed"),
        wgl_h.C_LONG_LONG.withName("NumberOfDataBytesProcessed"),
        wgl_h.C_LONG_LONG.withName("TotalNumberOfMetadataBytesInUse"),
        wgl_h.C_LONG_LONG.withName("TotalNumberOfDataBytesInUse"),
