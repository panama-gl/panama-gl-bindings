...
public class HPBUFFERARB__ {

    static final  GroupLayout $struct$LAYOUT = MemoryLayout.structLayout(
        Constants$root.C_LONG$LAYOUT.withName("unused")
    ).withName("HPBUFFERARB__");
    public static MemoryLayout $LAYOUT() {
        return HPBUFFERARB__.$struct$LAYOUT;
    }
    ...
    public static VarHandle unused$VH() {
        return HPBUFFERARB__.unused$VH;
    }
    public static int unused$get(MemorySegment seg) {
        return (int)HPBUFFERARB__.unused$VH.get(seg);
    }
    public static void unused$set( MemorySegment seg, int x) {
        HPBUFFERARB__.unused$VH.set(seg, x);
    }
    public static int unused$get(MemorySegment seg, long index) {
        return (int)HPBUFFERARB__.unused$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void unused$set(MemorySegment seg, long index, int x) {
        HPBUFFERARB__.unused$VH.set(seg.asSlice(index*sizeof()), x);
    }
