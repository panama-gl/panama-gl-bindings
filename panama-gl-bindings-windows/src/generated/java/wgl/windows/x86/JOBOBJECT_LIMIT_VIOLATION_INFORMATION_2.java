...
public class JOBOBJECT_LIMIT_VIOLATION_INFORMATION_2 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.unionLayout(
            wgl_h.C_LONG_LONG.withName("JobHighMemoryLimit"),
            wgl_h.C_LONG_LONG.withName("JobMemoryLimit")
        ).withName("$anon$12117:5"),
        MemoryLayout.unionLayout(
            wgl_h.C_INT.withName("RateControlTolerance"),
            wgl_h.C_INT.withName("CpuRateControlTolerance")
        ).withName("$anon$12122:5"),
        MemoryLayout.unionLayout(
            wgl_h.C_INT.withName("RateControlToleranceLimit"),
            wgl_h.C_INT.withName("CpuRateControlToleranceLimit")
        ).withName("$anon$12127:5"),
        wgl_h.C_LONG_LONG.withName("JobLowMemoryLimit"),
        wgl_h.C_INT.withName("IoRateControlTolerance"),
        wgl_h.C_INT.withName("IoRateControlToleranceLimit"),
        wgl_h.C_INT.withName("NetRateControlTolerance"),
        wgl_h.C_INT.withName("NetRateControlToleranceLimit")
