...
public class IPersistStorageVtbl {
    ...
    public static class InitNew {
        ...
        private static final MethodHandle UP$MH = wgl_h.upcallHandle(InitNew.Function.class, "apply", $DESC);
    ...
    public static class HandsOffStorage {
        ...
        private static final MethodHandle UP$MH = wgl_h.upcallHandle(HandsOffStorage.Function.class, "apply", $DESC);
