...
public interface PFNWGLGETEXTENSIONSSTRINGARBPROC {
    ...
    static MemorySegment allocate(PFNWGLGETEXTENSIONSSTRINGARBPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNWGLGETEXTENSIONSSTRINGARBPROC.class, fi, constants$1378.PFNWGLGETEXTENSIONSSTRINGARBPROC$FUNC, session);
    }
    static PFNWGLGETEXTENSIONSSTRINGARBPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _hdc) -> {
            try {
                return (java.lang.foreign.Addressable)(java.lang.foreign.MemoryAddress)constants$1378.PFNWGLGETEXTENSIONSSTRINGARBPROC$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_hdc);
            } catch (Throwable ex$) {
