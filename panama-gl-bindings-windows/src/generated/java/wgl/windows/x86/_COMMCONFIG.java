...
public class _COMMCONFIG {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        wgl_h.C_LONG.withName("dwProviderSubType"),
        wgl_h.C_LONG.withName("dwProviderOffset"),
        wgl_h.C_LONG.withName("dwProviderSize"),
        MemoryLayout.sequenceLayout(1, wgl_h.C_SHORT).withName("wcProviderData"),
