...
public class _TOKEN_ACCESS_INFORMATION {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        wgl_h.C_POINTER.withName("SidHash"),
        wgl_h.C_POINTER.withName("RestrictedSidHash"),
        wgl_h.C_POINTER.withName("Privileges"),
        _LUID.layout().withName("AuthenticationId"),
        wgl_h.C_INT.withName("TokenType"),
        wgl_h.C_INT.withName("ImpersonationLevel"),
        _TOKEN_MANDATORY_POLICY.layout().withName("MandatoryPolicy"),
        wgl_h.C_LONG.withName("Flags"),
        wgl_h.C_LONG.withName("AppContainerNumber"),
        MemoryLayout.paddingLayout(4),
        wgl_h.C_POINTER.withName("PackageSid"),
        wgl_h.C_POINTER.withName("CapabilitiesHash"),
        wgl_h.C_POINTER.withName("TrustLevelSid"),
        wgl_h.C_POINTER.withName("SecurityAttributes")
