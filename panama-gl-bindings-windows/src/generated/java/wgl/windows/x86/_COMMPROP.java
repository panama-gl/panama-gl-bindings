...
public class _COMMPROP {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        wgl_h.C_SHORT.withName("wPacketLength"),
        wgl_h.C_SHORT.withName("wPacketVersion"),
        wgl_h.C_LONG.withName("dwServiceMask"),
        wgl_h.C_LONG.withName("dwReserved1"),
        wgl_h.C_LONG.withName("dwMaxTxQueue"),
        wgl_h.C_LONG.withName("dwMaxRxQueue"),
        wgl_h.C_LONG.withName("dwMaxBaud"),
        wgl_h.C_LONG.withName("dwProvSubType"),
        wgl_h.C_LONG.withName("dwProvCapabilities"),
        wgl_h.C_LONG.withName("dwSettableParams"),
        wgl_h.C_LONG.withName("dwSettableBaud"),
        wgl_h.C_SHORT.withName("wSettableData"),
        wgl_h.C_SHORT.withName("wSettableStopParity"),
        wgl_h.C_LONG.withName("dwCurrentTxQueue"),
        wgl_h.C_LONG.withName("dwCurrentRxQueue"),
        wgl_h.C_LONG.withName("dwProvSpec1"),
        wgl_h.C_LONG.withName("dwProvSpec2"),
        MemoryLayout.sequenceLayout(1, wgl_h.C_SHORT).withName("wcProvChar"),
