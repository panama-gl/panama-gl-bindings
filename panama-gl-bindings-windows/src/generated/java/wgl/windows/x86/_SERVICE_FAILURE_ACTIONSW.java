...
public class _SERVICE_FAILURE_ACTIONSW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        wgl_h.C_LONG.withName("dwResetPeriod"),
        MemoryLayout.paddingLayout(4),
        wgl_h.C_POINTER.withName("lpRebootMsg"),
        wgl_h.C_POINTER.withName("lpCommand"),
        wgl_h.C_LONG.withName("cActions"),
        MemoryLayout.paddingLayout(4),
        wgl_h.C_POINTER.withName("lpsaActions")
