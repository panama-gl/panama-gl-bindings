...
public class tagRAWMOUSE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        wgl_h.C_SHORT.withName("usFlags"),
        MemoryLayout.paddingLayout(2),
        MemoryLayout.unionLayout(
            wgl_h.C_LONG.withName("ulButtons"),
            MemoryLayout.structLayout(
                wgl_h.C_SHORT.withName("usButtonFlags"),
                wgl_h.C_SHORT.withName("usButtonData")
            ).withName("$anon$14916:9")
        ).withName("$anon$14914:5"),
        wgl_h.C_LONG.withName("ulRawButtons"),
        wgl_h.C_LONG.withName("lLastX"),
        wgl_h.C_LONG.withName("lLastY"),
        wgl_h.C_LONG.withName("ulExtraInformation")
