...
public class _STARTUPINFOA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        wgl_h.C_POINTER.withName("lpReserved"),
        wgl_h.C_POINTER.withName("lpDesktop"),
        wgl_h.C_POINTER.withName("lpTitle"),
        wgl_h.C_LONG.withName("dwX"),
        wgl_h.C_LONG.withName("dwY"),
        wgl_h.C_LONG.withName("dwXSize"),
        wgl_h.C_LONG.withName("dwYSize"),
        wgl_h.C_LONG.withName("dwXCountChars"),
        wgl_h.C_LONG.withName("dwYCountChars"),
        wgl_h.C_LONG.withName("dwFillAttribute"),
        wgl_h.C_LONG.withName("dwFlags"),
        wgl_h.C_SHORT.withName("wShowWindow"),
        wgl_h.C_SHORT.withName("cbReserved2"),
        MemoryLayout.paddingLayout(4),
        wgl_h.C_POINTER.withName("lpReserved2"),
        wgl_h.C_POINTER.withName("hStdInput"),
        wgl_h.C_POINTER.withName("hStdOutput"),
        wgl_h.C_POINTER.withName("hStdError")
