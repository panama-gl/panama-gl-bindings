...
public class tagPANOSE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        wgl_h.C_CHAR.withName("bFamilyType"),
        wgl_h.C_CHAR.withName("bSerifStyle"),
        wgl_h.C_CHAR.withName("bWeight"),
        wgl_h.C_CHAR.withName("bProportion"),
        wgl_h.C_CHAR.withName("bContrast"),
        wgl_h.C_CHAR.withName("bStrokeVariation"),
        wgl_h.C_CHAR.withName("bArmStyle"),
        wgl_h.C_CHAR.withName("bLetterform"),
        wgl_h.C_CHAR.withName("bMidline"),
        wgl_h.C_CHAR.withName("bXHeight")
    ).withName("tagPANOSE");
