...
public class _IMAGE_OS2_HEADER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        wgl_h.C_SHORT.withName("ne_magic"),
        wgl_h.C_CHAR.withName("ne_ver"),
        wgl_h.C_CHAR.withName("ne_rev"),
        wgl_h.C_SHORT.withName("ne_enttab"),
        wgl_h.C_SHORT.withName("ne_cbenttab"),
        wgl_h.align(wgl_h.C_LONG, 2).withName("ne_crc"),
        wgl_h.C_SHORT.withName("ne_flags"),
        wgl_h.C_SHORT.withName("ne_autodata"),
        wgl_h.C_SHORT.withName("ne_heap"),
        wgl_h.C_SHORT.withName("ne_stack"),
        wgl_h.align(wgl_h.C_LONG, 2).withName("ne_csip"),
        wgl_h.align(wgl_h.C_LONG, 2).withName("ne_sssp"),
        wgl_h.C_SHORT.withName("ne_cseg"),
        wgl_h.C_SHORT.withName("ne_cmod"),
        wgl_h.C_SHORT.withName("ne_cbnrestab"),
        wgl_h.C_SHORT.withName("ne_segtab"),
        wgl_h.C_SHORT.withName("ne_rsrctab"),
        wgl_h.C_SHORT.withName("ne_restab"),
        wgl_h.C_SHORT.withName("ne_modtab"),
        wgl_h.C_SHORT.withName("ne_imptab"),
        wgl_h.align(wgl_h.C_LONG, 2).withName("ne_nrestab"),
        wgl_h.C_SHORT.withName("ne_cmovent"),
        wgl_h.C_SHORT.withName("ne_align"),
        wgl_h.C_SHORT.withName("ne_cres"),
        wgl_h.C_CHAR.withName("ne_exetyp"),
        wgl_h.C_CHAR.withName("ne_flagsothers"),
        wgl_h.C_SHORT.withName("ne_pretthunks"),
        wgl_h.C_SHORT.withName("ne_psegrefbytes"),
        wgl_h.C_SHORT.withName("ne_swaparea"),
        wgl_h.C_SHORT.withName("ne_expver")
