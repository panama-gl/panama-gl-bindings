...
public class DLGTEMPLATE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        wgl_h.align(wgl_h.C_LONG, 2).withName("style"),
        wgl_h.align(wgl_h.C_LONG, 2).withName("dwExtendedStyle"),
        wgl_h.C_SHORT.withName("cdit"),
        wgl_h.C_SHORT.withName("x"),
        wgl_h.C_SHORT.withName("y"),
        wgl_h.C_SHORT.withName("cx"),
        wgl_h.C_SHORT.withName("cy")
    ).withName("$anon$4904:9");
