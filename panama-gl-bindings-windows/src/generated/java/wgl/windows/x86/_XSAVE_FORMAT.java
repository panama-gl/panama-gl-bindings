...
public class _XSAVE_FORMAT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        wgl_h.C_SHORT.withName("ControlWord"),
        wgl_h.C_SHORT.withName("StatusWord"),
        wgl_h.C_CHAR.withName("TagWord"),
        wgl_h.C_CHAR.withName("Reserved1"),
        wgl_h.C_SHORT.withName("ErrorOpcode"),
        wgl_h.C_LONG.withName("ErrorOffset"),
        wgl_h.C_SHORT.withName("ErrorSelector"),
        wgl_h.C_SHORT.withName("Reserved2"),
        wgl_h.C_LONG.withName("DataOffset"),
        wgl_h.C_SHORT.withName("DataSelector"),
        wgl_h.C_SHORT.withName("Reserved3"),
        wgl_h.C_LONG.withName("MxCsr"),
        wgl_h.C_LONG.withName("MxCsr_Mask"),
        ...
        MemoryLayout.sequenceLayout(96, wgl_h.C_CHAR).withName("Reserved4")
