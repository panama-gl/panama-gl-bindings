...
public class _WOW64_FLOATING_SAVE_AREA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        wgl_h.C_LONG.withName("ControlWord"),
        wgl_h.C_LONG.withName("StatusWord"),
        wgl_h.C_LONG.withName("TagWord"),
        wgl_h.C_LONG.withName("ErrorOffset"),
        wgl_h.C_LONG.withName("ErrorSelector"),
        wgl_h.C_LONG.withName("DataOffset"),
        wgl_h.C_LONG.withName("DataSelector"),
        MemoryLayout.sequenceLayout(80, wgl_h.C_CHAR).withName("RegisterArea"),
        wgl_h.C_LONG.withName("Cr0NpxState")
