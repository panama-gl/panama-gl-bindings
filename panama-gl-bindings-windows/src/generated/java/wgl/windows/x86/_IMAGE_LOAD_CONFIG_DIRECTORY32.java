...
public class _IMAGE_LOAD_CONFIG_DIRECTORY32 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        wgl_h.C_LONG.withName("DeCommitFreeBlockThreshold"),
        wgl_h.C_LONG.withName("DeCommitTotalFreeThreshold"),
        wgl_h.C_LONG.withName("LockPrefixTable"),
        wgl_h.C_LONG.withName("MaximumAllocationSize"),
        wgl_h.C_LONG.withName("VirtualMemoryThreshold"),
        wgl_h.C_LONG.withName("ProcessHeapFlags"),
        wgl_h.C_LONG.withName("ProcessAffinityMask"),
        wgl_h.C_SHORT.withName("CSDVersion"),
        wgl_h.C_SHORT.withName("DependentLoadFlags"),
        wgl_h.C_LONG.withName("EditList"),
        wgl_h.C_LONG.withName("SecurityCookie"),
        wgl_h.C_LONG.withName("SEHandlerTable"),
        wgl_h.C_LONG.withName("SEHandlerCount"),
        wgl_h.C_LONG.withName("GuardCFCheckFunctionPointer"),
        wgl_h.C_LONG.withName("GuardCFDispatchFunctionPointer"),
        wgl_h.C_LONG.withName("GuardCFFunctionTable"),
        wgl_h.C_LONG.withName("GuardCFFunctionCount"),
        wgl_h.C_LONG.withName("GuardFlags"),
        _IMAGE_LOAD_CONFIG_CODE_INTEGRITY.layout().withName("CodeIntegrity"),
        wgl_h.C_LONG.withName("GuardAddressTakenIatEntryTable"),
        wgl_h.C_LONG.withName("GuardAddressTakenIatEntryCount"),
        wgl_h.C_LONG.withName("GuardLongJumpTargetTable"),
        wgl_h.C_LONG.withName("GuardLongJumpTargetCount"),
        wgl_h.C_LONG.withName("DynamicValueRelocTable"),
        wgl_h.C_LONG.withName("CHPEMetadataPointer"),
        wgl_h.C_LONG.withName("GuardRFFailureRoutine"),
        wgl_h.C_LONG.withName("GuardRFFailureRoutineFunctionPointer"),
        ...
        wgl_h.C_LONG.withName("GuardRFVerifyStackPointerFunctionPointer"),
        wgl_h.C_LONG.withName("HotPatchTableOffset"),
        wgl_h.C_LONG.withName("Reserved3"),
        wgl_h.C_LONG.withName("EnclaveConfigurationPointer"),
        wgl_h.C_LONG.withName("VolatileMetadataPointer"),
        wgl_h.C_LONG.withName("GuardEHContinuationTable"),
        wgl_h.C_LONG.withName("GuardEHContinuationCount")
