...
public class tagENHMETAHEADER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        wgl_h.C_LONG.withName("dSignature"),
        wgl_h.C_LONG.withName("nVersion"),
        wgl_h.C_LONG.withName("nBytes"),
        wgl_h.C_LONG.withName("nRecords"),
        wgl_h.C_SHORT.withName("nHandles"),
        wgl_h.C_SHORT.withName("sReserved"),
        wgl_h.C_LONG.withName("nDescription"),
        wgl_h.C_LONG.withName("offDescription"),
        wgl_h.C_LONG.withName("nPalEntries"),
        tagSIZE.layout().withName("szlDevice"),
        tagSIZE.layout().withName("szlMillimeters"),
        wgl_h.C_LONG.withName("cbPixelFormat"),
        wgl_h.C_LONG.withName("offPixelFormat"),
        wgl_h.C_LONG.withName("bOpenGL"),
