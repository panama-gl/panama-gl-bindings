...
class constants$753 {
    ...
    static final MethodHandle PCRYPT_ENCRYPT_PRIVATE_KEY_FUNC$MH = RuntimeHelper.downcallHandle(
        constants$753.PCRYPT_ENCRYPT_PRIVATE_KEY_FUNC$FUNC
    );
    ...
    static final MethodHandle PCRYPT_RESOLVE_HCRYPTPROV_FUNC$MH = RuntimeHelper.downcallHandle(
        constants$753.PCRYPT_RESOLVE_HCRYPTPROV_FUNC$FUNC
    );
    ...
    static final MethodHandle CryptFormatObject$MH = RuntimeHelper.downcallHandle(
        "CryptFormatObject",
        constants$753.CryptFormatObject$FUNC
    );
    ...
    static final MethodHandle PFN_CRYPT_ALLOC$MH = RuntimeHelper.downcallHandle(
        constants$753.PFN_CRYPT_ALLOC$FUNC
    );
}
