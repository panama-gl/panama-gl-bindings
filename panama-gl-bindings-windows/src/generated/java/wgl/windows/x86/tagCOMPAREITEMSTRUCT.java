...
public class tagCOMPAREITEMSTRUCT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        wgl_h.C_INT.withName("itemID1"),
        MemoryLayout.paddingLayout(4),
        wgl_h.C_LONG_LONG.withName("itemData1"),
        wgl_h.C_INT.withName("itemID2"),
        MemoryLayout.paddingLayout(4),
        wgl_h.C_LONG_LONG.withName("itemData2"),
        wgl_h.C_LONG.withName("dwLocaleId"),
        MemoryLayout.paddingLayout(4)
