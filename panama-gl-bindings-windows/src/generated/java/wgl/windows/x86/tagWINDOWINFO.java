...
public class tagWINDOWINFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        wgl_h.C_LONG.withName("dwWindowStatus"),
        wgl_h.C_INT.withName("cxWindowBorders"),
        wgl_h.C_INT.withName("cyWindowBorders"),
        wgl_h.C_SHORT.withName("atomWindowType"),
        wgl_h.C_SHORT.withName("wCreatorVersion")
