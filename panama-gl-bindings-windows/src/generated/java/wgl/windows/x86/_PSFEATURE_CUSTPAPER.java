...
public class _PSFEATURE_CUSTPAPER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        wgl_h.C_LONG.withName("lOrientation"),
        wgl_h.C_LONG.withName("lWidth"),
        wgl_h.C_LONG.withName("lHeight"),
        wgl_h.C_LONG.withName("lWidthOffset"),
        wgl_h.C_LONG.withName("lHeightOffset")
