...
public class _FILEMUIINFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(16, wgl_h.C_CHAR).withName("pChecksum"),
        MemoryLayout.sequenceLayout(16, wgl_h.C_CHAR).withName("pServiceChecksum"),
        wgl_h.C_LONG.withName("dwLanguageNameOffset"),
        wgl_h.C_LONG.withName("dwTypeIDMainSize"),
        wgl_h.C_LONG.withName("dwTypeIDMainOffset"),
        wgl_h.C_LONG.withName("dwTypeNameMainOffset"),
        wgl_h.C_LONG.withName("dwTypeIDMUISize"),
        wgl_h.C_LONG.withName("dwTypeIDMUIOffset"),
        wgl_h.C_LONG.withName("dwTypeNameMUIOffset"),
        MemoryLayout.sequenceLayout(8, wgl_h.C_CHAR).withName("abBuffer")
