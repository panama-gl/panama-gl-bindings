...
public class JOBOBJECT_IO_RATE_CONTROL_INFORMATION_NATIVE_V3 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        freeglut_h.C_LONG_LONG.withName("MaxIops"),
        freeglut_h.C_LONG_LONG.withName("MaxBandwidth"),
        freeglut_h.C_LONG_LONG.withName("ReservationIops"),
        freeglut_h.C_POINTER.withName("VolumeName"),
        freeglut_h.C_LONG.withName("BaseIoSize"),
        freeglut_h.C_INT.withName("ControlFlags"),
        freeglut_h.C_SHORT.withName("VolumeNameLength"),
        MemoryLayout.paddingLayout(6),
        freeglut_h.C_LONG_LONG.withName("CriticalReservationIops"),
        freeglut_h.C_LONG_LONG.withName("ReservationBandwidth"),
        freeglut_h.C_LONG_LONG.withName("CriticalReservationBandwidth"),
        freeglut_h.C_LONG_LONG.withName("MaxTimePercent"),
        freeglut_h.C_LONG_LONG.withName("ReservationTimePercent"),
        freeglut_h.C_LONG_LONG.withName("CriticalReservationTimePercent"),
        freeglut_h.C_LONG_LONG.withName("SoftMaxIops"),
        freeglut_h.C_LONG_LONG.withName("SoftMaxBandwidth"),
        freeglut_h.C_LONG_LONG.withName("SoftMaxTimePercent"),
        freeglut_h.C_LONG_LONG.withName("LimitExcessNotifyIops"),
        freeglut_h.C_LONG_LONG.withName("LimitExcessNotifyBandwidth"),
        freeglut_h.C_LONG_LONG.withName("LimitExcessNotifyTimePercent")
