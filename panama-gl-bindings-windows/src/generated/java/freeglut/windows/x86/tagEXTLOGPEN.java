...
public class tagEXTLOGPEN {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        freeglut_h.C_LONG.withName("elpPenStyle"),
        freeglut_h.C_LONG.withName("elpWidth"),
        freeglut_h.C_INT.withName("elpBrushStyle"),
        freeglut_h.C_LONG.withName("elpColor"),
        freeglut_h.C_LONG_LONG.withName("elpHatch"),
        freeglut_h.C_LONG.withName("elpNumEntries"),
        MemoryLayout.sequenceLayout(1, freeglut_h.C_LONG).withName("elpStyleEntry")
