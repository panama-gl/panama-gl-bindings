...
public class _IMAGE_DYNAMIC_RELOCATION64_V2 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        freeglut_h.align(freeglut_h.C_LONG, 1).withName("HeaderSize"),
        freeglut_h.align(freeglut_h.C_LONG, 1).withName("FixupInfoSize"),
        freeglut_h.align(freeglut_h.C_LONG_LONG, 1).withName("Symbol"),
        freeglut_h.align(freeglut_h.C_LONG, 1).withName("SymbolGroup"),
        freeglut_h.align(freeglut_h.C_LONG, 1).withName("Flags")
