...
public class _ACTIVATION_CONTEXT_ASSEMBLY_DETAILED_INFORMATION {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        freeglut_h.C_LONG.withName("ulEncodedAssemblyIdentityLength"),
        freeglut_h.C_LONG.withName("ulManifestPathType"),
        freeglut_h.C_LONG.withName("ulManifestPathLength"),
        _LARGE_INTEGER.layout().withName("liManifestLastWriteTime"),
        freeglut_h.C_LONG.withName("ulPolicyPathType"),
        freeglut_h.C_LONG.withName("ulPolicyPathLength"),
        _LARGE_INTEGER.layout().withName("liPolicyLastWriteTime"),
        freeglut_h.C_LONG.withName("ulMetadataSatelliteRosterIndex"),
        freeglut_h.C_LONG.withName("ulManifestVersionMajor"),
        freeglut_h.C_LONG.withName("ulManifestVersionMinor"),
        freeglut_h.C_LONG.withName("ulPolicyVersionMajor"),
        freeglut_h.C_LONG.withName("ulPolicyVersionMinor"),
        freeglut_h.C_LONG.withName("ulAssemblyDirectoryNameLength"),
        freeglut_h.C_POINTER.withName("lpAssemblyEncodedAssemblyIdentity"),
        freeglut_h.C_POINTER.withName("lpAssemblyManifestPath"),
        freeglut_h.C_POINTER.withName("lpAssemblyPolicyPath"),
        freeglut_h.C_POINTER.withName("lpAssemblyDirectoryName"),
        freeglut_h.C_LONG.withName("ulFileCount"),
