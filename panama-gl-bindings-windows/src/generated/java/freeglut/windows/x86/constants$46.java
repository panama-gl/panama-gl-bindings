...
class constants$46 {
    ...
    static final MethodHandle _bittestandset$MH = RuntimeHelper.downcallHandle(
        "_bittestandset",
        constants$46._bittestandset$FUNC
    );
    ...
    static final MethodHandle _bittestandreset$MH = RuntimeHelper.downcallHandle(
        "_bittestandreset",
        constants$46._bittestandreset$FUNC
    );
    ...
    static final MethodHandle _interlockedbittestandset$MH = RuntimeHelper.downcallHandle(
        ...
        constants$46._interlockedbittestandset$FUNC
    );
    ...
    static final MethodHandle _interlockedbittestandreset$MH = RuntimeHelper.downcallHandle(
        ...
        constants$46._interlockedbittestandreset$FUNC
    );
    ...
    static final MethodHandle _bittestandcomplement64$MH = RuntimeHelper.downcallHandle(
        ...
        constants$46._bittestandcomplement64$FUNC
    );
}
