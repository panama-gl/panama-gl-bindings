...
public class tagLOGCOLORSPACEW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        freeglut_h.C_LONG.withName("lcsSignature"),
        freeglut_h.C_LONG.withName("lcsVersion"),
        freeglut_h.C_LONG.withName("lcsSize"),
        freeglut_h.C_LONG.withName("lcsCSType"),
        freeglut_h.C_LONG.withName("lcsIntent"),
        tagICEXYZTRIPLE.layout().withName("lcsEndpoints"),
        freeglut_h.C_LONG.withName("lcsGammaRed"),
        freeglut_h.C_LONG.withName("lcsGammaGreen"),
        freeglut_h.C_LONG.withName("lcsGammaBlue"),
        MemoryLayout.sequenceLayout(260, freeglut_h.C_SHORT).withName("lcsFilename")
