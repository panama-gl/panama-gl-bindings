...
public class _ACTIVATION_CONTEXT_DETAILED_INFORMATION {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        freeglut_h.C_LONG.withName("ulFormatVersion"),
        freeglut_h.C_LONG.withName("ulAssemblyCount"),
        freeglut_h.C_LONG.withName("ulRootManifestPathType"),
        freeglut_h.C_LONG.withName("ulRootManifestPathChars"),
        freeglut_h.C_LONG.withName("ulRootConfigurationPathType"),
        freeglut_h.C_LONG.withName("ulRootConfigurationPathChars"),
        freeglut_h.C_LONG.withName("ulAppDirPathType"),
        freeglut_h.C_LONG.withName("ulAppDirPathChars"),
        MemoryLayout.paddingLayout(4),
        freeglut_h.C_POINTER.withName("lpRootManifestPath"),
        freeglut_h.C_POINTER.withName("lpRootConfigurationPath"),
        freeglut_h.C_POINTER.withName("lpAppDirPath")
