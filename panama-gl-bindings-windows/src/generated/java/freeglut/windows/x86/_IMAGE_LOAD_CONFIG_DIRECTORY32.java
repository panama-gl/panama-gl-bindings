...
public class _IMAGE_LOAD_CONFIG_DIRECTORY32 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        freeglut_h.C_LONG.withName("DeCommitFreeBlockThreshold"),
        freeglut_h.C_LONG.withName("DeCommitTotalFreeThreshold"),
        freeglut_h.C_LONG.withName("LockPrefixTable"),
        freeglut_h.C_LONG.withName("MaximumAllocationSize"),
        freeglut_h.C_LONG.withName("VirtualMemoryThreshold"),
        freeglut_h.C_LONG.withName("ProcessHeapFlags"),
        freeglut_h.C_LONG.withName("ProcessAffinityMask"),
        freeglut_h.C_SHORT.withName("CSDVersion"),
        freeglut_h.C_SHORT.withName("DependentLoadFlags"),
        freeglut_h.C_LONG.withName("EditList"),
        freeglut_h.C_LONG.withName("SecurityCookie"),
        freeglut_h.C_LONG.withName("SEHandlerTable"),
        freeglut_h.C_LONG.withName("SEHandlerCount"),
        freeglut_h.C_LONG.withName("GuardCFCheckFunctionPointer"),
        freeglut_h.C_LONG.withName("GuardCFDispatchFunctionPointer"),
        freeglut_h.C_LONG.withName("GuardCFFunctionTable"),
        freeglut_h.C_LONG.withName("GuardCFFunctionCount"),
        freeglut_h.C_LONG.withName("GuardFlags"),
        _IMAGE_LOAD_CONFIG_CODE_INTEGRITY.layout().withName("CodeIntegrity"),
        freeglut_h.C_LONG.withName("GuardAddressTakenIatEntryTable"),
        freeglut_h.C_LONG.withName("GuardAddressTakenIatEntryCount"),
        freeglut_h.C_LONG.withName("GuardLongJumpTargetTable"),
        freeglut_h.C_LONG.withName("GuardLongJumpTargetCount"),
        freeglut_h.C_LONG.withName("DynamicValueRelocTable"),
        freeglut_h.C_LONG.withName("CHPEMetadataPointer"),
        freeglut_h.C_LONG.withName("GuardRFFailureRoutine"),
        freeglut_h.C_LONG.withName("GuardRFFailureRoutineFunctionPointer"),
        ...
        freeglut_h.C_LONG.withName("GuardRFVerifyStackPointerFunctionPointer"),
        freeglut_h.C_LONG.withName("HotPatchTableOffset"),
        freeglut_h.C_LONG.withName("Reserved3"),
        freeglut_h.C_LONG.withName("EnclaveConfigurationPointer"),
        freeglut_h.C_LONG.withName("VolatileMetadataPointer"),
        freeglut_h.C_LONG.withName("GuardEHContinuationTable"),
        freeglut_h.C_LONG.withName("GuardEHContinuationCount")
