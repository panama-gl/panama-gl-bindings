...
public class _OVERLAPPED {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        freeglut_h.C_LONG_LONG.withName("Internal"),
        freeglut_h.C_LONG_LONG.withName("InternalHigh"),
        MemoryLayout.unionLayout(
            MemoryLayout.structLayout(
                freeglut_h.C_LONG.withName("Offset"),
                freeglut_h.C_LONG.withName("OffsetHigh")
            ).withName("$anon$56:9"),
            freeglut_h.C_POINTER.withName("Pointer")
        ).withName("$anon$55:5"),
        freeglut_h.C_POINTER.withName("hEvent")
