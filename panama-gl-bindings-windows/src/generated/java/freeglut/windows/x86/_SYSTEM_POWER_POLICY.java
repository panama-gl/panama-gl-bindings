...
public class _SYSTEM_POWER_POLICY {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        freeglut_h.C_INT.withName("LidOpenWake"),
        freeglut_h.C_LONG.withName("Reserved"),
        POWER_ACTION_POLICY.layout().withName("Idle"),
        freeglut_h.C_LONG.withName("IdleTimeout"),
        freeglut_h.C_CHAR.withName("IdleSensitivity"),
        freeglut_h.C_CHAR.withName("DynamicThrottle"),
        MemoryLayout.sequenceLayout(2, freeglut_h.C_CHAR).withName("Spare2"),
        freeglut_h.C_INT.withName("MinSleep"),
        freeglut_h.C_INT.withName("MaxSleep"),
        freeglut_h.C_INT.withName("ReducedLatencySleep"),
        freeglut_h.C_LONG.withName("WinLogonFlags"),
        freeglut_h.C_LONG.withName("Spare3"),
        freeglut_h.C_LONG.withName("DozeS4Timeout"),
        freeglut_h.C_LONG.withName("BroadcastCapacityResolution"),
        MemoryLayout.sequenceLayout(4, SYSTEM_POWER_LEVEL.layout()).withName("DischargePolicy"),
        freeglut_h.C_LONG.withName("VideoTimeout"),
        freeglut_h.C_CHAR.withName("VideoDimDisplay"),
        MemoryLayout.paddingLayout(3),
        MemoryLayout.sequenceLayout(3, freeglut_h.C_LONG).withName("VideoReserved"),
        freeglut_h.C_LONG.withName("SpindownTimeout"),
        freeglut_h.C_CHAR.withName("OptimizeForPower"),
        freeglut_h.C_CHAR.withName("FanThrottleTolerance"),
        freeglut_h.C_CHAR.withName("ForcedThrottle"),
