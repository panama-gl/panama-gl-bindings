...
public class tagPOINTER_DEVICE_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        freeglut_h.C_LONG.withName("displayOrientation"),
        MemoryLayout.paddingLayout(4),
        freeglut_h.C_POINTER.withName("device"),
        freeglut_h.C_INT.withName("pointerDeviceType"),
        MemoryLayout.paddingLayout(4),
        freeglut_h.C_POINTER.withName("monitor"),
        freeglut_h.C_LONG.withName("startingCursorId"),
        freeglut_h.C_SHORT.withName("maxActiveContacts"),
        MemoryLayout.sequenceLayout(520, freeglut_h.C_SHORT).withName("productString"),
