...
public class SYSTEM_POWER_CAPABILITIES {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        freeglut_h.C_CHAR.withName("PowerButtonPresent"),
        freeglut_h.C_CHAR.withName("SleepButtonPresent"),
        freeglut_h.C_CHAR.withName("LidPresent"),
        freeglut_h.C_CHAR.withName("SystemS1"),
        freeglut_h.C_CHAR.withName("SystemS2"),
        freeglut_h.C_CHAR.withName("SystemS3"),
        freeglut_h.C_CHAR.withName("SystemS4"),
        freeglut_h.C_CHAR.withName("SystemS5"),
        freeglut_h.C_CHAR.withName("HiberFilePresent"),
        freeglut_h.C_CHAR.withName("FullWake"),
        freeglut_h.C_CHAR.withName("VideoDimPresent"),
        freeglut_h.C_CHAR.withName("ApmPresent"),
        freeglut_h.C_CHAR.withName("UpsPresent"),
        freeglut_h.C_CHAR.withName("ThermalControl"),
        freeglut_h.C_CHAR.withName("ProcessorThrottle"),
        freeglut_h.C_CHAR.withName("ProcessorMinThrottle"),
        freeglut_h.C_CHAR.withName("ProcessorMaxThrottle"),
        freeglut_h.C_CHAR.withName("FastSystemS4"),
        freeglut_h.C_CHAR.withName("Hiberboot"),
        freeglut_h.C_CHAR.withName("WakeAlarmPresent"),
        freeglut_h.C_CHAR.withName("AoAc"),
        freeglut_h.C_CHAR.withName("DiskSpinDown"),
        freeglut_h.C_CHAR.withName("HiberFileType"),
        freeglut_h.C_CHAR.withName("AoAcConnectivitySupported"),
        MemoryLayout.sequenceLayout(6, freeglut_h.C_CHAR).withName("spare3"),
        freeglut_h.C_CHAR.withName("SystemBatteriesPresent"),
        freeglut_h.C_CHAR.withName("BatteriesAreShortTerm"),
        MemoryLayout.sequenceLayout(3, BATTERY_REPORTING_SCALE.layout()).withName("BatteryScale"),
        freeglut_h.C_INT.withName("AcOnLineWake"),
        freeglut_h.C_INT.withName("SoftLidWake"),
        freeglut_h.C_INT.withName("RtcWake"),
        freeglut_h.C_INT.withName("MinDeviceWakeState"),
        freeglut_h.C_INT.withName("DefaultLowLatencyWake")
