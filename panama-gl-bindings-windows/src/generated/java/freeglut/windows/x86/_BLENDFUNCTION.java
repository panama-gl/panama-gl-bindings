...
public class _BLENDFUNCTION {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        freeglut_h.C_CHAR.withName("BlendOp"),
        freeglut_h.C_CHAR.withName("BlendFlags"),
        freeglut_h.C_CHAR.withName("SourceConstantAlpha"),
        freeglut_h.C_CHAR.withName("AlphaFormat")
