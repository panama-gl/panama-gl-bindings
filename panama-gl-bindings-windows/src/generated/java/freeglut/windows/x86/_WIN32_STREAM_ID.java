...
public class _WIN32_STREAM_ID {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        freeglut_h.C_LONG.withName("dwStreamId"),
        freeglut_h.C_LONG.withName("dwStreamAttributes"),
        _LARGE_INTEGER.layout().withName("Size"),
        freeglut_h.C_LONG.withName("dwStreamNameSize"),
        MemoryLayout.sequenceLayout(1, freeglut_h.C_SHORT).withName("cStreamName"),
