...
public class tagBITMAPFILEHEADER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        freeglut_h.C_SHORT.withName("bfType"),
        freeglut_h.align(freeglut_h.C_LONG, 2).withName("bfSize"),
        freeglut_h.C_SHORT.withName("bfReserved1"),
        freeglut_h.C_SHORT.withName("bfReserved2"),
        freeglut_h.align(freeglut_h.C_LONG, 2).withName("bfOffBits")
