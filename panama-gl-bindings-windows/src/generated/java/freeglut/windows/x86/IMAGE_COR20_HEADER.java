...
public class IMAGE_COR20_HEADER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        freeglut_h.C_SHORT.withName("MajorRuntimeVersion"),
        freeglut_h.C_SHORT.withName("MinorRuntimeVersion"),
        _IMAGE_DATA_DIRECTORY.layout().withName("MetaData"),
        freeglut_h.C_LONG.withName("Flags"),
        MemoryLayout.unionLayout(
            freeglut_h.C_LONG.withName("EntryPointToken"),
            freeglut_h.C_LONG.withName("EntryPointRVA")
