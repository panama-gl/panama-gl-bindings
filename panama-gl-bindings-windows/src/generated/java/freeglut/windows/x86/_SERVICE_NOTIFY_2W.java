...
public class _SERVICE_NOTIFY_2W {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        freeglut_h.C_POINTER.withName("pfnNotifyCallback"),
        freeglut_h.C_POINTER.withName("pContext"),
        freeglut_h.C_LONG.withName("dwNotificationStatus"),
        _SERVICE_STATUS_PROCESS.layout().withName("ServiceStatus"),
        freeglut_h.C_LONG.withName("dwNotificationTriggered"),
        MemoryLayout.paddingLayout(4),
        freeglut_h.C_POINTER.withName("pszServiceNames")
