...
public class tagCOLORADJUSTMENT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        freeglut_h.C_SHORT.withName("caSize"),
        freeglut_h.C_SHORT.withName("caFlags"),
        freeglut_h.C_SHORT.withName("caIlluminantIndex"),
        freeglut_h.C_SHORT.withName("caRedGamma"),
        freeglut_h.C_SHORT.withName("caGreenGamma"),
        freeglut_h.C_SHORT.withName("caBlueGamma"),
        freeglut_h.C_SHORT.withName("caReferenceBlack"),
        freeglut_h.C_SHORT.withName("caReferenceWhite"),
        freeglut_h.C_SHORT.withName("caContrast"),
        freeglut_h.C_SHORT.withName("caBrightness"),
        freeglut_h.C_SHORT.withName("caColorfulness"),
        freeglut_h.C_SHORT.withName("caRedGreenTint")
