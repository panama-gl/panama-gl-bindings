...
class constants$484 {
    ...
    static final MethodHandle GetForegroundWindow$MH = RuntimeHelper.downcallHandle(
        "GetForegroundWindow",
        constants$484.GetForegroundWindow$FUNC
    );
    ...
    static final MethodHandle PaintDesktop$MH = RuntimeHelper.downcallHandle(
        "PaintDesktop",
        constants$484.PaintDesktop$FUNC
    );
    ...
    static final MethodHandle SwitchToThisWindow$MH = RuntimeHelper.downcallHandle(
        "SwitchToThisWindow",
        constants$484.SwitchToThisWindow$FUNC
    );
    ...
    static final MethodHandle SetForegroundWindow$MH = RuntimeHelper.downcallHandle(
        "SetForegroundWindow",
        constants$484.SetForegroundWindow$FUNC
    );
    ...
    static final MethodHandle AllowSetForegroundWindow$MH = RuntimeHelper.downcallHandle(
        ...
        constants$484.AllowSetForegroundWindow$FUNC
    );
    ...
    static final MethodHandle LockSetForegroundWindow$MH = RuntimeHelper.downcallHandle(
        ...
        constants$484.LockSetForegroundWindow$FUNC
    );
}
