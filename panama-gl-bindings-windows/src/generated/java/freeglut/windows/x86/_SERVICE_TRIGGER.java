...
public class _SERVICE_TRIGGER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        freeglut_h.C_LONG.withName("dwTriggerType"),
        freeglut_h.C_LONG.withName("dwAction"),
        freeglut_h.C_POINTER.withName("pTriggerSubtype"),
        freeglut_h.C_LONG.withName("cDataItems"),
        MemoryLayout.paddingLayout(4),
        freeglut_h.C_POINTER.withName("pDataItems")
