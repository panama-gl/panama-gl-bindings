...
public class _QUERY_SERVICE_CONFIGA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        freeglut_h.C_LONG.withName("dwServiceType"),
        freeglut_h.C_LONG.withName("dwStartType"),
        freeglut_h.C_LONG.withName("dwErrorControl"),
        MemoryLayout.paddingLayout(4),
        freeglut_h.C_POINTER.withName("lpBinaryPathName"),
        freeglut_h.C_POINTER.withName("lpLoadOrderGroup"),
        freeglut_h.C_LONG.withName("dwTagId"),
        MemoryLayout.paddingLayout(4),
        freeglut_h.C_POINTER.withName("lpDependencies"),
        freeglut_h.C_POINTER.withName("lpServiceStartName"),
        freeglut_h.C_POINTER.withName("lpDisplayName")
