...
public class SYSTEM_BATTERY_STATE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        freeglut_h.C_CHAR.withName("AcOnLine"),
        freeglut_h.C_CHAR.withName("BatteryPresent"),
        freeglut_h.C_CHAR.withName("Charging"),
        freeglut_h.C_CHAR.withName("Discharging"),
        MemoryLayout.sequenceLayout(3, freeglut_h.C_CHAR).withName("Spare1"),
        freeglut_h.C_CHAR.withName("Tag"),
        freeglut_h.C_LONG.withName("MaxCapacity"),
        freeglut_h.C_LONG.withName("RemainingCapacity"),
        freeglut_h.C_LONG.withName("Rate"),
        freeglut_h.C_LONG.withName("EstimatedTime"),
        freeglut_h.C_LONG.withName("DefaultAlert1"),
        freeglut_h.C_LONG.withName("DefaultAlert2")
