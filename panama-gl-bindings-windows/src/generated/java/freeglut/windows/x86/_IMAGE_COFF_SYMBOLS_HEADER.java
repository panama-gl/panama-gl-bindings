...
public class _IMAGE_COFF_SYMBOLS_HEADER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        freeglut_h.C_LONG.withName("LvaToFirstSymbol"),
        freeglut_h.C_LONG.withName("NumberOfLinenumbers"),
        freeglut_h.C_LONG.withName("LvaToFirstLinenumber"),
        freeglut_h.C_LONG.withName("RvaToFirstByteOfCode"),
        freeglut_h.C_LONG.withName("RvaToLastByteOfCode"),
        freeglut_h.C_LONG.withName("RvaToFirstByteOfData"),
        freeglut_h.C_LONG.withName("RvaToLastByteOfData")
