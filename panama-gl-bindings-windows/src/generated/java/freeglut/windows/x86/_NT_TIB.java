...
public class _NT_TIB {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        freeglut_h.C_POINTER.withName("ExceptionList"),
        freeglut_h.C_POINTER.withName("StackBase"),
        freeglut_h.C_POINTER.withName("StackLimit"),
        freeglut_h.C_POINTER.withName("SubSystemTib"),
        MemoryLayout.unionLayout(
            freeglut_h.C_POINTER.withName("FiberData"),
            freeglut_h.C_LONG.withName("Version")
        ).withName("$anon$11490:5"),
        freeglut_h.C_POINTER.withName("ArbitraryUserPointer"),
        freeglut_h.C_POINTER.withName("Self")
    ).withName("_NT_TIB");
