...
public class _VIDEOPARAMETERS {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        freeglut_h.C_LONG.withName("dwOffset"),
        freeglut_h.C_LONG.withName("dwCommand"),
        freeglut_h.C_LONG.withName("dwFlags"),
        freeglut_h.C_LONG.withName("dwMode"),
        freeglut_h.C_LONG.withName("dwTVStandard"),
        freeglut_h.C_LONG.withName("dwAvailableModes"),
        freeglut_h.C_LONG.withName("dwAvailableTVStandard"),
        freeglut_h.C_LONG.withName("dwFlickerFilter"),
        freeglut_h.C_LONG.withName("dwOverScanX"),
        freeglut_h.C_LONG.withName("dwOverScanY"),
        freeglut_h.C_LONG.withName("dwMaxUnscaledX"),
        freeglut_h.C_LONG.withName("dwMaxUnscaledY"),
        freeglut_h.C_LONG.withName("dwPositionX"),
        freeglut_h.C_LONG.withName("dwPositionY"),
        freeglut_h.C_LONG.withName("dwBrightness"),
        freeglut_h.C_LONG.withName("dwContrast"),
        freeglut_h.C_LONG.withName("dwCPType"),
        freeglut_h.C_LONG.withName("dwCPCommand"),
        freeglut_h.C_LONG.withName("dwCPStandard"),
        freeglut_h.C_LONG.withName("dwCPKey"),
        freeglut_h.C_LONG.withName("bCP_APSTriggerBits"),
        MemoryLayout.sequenceLayout(256, freeglut_h.C_CHAR).withName("bOEMCopyProtection")
