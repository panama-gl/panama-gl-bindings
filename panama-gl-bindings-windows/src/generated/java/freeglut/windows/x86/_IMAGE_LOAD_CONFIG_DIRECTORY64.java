...
public class _IMAGE_LOAD_CONFIG_DIRECTORY64 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        freeglut_h.C_SHORT.withName("MajorVersion"),
        freeglut_h.C_SHORT.withName("MinorVersion"),
        freeglut_h.C_LONG.withName("GlobalFlagsClear"),
        freeglut_h.C_LONG.withName("GlobalFlagsSet"),
        freeglut_h.C_LONG.withName("CriticalSectionDefaultTimeout"),
        freeglut_h.align(freeglut_h.C_LONG_LONG, 4).withName("DeCommitFreeBlockThreshold"),
        freeglut_h.align(freeglut_h.C_LONG_LONG, 4).withName("DeCommitTotalFreeThreshold"),
        freeglut_h.align(freeglut_h.C_LONG_LONG, 4).withName("LockPrefixTable"),
        freeglut_h.align(freeglut_h.C_LONG_LONG, 4).withName("MaximumAllocationSize"),
        freeglut_h.align(freeglut_h.C_LONG_LONG, 4).withName("VirtualMemoryThreshold"),
        freeglut_h.align(freeglut_h.C_LONG_LONG, 4).withName("ProcessAffinityMask"),
        freeglut_h.C_LONG.withName("ProcessHeapFlags"),
        freeglut_h.C_SHORT.withName("CSDVersion"),
        freeglut_h.C_SHORT.withName("DependentLoadFlags"),
        freeglut_h.align(freeglut_h.C_LONG_LONG, 4).withName("EditList"),
        freeglut_h.align(freeglut_h.C_LONG_LONG, 4).withName("SecurityCookie"),
        freeglut_h.align(freeglut_h.C_LONG_LONG, 4).withName("SEHandlerTable"),
        freeglut_h.align(freeglut_h.C_LONG_LONG, 4).withName("SEHandlerCount"),
        freeglut_h.align(freeglut_h.C_LONG_LONG, 4).withName("GuardCFCheckFunctionPointer"),
        freeglut_h.align(freeglut_h.C_LONG_LONG, 4).withName("GuardCFDispatchFunctionPointer"),
        freeglut_h.align(freeglut_h.C_LONG_LONG, 4).withName("GuardCFFunctionTable"),
        freeglut_h.align(freeglut_h.C_LONG_LONG, 4).withName("GuardCFFunctionCount"),
        freeglut_h.C_LONG.withName("GuardFlags"),
        _IMAGE_LOAD_CONFIG_CODE_INTEGRITY.layout().withName("CodeIntegrity"),
        freeglut_h.align(freeglut_h.C_LONG_LONG, 4).withName("GuardAddressTakenIatEntryTable"),
        freeglut_h.align(freeglut_h.C_LONG_LONG, 4).withName("GuardAddressTakenIatEntryCount"),
        freeglut_h.align(freeglut_h.C_LONG_LONG, 4).withName("GuardLongJumpTargetTable"),
        freeglut_h.align(freeglut_h.C_LONG_LONG, 4).withName("GuardLongJumpTargetCount"),
        freeglut_h.align(freeglut_h.C_LONG_LONG, 4).withName("DynamicValueRelocTable"),
        freeglut_h.align(freeglut_h.C_LONG_LONG, 4).withName("CHPEMetadataPointer"),
        freeglut_h.align(freeglut_h.C_LONG_LONG, 4).withName("GuardRFFailureRoutine"),
        freeglut_h.align(freeglut_h.C_LONG_LONG, 4).withName("GuardRFFailureRoutineFunctionPointer"),
        freeglut_h.C_LONG.withName("DynamicValueRelocTableOffset"),
        freeglut_h.C_SHORT.withName("DynamicValueRelocTableSection"),
        freeglut_h.C_SHORT.withName("Reserved2"),
        freeglut_h.align(freeglut_h.C_LONG_LONG, 4).withName("GuardRFVerifyStackPointerFunctionPointer"),
        freeglut_h.C_LONG.withName("HotPatchTableOffset"),
        freeglut_h.C_LONG.withName("Reserved3"),
        freeglut_h.align(freeglut_h.C_LONG_LONG, 4).withName("EnclaveConfigurationPointer"),
        freeglut_h.align(freeglut_h.C_LONG_LONG, 4).withName("VolatileMetadataPointer"),
        freeglut_h.align(freeglut_h.C_LONG_LONG, 4).withName("GuardEHContinuationTable"),
        freeglut_h.align(freeglut_h.C_LONG_LONG, 4).withName("GuardEHContinuationCount")
