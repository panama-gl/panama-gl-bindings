...
class constants$446 {
    ...
    static final MethodHandle SetDlgItemTextA$MH = RuntimeHelper.downcallHandle(
        "SetDlgItemTextA",
        constants$446.SetDlgItemTextA$FUNC
    );
    ...
    static final MethodHandle SetDlgItemTextW$MH = RuntimeHelper.downcallHandle(
        "SetDlgItemTextW",
        constants$446.SetDlgItemTextW$FUNC
    );
    ...
    static final MethodHandle GetDlgItemTextA$MH = RuntimeHelper.downcallHandle(
        "GetDlgItemTextA",
        constants$446.GetDlgItemTextA$FUNC
    );
    ...
    static final MethodHandle GetDlgItemTextW$MH = RuntimeHelper.downcallHandle(
        "GetDlgItemTextW",
        constants$446.GetDlgItemTextW$FUNC
    );
    ...
    static final MethodHandle CheckDlgButton$MH = RuntimeHelper.downcallHandle(
        "CheckDlgButton",
        constants$446.CheckDlgButton$FUNC
    );
    ...
    static final MethodHandle CheckRadioButton$MH = RuntimeHelper.downcallHandle(
        "CheckRadioButton",
        constants$446.CheckRadioButton$FUNC
    );
}
