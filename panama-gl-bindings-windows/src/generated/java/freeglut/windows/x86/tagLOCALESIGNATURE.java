...
public class tagLOCALESIGNATURE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(4, freeglut_h.C_LONG).withName("lsUsb"),
        MemoryLayout.sequenceLayout(2, freeglut_h.C_LONG).withName("lsCsbDefault"),
        MemoryLayout.sequenceLayout(2, freeglut_h.C_LONG).withName("lsCsbSupported")
