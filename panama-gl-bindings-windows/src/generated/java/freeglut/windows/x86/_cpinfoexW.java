...
public class _cpinfoexW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        freeglut_h.C_SHORT.withName("UnicodeDefaultChar"),
        freeglut_h.C_INT.withName("CodePage"),
        MemoryLayout.sequenceLayout(260, freeglut_h.C_SHORT).withName("CodePageName")
    ).withName("_cpinfoexW");
