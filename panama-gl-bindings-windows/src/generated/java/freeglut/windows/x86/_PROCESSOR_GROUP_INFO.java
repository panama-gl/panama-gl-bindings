...
public class _PROCESSOR_GROUP_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        freeglut_h.C_CHAR.withName("MaximumProcessorCount"),
        freeglut_h.C_CHAR.withName("ActiveProcessorCount"),
        MemoryLayout.sequenceLayout(38, freeglut_h.C_CHAR).withName("Reserved"),
        freeglut_h.C_LONG_LONG.withName("ActiveProcessorMask")
