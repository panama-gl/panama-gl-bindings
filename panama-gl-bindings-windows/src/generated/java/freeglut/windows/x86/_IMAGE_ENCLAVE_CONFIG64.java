...
public class _IMAGE_ENCLAVE_CONFIG64 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        freeglut_h.C_LONG.withName("MinimumRequiredConfigSize"),
        freeglut_h.C_LONG.withName("PolicyFlags"),
        freeglut_h.C_LONG.withName("NumberOfImports"),
        freeglut_h.C_LONG.withName("ImportList"),
        freeglut_h.C_LONG.withName("ImportEntrySize"),
        MemoryLayout.sequenceLayout(16, freeglut_h.C_CHAR).withName("FamilyID"),
        MemoryLayout.sequenceLayout(16, freeglut_h.C_CHAR).withName("ImageID"),
        freeglut_h.C_LONG.withName("ImageVersion"),
        freeglut_h.C_LONG.withName("SecurityVersion"),
        freeglut_h.align(freeglut_h.C_LONG_LONG, 4).withName("EnclaveSize"),
        freeglut_h.C_LONG.withName("NumberOfThreads"),
        freeglut_h.C_LONG.withName("EnclaveFlags")
