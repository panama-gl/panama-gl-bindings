...
public class _KNONVOLATILE_CONTEXT_POINTERS_ARM64 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        freeglut_h.C_POINTER.withName("X19"),
        freeglut_h.C_POINTER.withName("X20"),
        freeglut_h.C_POINTER.withName("X21"),
        freeglut_h.C_POINTER.withName("X22"),
        freeglut_h.C_POINTER.withName("X23"),
        freeglut_h.C_POINTER.withName("X24"),
        freeglut_h.C_POINTER.withName("X25"),
        freeglut_h.C_POINTER.withName("X26"),
        freeglut_h.C_POINTER.withName("X27"),
        freeglut_h.C_POINTER.withName("X28"),
        freeglut_h.C_POINTER.withName("Fp"),
        freeglut_h.C_POINTER.withName("Lr"),
        freeglut_h.C_POINTER.withName("D8"),
        freeglut_h.C_POINTER.withName("D9"),
        freeglut_h.C_POINTER.withName("D10"),
        freeglut_h.C_POINTER.withName("D11"),
        freeglut_h.C_POINTER.withName("D12"),
        freeglut_h.C_POINTER.withName("D13"),
        freeglut_h.C_POINTER.withName("D14"),
        freeglut_h.C_POINTER.withName("D15")
