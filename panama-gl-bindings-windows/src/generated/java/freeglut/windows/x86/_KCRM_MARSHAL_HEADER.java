...
public class _KCRM_MARSHAL_HEADER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        freeglut_h.C_LONG.withName("VersionMajor"),
        freeglut_h.C_LONG.withName("VersionMinor"),
        freeglut_h.C_LONG.withName("NumProtocols"),
        freeglut_h.C_LONG.withName("Unused")
