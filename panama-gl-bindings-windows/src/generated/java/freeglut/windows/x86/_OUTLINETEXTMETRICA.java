...
public class _OUTLINETEXTMETRICA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        freeglut_h.C_INT.withName("otmSize"),
        tagTEXTMETRICA.layout().withName("otmTextMetrics"),
        freeglut_h.C_CHAR.withName("otmFiller"),
        tagPANOSE.layout().withName("otmPanoseNumber"),
        MemoryLayout.paddingLayout(1),
        freeglut_h.C_INT.withName("otmfsSelection"),
        freeglut_h.C_INT.withName("otmfsType"),
        freeglut_h.C_INT.withName("otmsCharSlopeRise"),
        freeglut_h.C_INT.withName("otmsCharSlopeRun"),
        freeglut_h.C_INT.withName("otmItalicAngle"),
        freeglut_h.C_INT.withName("otmEMSquare"),
        freeglut_h.C_INT.withName("otmAscent"),
        freeglut_h.C_INT.withName("otmDescent"),
        freeglut_h.C_INT.withName("otmLineGap"),
        freeglut_h.C_INT.withName("otmsCapEmHeight"),
        freeglut_h.C_INT.withName("otmsXHeight"),
        tagRECT.layout().withName("otmrcFontBox"),
        freeglut_h.C_INT.withName("otmMacAscent"),
        freeglut_h.C_INT.withName("otmMacDescent"),
        freeglut_h.C_INT.withName("otmMacLineGap"),
        freeglut_h.C_INT.withName("otmusMinimumPPEM"),
        ...
        freeglut_h.C_INT.withName("otmsStrikeoutSize"),
        freeglut_h.C_INT.withName("otmsStrikeoutPosition"),
        freeglut_h.C_INT.withName("otmsUnderscoreSize"),
        freeglut_h.C_INT.withName("otmsUnderscorePosition"),
        MemoryLayout.paddingLayout(4),
        freeglut_h.C_POINTER.withName("otmpFamilyName"),
        freeglut_h.C_POINTER.withName("otmpFaceName"),
        freeglut_h.C_POINTER.withName("otmpStyleName"),
        freeglut_h.C_POINTER.withName("otmpFullName")
