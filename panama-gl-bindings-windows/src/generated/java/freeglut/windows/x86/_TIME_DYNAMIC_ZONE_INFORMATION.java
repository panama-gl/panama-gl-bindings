...
public class _TIME_DYNAMIC_ZONE_INFORMATION {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        freeglut_h.C_LONG.withName("Bias"),
        MemoryLayout.sequenceLayout(32, freeglut_h.C_SHORT).withName("StandardName"),
        _SYSTEMTIME.layout().withName("StandardDate"),
        freeglut_h.C_LONG.withName("StandardBias"),
        MemoryLayout.sequenceLayout(32, freeglut_h.C_SHORT).withName("DaylightName"),
        _SYSTEMTIME.layout().withName("DaylightDate"),
        freeglut_h.C_LONG.withName("DaylightBias"),
        MemoryLayout.sequenceLayout(128, freeglut_h.C_SHORT).withName("TimeZoneKeyName"),
        freeglut_h.C_CHAR.withName("DynamicDaylightTimeDisabled"),
