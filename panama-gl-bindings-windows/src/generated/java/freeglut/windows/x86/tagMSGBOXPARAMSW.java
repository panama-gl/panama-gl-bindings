...
public class tagMSGBOXPARAMSW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        freeglut_h.C_POINTER.withName("lpszText"),
        freeglut_h.C_POINTER.withName("lpszCaption"),
        freeglut_h.C_LONG.withName("dwStyle"),
        MemoryLayout.paddingLayout(4),
        freeglut_h.C_POINTER.withName("lpszIcon"),
        freeglut_h.C_LONG_LONG.withName("dwContextHelpId"),
        freeglut_h.C_POINTER.withName("lpfnMsgBoxCallback"),
        freeglut_h.C_LONG.withName("dwLanguageId"),
        MemoryLayout.paddingLayout(4)
