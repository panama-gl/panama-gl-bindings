...
public class tagNEWTEXTMETRICW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        freeglut_h.C_LONG.withName("tmHeight"),
        freeglut_h.C_LONG.withName("tmAscent"),
        freeglut_h.C_LONG.withName("tmDescent"),
        freeglut_h.C_LONG.withName("tmInternalLeading"),
        freeglut_h.C_LONG.withName("tmExternalLeading"),
        freeglut_h.C_LONG.withName("tmAveCharWidth"),
        freeglut_h.C_LONG.withName("tmMaxCharWidth"),
        freeglut_h.C_LONG.withName("tmWeight"),
        freeglut_h.C_LONG.withName("tmOverhang"),
        freeglut_h.C_LONG.withName("tmDigitizedAspectX"),
        freeglut_h.C_LONG.withName("tmDigitizedAspectY"),
        freeglut_h.C_SHORT.withName("tmFirstChar"),
        freeglut_h.C_SHORT.withName("tmLastChar"),
        freeglut_h.C_SHORT.withName("tmDefaultChar"),
        freeglut_h.C_SHORT.withName("tmBreakChar"),
        freeglut_h.C_CHAR.withName("tmItalic"),
        freeglut_h.C_CHAR.withName("tmUnderlined"),
        freeglut_h.C_CHAR.withName("tmStruckOut"),
        freeglut_h.C_CHAR.withName("tmPitchAndFamily"),
        freeglut_h.C_CHAR.withName("tmCharSet"),
        MemoryLayout.paddingLayout(3),
        freeglut_h.C_LONG.withName("ntmFlags"),
        freeglut_h.C_INT.withName("ntmSizeEM"),
        freeglut_h.C_INT.withName("ntmCellHeight"),
        freeglut_h.C_INT.withName("ntmAvgWidth")
