...
public class provider_info {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        freeglut_h.C_POINTER.withName("pi_R0_1val"),
        freeglut_h.C_POINTER.withName("pi_R0_allvals"),
        freeglut_h.C_POINTER.withName("pi_R3_1val"),
        freeglut_h.C_POINTER.withName("pi_R3_allvals"),
        freeglut_h.C_LONG.withName("pi_flags"),
        MemoryLayout.paddingLayout(4),
        freeglut_h.C_POINTER.withName("pi_key_context")
