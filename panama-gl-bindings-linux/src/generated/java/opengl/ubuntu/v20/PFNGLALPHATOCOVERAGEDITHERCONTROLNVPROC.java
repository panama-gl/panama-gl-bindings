...
public interface PFNGLALPHATOCOVERAGEDITHERCONTROLNVPROC {
    ...
    static MemorySegment allocate(PFNGLALPHATOCOVERAGEDITHERCONTROLNVPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLALPHATOCOVERAGEDITHERCONTROLNVPROC.class, fi, constants$725.PFNGLALPHATOCOVERAGEDITHERCONTROLNVPROC$FUNC, session);
    }
    static PFNGLALPHATOCOVERAGEDITHERCONTROLNVPROC ofAddress(MemoryAddress addr, MemorySession session) {
        MemorySegment symbol = MemorySegment.ofAddress(addr, 0, session);
        return (int _mode) -> {
            try {
                constants$725.PFNGLALPHATOCOVERAGEDITHERCONTROLNVPROC$MH.invokeExact((Addressable)symbol, _mode);
            } catch (Throwable ex$) {
