...
public interface PFNGLVIDEOCAPTURENVPROC {
    ...
    static MemorySegment allocate(PFNGLVIDEOCAPTURENVPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLVIDEOCAPTURENVPROC.class, fi, constants$881.PFNGLVIDEOCAPTURENVPROC$FUNC, session);
    }
    static PFNGLVIDEOCAPTURENVPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _video_capture_slot, java.lang.foreign.MemoryAddress _sequence_num, java.lang.foreign.MemoryAddress _capture_time) -> {
            try {
                return (int)constants$881.PFNGLVIDEOCAPTURENVPROC$MH.invokeExact((Addressable)symbol, _video_capture_slot, (java.lang.foreign.Addressable)_sequence_num, (java.lang.foreign.Addressable)_capture_time);
            } catch (Throwable ex$) {
