...
public class random_data {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        glut_h.C_POINTER.withName("fptr"),
        glut_h.C_POINTER.withName("rptr"),
        glut_h.C_POINTER.withName("state"),
        glut_h.C_INT.withName("rand_type"),
        glut_h.C_INT.withName("rand_deg"),
        glut_h.C_INT.withName("rand_sep"),
        MemoryLayout.paddingLayout(4),
        glut_h.C_POINTER.withName("end_ptr")
