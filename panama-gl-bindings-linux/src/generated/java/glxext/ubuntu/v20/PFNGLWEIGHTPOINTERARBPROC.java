...
public interface PFNGLWEIGHTPOINTERARBPROC {
    ...
    static MemorySegment allocate(PFNGLWEIGHTPOINTERARBPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLWEIGHTPOINTERARBPROC.class, fi, constants$466.PFNGLWEIGHTPOINTERARBPROC$FUNC, session);
    }
    static PFNGLWEIGHTPOINTERARBPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _size, int _type, int _stride, java.lang.foreign.MemoryAddress _pointer) -> {
            try {
                constants$466.PFNGLWEIGHTPOINTERARBPROC$MH.invokeExact((Addressable)symbol, _size, _type, _stride, (java.lang.foreign.Addressable)_pointer);
            } catch (Throwable ex$) {
