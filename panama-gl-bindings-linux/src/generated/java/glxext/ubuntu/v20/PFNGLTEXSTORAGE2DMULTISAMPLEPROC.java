...
public interface PFNGLTEXSTORAGE2DMULTISAMPLEPROC {
    ...
    static MemorySegment allocate(PFNGLTEXSTORAGE2DMULTISAMPLEPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLTEXSTORAGE2DMULTISAMPLEPROC.class, fi, constants$346.PFNGLTEXSTORAGE2DMULTISAMPLEPROC$FUNC, session);
    }
    static PFNGLTEXSTORAGE2DMULTISAMPLEPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _target, int _samples, int _internalformat, int _width, int _height, byte _fixedsamplelocations) -> {
            try {
                constants$346.PFNGLTEXSTORAGE2DMULTISAMPLEPROC$MH.invokeExact((Addressable)symbol, _target, _samples, _internalformat, _width, _height, _fixedsamplelocations);
            } catch (Throwable ex$) {
