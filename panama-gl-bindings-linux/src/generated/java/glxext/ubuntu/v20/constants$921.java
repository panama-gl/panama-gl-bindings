...
class constants$921 {
    ...
    static final MethodHandle PFNGLVDPAUREGISTERVIDEOSURFACENVPROC$MH = RuntimeHelper.downcallHandle(
        constants$921.PFNGLVDPAUREGISTERVIDEOSURFACENVPROC$FUNC
    );
    ...
    static final MethodHandle PFNGLVDPAUREGISTEROUTPUTSURFACENVPROC$MH = RuntimeHelper.downcallHandle(
        constants$921.PFNGLVDPAUREGISTEROUTPUTSURFACENVPROC$FUNC
    );
    ...
    static final MethodHandle PFNGLVDPAUISSURFACENVPROC$MH = RuntimeHelper.downcallHandle(
        constants$921.PFNGLVDPAUISSURFACENVPROC$FUNC
    );
}
