...
public interface PFNGLGETSHADERINFOLOGPROC {
    ...
    static MemorySegment allocate(PFNGLGETSHADERINFOLOGPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLGETSHADERINFOLOGPROC.class, fi, constants$206.PFNGLGETSHADERINFOLOGPROC$FUNC, session);
    }
    static PFNGLGETSHADERINFOLOGPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _shader, int _bufSize, java.lang.foreign.MemoryAddress _length, java.lang.foreign.MemoryAddress _infoLog) -> {
            try {
                constants$206.PFNGLGETSHADERINFOLOGPROC$MH.invokeExact((Addressable)symbol, _shader, _bufSize, (java.lang.foreign.Addressable)_length, (java.lang.foreign.Addressable)_infoLog);
            } catch (Throwable ex$) {
