...
public interface PFNGLSPECIALIZESHADERARBPROC {
    ...
    static MemorySegment allocate(PFNGLSPECIALIZESHADERARBPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLSPECIALIZESHADERARBPROC.class, fi, constants$416.PFNGLSPECIALIZESHADERARBPROC$FUNC, session);
    }
    static PFNGLSPECIALIZESHADERARBPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _shader, java.lang.foreign.MemoryAddress _pEntryPoint, int _numSpecializationConstants, java.lang.foreign.MemoryAddress _pConstantIndex, java.lang.foreign.MemoryAddress _pConstantValue) -> {
            try {
                constants$416.PFNGLSPECIALIZESHADERARBPROC$MH.invokeExact((Addressable)symbol, _shader, (java.lang.foreign.Addressable)_pEntryPoint, _numSpecializationConstants, (java.lang.foreign.Addressable)_pConstantIndex, (java.lang.foreign.Addressable)_pConstantValue);
            } catch (Throwable ex$) {
