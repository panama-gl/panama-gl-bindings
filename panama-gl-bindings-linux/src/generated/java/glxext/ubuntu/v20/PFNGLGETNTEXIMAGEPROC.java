...
public interface PFNGLGETNTEXIMAGEPROC {
    ...
    static MemorySegment allocate(PFNGLGETNTEXIMAGEPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLGETNTEXIMAGEPROC.class, fi, constants$390.PFNGLGETNTEXIMAGEPROC$FUNC, session);
    }
    static PFNGLGETNTEXIMAGEPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _target, int _level, int _format, int _type, int _bufSize, java.lang.foreign.MemoryAddress _pixels) -> {
            try {
                constants$390.PFNGLGETNTEXIMAGEPROC$MH.invokeExact((Addressable)symbol, _target, _level, _format, _type, _bufSize, (java.lang.foreign.Addressable)_pixels);
            } catch (Throwable ex$) {
