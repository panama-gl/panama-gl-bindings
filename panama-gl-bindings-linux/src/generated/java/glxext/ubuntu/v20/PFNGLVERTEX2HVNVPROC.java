...
public interface PFNGLVERTEX2HVNVPROC {
    ...
    static MemorySegment allocate(PFNGLVERTEX2HVNVPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLVERTEX2HVNVPROC.class, fi, constants$849.PFNGLVERTEX2HVNVPROC$FUNC, session);
    }
    static PFNGLVERTEX2HVNVPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _v) -> {
            try {
                constants$849.PFNGLVERTEX2HVNVPROC$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_v);
            } catch (Throwable ex$) {
