...
public interface PFNGLISENABLEDINDEXEDEXTPROC {
    ...
    static MemorySegment allocate(PFNGLISENABLEDINDEXEDEXTPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLISENABLEDINDEXEDEXTPROC.class, fi, constants$648.PFNGLISENABLEDINDEXEDEXTPROC$FUNC, session);
    }
    static PFNGLISENABLEDINDEXEDEXTPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _target, int _index) -> {
            try {
                return (byte)constants$648.PFNGLISENABLEDINDEXEDEXTPROC$MH.invokeExact((Addressable)symbol, _target, _index);
            } catch (Throwable ex$) {
