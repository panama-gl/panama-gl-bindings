...
public interface PFNGLFRAMEBUFFERTEXTURELAYEREXTPROC {
    ...
    static MemorySegment allocate(PFNGLFRAMEBUFFERTEXTURELAYEREXTPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLFRAMEBUFFERTEXTURELAYEREXTPROC.class, fi, constants$753.PFNGLFRAMEBUFFERTEXTURELAYEREXTPROC$FUNC, session);
    }
    static PFNGLFRAMEBUFFERTEXTURELAYEREXTPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _target, int _attachment, int _texture, int _level, int _layer) -> {
            try {
                constants$753.PFNGLFRAMEBUFFERTEXTURELAYEREXTPROC$MH.invokeExact((Addressable)symbol, _target, _attachment, _texture, _level, _layer);
            } catch (Throwable ex$) {
