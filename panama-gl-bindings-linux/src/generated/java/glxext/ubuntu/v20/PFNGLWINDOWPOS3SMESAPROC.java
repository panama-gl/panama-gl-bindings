...
public interface PFNGLWINDOWPOS3SMESAPROC {
    ...
    static MemorySegment allocate(PFNGLWINDOWPOS3SMESAPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLWINDOWPOS3SMESAPROC.class, fi, constants$802.PFNGLWINDOWPOS3SMESAPROC$FUNC, session);
    }
    static PFNGLWINDOWPOS3SMESAPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (short _x, short _y, short _z) -> {
            try {
                constants$802.PFNGLWINDOWPOS3SMESAPROC$MH.invokeExact((Addressable)symbol, _x, _y, _z);
            } catch (Throwable ex$) {
