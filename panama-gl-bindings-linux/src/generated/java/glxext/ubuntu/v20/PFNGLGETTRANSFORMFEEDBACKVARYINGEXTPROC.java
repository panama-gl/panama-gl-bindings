...
public interface PFNGLGETTRANSFORMFEEDBACKVARYINGEXTPROC {
    ...
    static MemorySegment allocate(PFNGLGETTRANSFORMFEEDBACKVARYINGEXTPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLGETTRANSFORMFEEDBACKVARYINGEXTPROC.class, fi, constants$760.PFNGLGETTRANSFORMFEEDBACKVARYINGEXTPROC$FUNC, session);
    }
    static PFNGLGETTRANSFORMFEEDBACKVARYINGEXTPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _program, int _index, int _bufSize, java.lang.foreign.MemoryAddress _length, java.lang.foreign.MemoryAddress _size, java.lang.foreign.MemoryAddress _type, java.lang.foreign.MemoryAddress _name) -> {
            try {
                constants$760.PFNGLGETTRANSFORMFEEDBACKVARYINGEXTPROC$MH.invokeExact((Addressable)symbol, _program, _index, _bufSize, (java.lang.foreign.Addressable)_length, (java.lang.foreign.Addressable)_size, (java.lang.foreign.Addressable)_type, (java.lang.foreign.Addressable)_name);
            } catch (Throwable ex$) {
