...
class constants$321 {
    ...
    static final MethodHandle PFNGLPROGRAMUNIFORMMATRIX3FVPROC$MH = RuntimeHelper.downcallHandle(
        constants$321.PFNGLPROGRAMUNIFORMMATRIX3FVPROC$FUNC
    );
    ...
    static final MethodHandle PFNGLPROGRAMUNIFORMMATRIX4FVPROC$MH = RuntimeHelper.downcallHandle(
        constants$321.PFNGLPROGRAMUNIFORMMATRIX4FVPROC$FUNC
    );
    ...
    static final MethodHandle PFNGLPROGRAMUNIFORMMATRIX2DVPROC$MH = RuntimeHelper.downcallHandle(
        constants$321.PFNGLPROGRAMUNIFORMMATRIX2DVPROC$FUNC
    );
}
