...
class constants$692 {
    ...
    static final MethodHandle PFNGLGETVERTEXARRAYINTEGERVEXTPROC$MH = RuntimeHelper.downcallHandle(
        constants$692.PFNGLGETVERTEXARRAYINTEGERVEXTPROC$FUNC
    );
    ...
    static final MethodHandle PFNGLGETVERTEXARRAYPOINTERVEXTPROC$MH = RuntimeHelper.downcallHandle(
        constants$692.PFNGLGETVERTEXARRAYPOINTERVEXTPROC$FUNC
    );
    ...
    static final MethodHandle PFNGLGETVERTEXARRAYINTEGERI_VEXTPROC$MH = RuntimeHelper.downcallHandle(
        constants$692.PFNGLGETVERTEXARRAYINTEGERI_VEXTPROC$FUNC
    );
}
