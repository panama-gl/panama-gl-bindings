...
public interface PFNGLGETPROGRAMRESOURCENAMEPROC {
    ...
    static MemorySegment allocate(PFNGLGETPROGRAMRESOURCENAMEPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLGETPROGRAMRESOURCENAMEPROC.class, fi, constants$344.PFNGLGETPROGRAMRESOURCENAMEPROC$FUNC, session);
    }
    static PFNGLGETPROGRAMRESOURCENAMEPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _program, int _programInterface, int _index, int _bufSize, java.lang.foreign.MemoryAddress _length, java.lang.foreign.MemoryAddress _name) -> {
            try {
                constants$344.PFNGLGETPROGRAMRESOURCENAMEPROC$MH.invokeExact((Addressable)symbol, _program, _programInterface, _index, _bufSize, (java.lang.foreign.Addressable)_length, (java.lang.foreign.Addressable)_name);
            } catch (Throwable ex$) {
