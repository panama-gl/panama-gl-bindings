...
public interface PFNGLGETACTIVEUNIFORMARBPROC {
    ...
    static MemorySegment allocate(PFNGLGETACTIVEUNIFORMARBPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLGETACTIVEUNIFORMARBPROC.class, fi, constants$454.PFNGLGETACTIVEUNIFORMARBPROC$FUNC, session);
    }
    static PFNGLGETACTIVEUNIFORMARBPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _programObj, int _index, int _maxLength, java.lang.foreign.MemoryAddress _length, java.lang.foreign.MemoryAddress _size, java.lang.foreign.MemoryAddress _type, java.lang.foreign.MemoryAddress _name) -> {
            try {
                constants$454.PFNGLGETACTIVEUNIFORMARBPROC$MH.invokeExact((Addressable)symbol, _programObj, _index, _maxLength, (java.lang.foreign.Addressable)_length, (java.lang.foreign.Addressable)_size, (java.lang.foreign.Addressable)_type, (java.lang.foreign.Addressable)_name);
            } catch (Throwable ex$) {
