...
public interface PFNGLGETVARYINGLOCATIONNVPROC {
    ...
    static MemorySegment allocate(PFNGLGETVARYINGLOCATIONNVPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLGETVARYINGLOCATIONNVPROC.class, fi, constants$916.PFNGLGETVARYINGLOCATIONNVPROC$FUNC, session);
    }
    static PFNGLGETVARYINGLOCATIONNVPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _program, java.lang.foreign.MemoryAddress _name) -> {
            try {
                return (int)constants$916.PFNGLGETVARYINGLOCATIONNVPROC$MH.invokeExact((Addressable)symbol, _program, (java.lang.foreign.Addressable)_name);
            } catch (Throwable ex$) {
