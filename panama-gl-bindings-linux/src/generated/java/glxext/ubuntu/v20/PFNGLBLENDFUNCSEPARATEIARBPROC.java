...
public interface PFNGLBLENDFUNCSEPARATEIARBPROC {
    ...
    static MemorySegment allocate(PFNGLBLENDFUNCSEPARATEIARBPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLBLENDFUNCSEPARATEIARBPROC.class, fi, constants$407.PFNGLBLENDFUNCSEPARATEIARBPROC$FUNC, session);
    }
    static PFNGLBLENDFUNCSEPARATEIARBPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _buf, int _srcRGB, int _dstRGB, int _srcAlpha, int _dstAlpha) -> {
            try {
                constants$407.PFNGLBLENDFUNCSEPARATEIARBPROC$MH.invokeExact((Addressable)symbol, _buf, _srcRGB, _dstRGB, _srcAlpha, _dstAlpha);
            } catch (Throwable ex$) {
