...
public interface PFNGLFINISHASYNCSGIXPROC {
    ...
    static MemorySegment allocate(PFNGLFINISHASYNCSGIXPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLFINISHASYNCSGIXPROC.class, fi, constants$976.PFNGLFINISHASYNCSGIXPROC$FUNC, session);
    }
    static PFNGLFINISHASYNCSGIXPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _markerp) -> {
            try {
                return (int)constants$976.PFNGLFINISHASYNCSGIXPROC$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_markerp);
            } catch (Throwable ex$) {
