...
public interface PFNGLPROGRAMLOCALPARAMETERI4INVPROC {
    ...
    static MemorySegment allocate(PFNGLPROGRAMLOCALPARAMETERI4INVPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLPROGRAMLOCALPARAMETERI4INVPROC.class, fi, constants$843.PFNGLPROGRAMLOCALPARAMETERI4INVPROC$FUNC, session);
    }
    static PFNGLPROGRAMLOCALPARAMETERI4INVPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _target, int _index, int _x, int _y, int _z, int _w) -> {
            try {
                constants$843.PFNGLPROGRAMLOCALPARAMETERI4INVPROC$MH.invokeExact((Addressable)symbol, _target, _index, _x, _y, _z, _w);
            } catch (Throwable ex$) {
