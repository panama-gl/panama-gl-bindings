...
public interface PFNGLGETPROGRAMSTAGEIVPROC {
    ...
    static MemorySegment allocate(PFNGLGETPROGRAMSTAGEIVPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLGETPROGRAMSTAGEIVPROC.class, fi, constants$300.PFNGLGETPROGRAMSTAGEIVPROC$FUNC, session);
    }
    static PFNGLGETPROGRAMSTAGEIVPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _program, int _shadertype, int _pname, java.lang.foreign.MemoryAddress _values) -> {
            try {
                constants$300.PFNGLGETPROGRAMSTAGEIVPROC$MH.invokeExact((Addressable)symbol, _program, _shadertype, _pname, (java.lang.foreign.Addressable)_values);
            } catch (Throwable ex$) {
