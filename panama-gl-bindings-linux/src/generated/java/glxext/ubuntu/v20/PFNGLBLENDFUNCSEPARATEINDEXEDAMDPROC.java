...
public interface PFNGLBLENDFUNCSEPARATEINDEXEDAMDPROC {
    ...
    static MemorySegment allocate(PFNGLBLENDFUNCSEPARATEINDEXEDAMDPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLBLENDFUNCSEPARATEINDEXEDAMDPROC.class, fi, constants$538.PFNGLBLENDFUNCSEPARATEINDEXEDAMDPROC$FUNC, session);
    }
    static PFNGLBLENDFUNCSEPARATEINDEXEDAMDPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _buf, int _srcRGB, int _dstRGB, int _srcAlpha, int _dstAlpha) -> {
            try {
                constants$538.PFNGLBLENDFUNCSEPARATEINDEXEDAMDPROC$MH.invokeExact((Addressable)symbol, _buf, _srcRGB, _dstRGB, _srcAlpha, _dstAlpha);
            } catch (Throwable ex$) {
