...
public interface PFNGLGETPROGRAMRESOURCEINDEXPROC {
    ...
    static MemorySegment allocate(PFNGLGETPROGRAMRESOURCEINDEXPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLGETPROGRAMRESOURCEINDEXPROC.class, fi, constants$344.PFNGLGETPROGRAMRESOURCEINDEXPROC$FUNC, session);
    }
    static PFNGLGETPROGRAMRESOURCEINDEXPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _program, int _programInterface, java.lang.foreign.MemoryAddress _name) -> {
            try {
                return (int)constants$344.PFNGLGETPROGRAMRESOURCEINDEXPROC$MH.invokeExact((Addressable)symbol, _program, _programInterface, (java.lang.foreign.Addressable)_name);
            } catch (Throwable ex$) {
