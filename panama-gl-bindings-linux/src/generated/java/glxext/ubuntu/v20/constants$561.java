...
class constants$561 {
    ...
    static final MethodHandle PFNGLDRAWRANGEELEMENTARRAYAPPLEPROC$MH = RuntimeHelper.downcallHandle(
        constants$561.PFNGLDRAWRANGEELEMENTARRAYAPPLEPROC$FUNC
    );
    ...
    static final MethodHandle PFNGLMULTIDRAWELEMENTARRAYAPPLEPROC$MH = RuntimeHelper.downcallHandle(
        constants$561.PFNGLMULTIDRAWELEMENTARRAYAPPLEPROC$FUNC
    );
    ...
    static final MethodHandle PFNGLMULTIDRAWRANGEELEMENTARRAYAPPLEPROC$MH = RuntimeHelper.downcallHandle(
        constants$561.PFNGLMULTIDRAWRANGEELEMENTARRAYAPPLEPROC$FUNC
    );
}
