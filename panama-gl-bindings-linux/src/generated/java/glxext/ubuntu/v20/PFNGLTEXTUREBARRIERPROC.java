...
public interface PFNGLTEXTUREBARRIERPROC {
    ...
    static MemorySegment allocate(PFNGLTEXTUREBARRIERPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLTEXTUREBARRIERPROC.class, fi, constants$396.PFNGLTEXTUREBARRIERPROC$FUNC, session);
    }
    static PFNGLTEXTUREBARRIERPROC ofAddress(MemoryAddress addr, MemorySession session) {
        MemorySegment symbol = MemorySegment.ofAddress(addr, 0, session);
        return () -> {
            try {
                constants$396.PFNGLTEXTUREBARRIERPROC$MH.invokeExact((Addressable)symbol);
            } catch (Throwable ex$) {
