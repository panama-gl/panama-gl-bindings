...
public interface PFNGLGENSEMAPHORESEXTPROC {
    ...
    static MemorySegment allocate(PFNGLGENSEMAPHORESEXTPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLGENSEMAPHORESEXTPROC.class, fi, constants$745.PFNGLGENSEMAPHORESEXTPROC$FUNC, session);
    }
    static PFNGLGENSEMAPHORESEXTPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _n, java.lang.foreign.MemoryAddress _semaphores) -> {
            try {
                constants$745.PFNGLGENSEMAPHORESEXTPROC$MH.invokeExact((Addressable)symbol, _n, (java.lang.foreign.Addressable)_semaphores);
            } catch (Throwable ex$) {
