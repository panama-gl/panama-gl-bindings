...
public interface PFNGLGETQUERYIVPROC {
    ...
    static MemorySegment allocate(PFNGLGETQUERYIVPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLGETQUERYIVPROC.class, fi, constants$194.PFNGLGETQUERYIVPROC$FUNC, session);
    }
    static PFNGLGETQUERYIVPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _target, int _pname, java.lang.foreign.MemoryAddress _params) -> {
            try {
                constants$194.PFNGLGETQUERYIVPROC$MH.invokeExact((Addressable)symbol, _target, _pname, (java.lang.foreign.Addressable)_params);
            } catch (Throwable ex$) {
