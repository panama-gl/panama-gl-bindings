...
public interface PFNGLGETCOMPRESSEDTEXTURESUBIMAGEPROC {
    ...
    static MemorySegment allocate(PFNGLGETCOMPRESSEDTEXTURESUBIMAGEPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLGETCOMPRESSEDTEXTURESUBIMAGEPROC.class, fi, constants$389.PFNGLGETCOMPRESSEDTEXTURESUBIMAGEPROC$FUNC, session);
    }
    static PFNGLGETCOMPRESSEDTEXTURESUBIMAGEPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _texture, int _level, int _xoffset, int _yoffset, int _zoffset, int _width, int _height, int _depth, int _bufSize, java.lang.foreign.MemoryAddress _pixels) -> {
            try {
                constants$389.PFNGLGETCOMPRESSEDTEXTURESUBIMAGEPROC$MH.invokeExact((Addressable)symbol, _texture, _level, _xoffset, _yoffset, _zoffset, _width, _height, _depth, _bufSize, (java.lang.foreign.Addressable)_pixels);
            } catch (Throwable ex$) {
