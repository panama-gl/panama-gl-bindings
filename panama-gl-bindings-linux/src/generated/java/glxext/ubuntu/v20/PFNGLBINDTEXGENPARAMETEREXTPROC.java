...
public interface PFNGLBINDTEXGENPARAMETEREXTPROC {
    ...
    static MemorySegment allocate(PFNGLBINDTEXGENPARAMETEREXTPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLBINDTEXGENPARAMETEREXTPROC.class, fi, constants$776.PFNGLBINDTEXGENPARAMETEREXTPROC$FUNC, session);
    }
    static PFNGLBINDTEXGENPARAMETEREXTPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _unit, int _coord, int _value) -> {
            try {
                return (int)constants$776.PFNGLBINDTEXGENPARAMETEREXTPROC$MH.invokeExact((Addressable)symbol, _unit, _coord, _value);
            } catch (Throwable ex$) {
