...
public interface PFNGLSAMPLECOVERAGEARBPROC {
    ...
    static MemorySegment allocate(PFNGLSAMPLECOVERAGEARBPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLSAMPLECOVERAGEARBPROC.class, fi, constants$431.PFNGLSAMPLECOVERAGEARBPROC$FUNC, session);
    }
    static PFNGLSAMPLECOVERAGEARBPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (float _value, byte _invert) -> {
            try {
                constants$431.PFNGLSAMPLECOVERAGEARBPROC$MH.invokeExact((Addressable)symbol, _value, _invert);
            } catch (Throwable ex$) {
