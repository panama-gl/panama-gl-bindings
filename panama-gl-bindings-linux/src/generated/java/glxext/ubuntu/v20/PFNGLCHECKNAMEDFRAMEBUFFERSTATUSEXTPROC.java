...
public interface PFNGLCHECKNAMEDFRAMEBUFFERSTATUSEXTPROC {
    ...
    static MemorySegment allocate(PFNGLCHECKNAMEDFRAMEBUFFERSTATUSEXTPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLCHECKNAMEDFRAMEBUFFERSTATUSEXTPROC.class, fi, constants$681.PFNGLCHECKNAMEDFRAMEBUFFERSTATUSEXTPROC$FUNC, session);
    }
    static PFNGLCHECKNAMEDFRAMEBUFFERSTATUSEXTPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _framebuffer, int _target) -> {
            try {
                return (int)constants$681.PFNGLCHECKNAMEDFRAMEBUFFERSTATUSEXTPROC$MH.invokeExact((Addressable)symbol, _framebuffer, _target);
            } catch (Throwable ex$) {
