...
public interface PFNGLBINDMATERIALPARAMETEREXTPROC {
    ...
    static MemorySegment allocate(PFNGLBINDMATERIALPARAMETEREXTPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLBINDMATERIALPARAMETEREXTPROC.class, fi, constants$776.PFNGLBINDMATERIALPARAMETEREXTPROC$FUNC, session);
    }
    static PFNGLBINDMATERIALPARAMETEREXTPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _face, int _value) -> {
            try {
                return (int)constants$776.PFNGLBINDMATERIALPARAMETEREXTPROC$MH.invokeExact((Addressable)symbol, _face, _value);
            } catch (Throwable ex$) {
