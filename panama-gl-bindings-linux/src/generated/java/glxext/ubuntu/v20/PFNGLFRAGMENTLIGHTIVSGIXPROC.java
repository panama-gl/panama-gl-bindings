...
public interface PFNGLFRAGMENTLIGHTIVSGIXPROC {
    ...
    static MemorySegment allocate(PFNGLFRAGMENTLIGHTIVSGIXPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLFRAGMENTLIGHTIVSGIXPROC.class, fi, constants$979.PFNGLFRAGMENTLIGHTIVSGIXPROC$FUNC, session);
    }
    static PFNGLFRAGMENTLIGHTIVSGIXPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _light, int _pname, java.lang.foreign.MemoryAddress _params) -> {
            try {
                constants$979.PFNGLFRAGMENTLIGHTIVSGIXPROC$MH.invokeExact((Addressable)symbol, _light, _pname, (java.lang.foreign.Addressable)_params);
            } catch (Throwable ex$) {
