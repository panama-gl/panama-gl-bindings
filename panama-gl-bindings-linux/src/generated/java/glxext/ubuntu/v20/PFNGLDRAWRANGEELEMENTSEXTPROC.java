...
public interface PFNGLDRAWRANGEELEMENTSEXTPROC {
    ...
    static MemorySegment allocate(PFNGLDRAWRANGEELEMENTSEXTPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLDRAWRANGEELEMENTSEXTPROC.class, fi, constants$707.PFNGLDRAWRANGEELEMENTSEXTPROC$FUNC, session);
    }
    static PFNGLDRAWRANGEELEMENTSEXTPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _mode, int _start, int _end, int _count, int _type, java.lang.foreign.MemoryAddress _indices) -> {
            try {
                constants$707.PFNGLDRAWRANGEELEMENTSEXTPROC$MH.invokeExact((Addressable)symbol, _mode, _start, _end, _count, _type, (java.lang.foreign.Addressable)_indices);
            } catch (Throwable ex$) {
