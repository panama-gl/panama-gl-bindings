...
public interface PFNGLDELETEFENCESAPPLEPROC {
    ...
    static MemorySegment allocate(PFNGLDELETEFENCESAPPLEPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLDELETEFENCESAPPLEPROC.class, fi, constants$562.PFNGLDELETEFENCESAPPLEPROC$FUNC, session);
    }
    static PFNGLDELETEFENCESAPPLEPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _n, java.lang.foreign.MemoryAddress _fences) -> {
            try {
                constants$562.PFNGLDELETEFENCESAPPLEPROC$MH.invokeExact((Addressable)symbol, _n, (java.lang.foreign.Addressable)_fences);
            } catch (Throwable ex$) {
