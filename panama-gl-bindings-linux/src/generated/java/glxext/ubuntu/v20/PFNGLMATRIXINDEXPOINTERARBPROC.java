...
public interface PFNGLMATRIXINDEXPOINTERARBPROC {
    ...
    static MemorySegment allocate(PFNGLMATRIXINDEXPOINTERARBPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLMATRIXINDEXPOINTERARBPROC.class, fi, constants$430.PFNGLMATRIXINDEXPOINTERARBPROC$FUNC, session);
    }
    static PFNGLMATRIXINDEXPOINTERARBPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _size, int _type, int _stride, java.lang.foreign.MemoryAddress _pointer) -> {
            try {
                constants$430.PFNGLMATRIXINDEXPOINTERARBPROC$MH.invokeExact((Addressable)symbol, _size, _type, _stride, (java.lang.foreign.Addressable)_pointer);
            } catch (Throwable ex$) {
