...
public interface PFNGLBLITNAMEDFRAMEBUFFERPROC {
    ...
    static MemorySegment allocate(PFNGLBLITNAMEDFRAMEBUFFERPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLBLITNAMEDFRAMEBUFFERPROC.class, fi, constants$367.PFNGLBLITNAMEDFRAMEBUFFERPROC$FUNC, session);
    }
    static PFNGLBLITNAMEDFRAMEBUFFERPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _readFramebuffer, int _drawFramebuffer, int _srcX0, int _srcY0, int _srcX1, int _srcY1, int _dstX0, int _dstY0, int _dstX1, int _dstY1, int _mask, int _filter) -> {
            try {
                constants$367.PFNGLBLITNAMEDFRAMEBUFFERPROC$MH.invokeExact((Addressable)symbol, _readFramebuffer, _drawFramebuffer, _srcX0, _srcY0, _srcX1, _srcY1, _dstX0, _dstY0, _dstX1, _dstY1, _mask, _filter);
            } catch (Throwable ex$) {
