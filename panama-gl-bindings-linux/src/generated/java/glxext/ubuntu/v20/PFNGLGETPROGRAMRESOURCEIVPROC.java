...
public interface PFNGLGETPROGRAMRESOURCEIVPROC {
    ...
    static MemorySegment allocate(PFNGLGETPROGRAMRESOURCEIVPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLGETPROGRAMRESOURCEIVPROC.class, fi, constants$344.PFNGLGETPROGRAMRESOURCEIVPROC$FUNC, session);
    }
    static PFNGLGETPROGRAMRESOURCEIVPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _program, int _programInterface, int _index, int _propCount, java.lang.foreign.MemoryAddress _props, int _bufSize, java.lang.foreign.MemoryAddress _length, java.lang.foreign.MemoryAddress _params) -> {
            try {
                constants$344.PFNGLGETPROGRAMRESOURCEIVPROC$MH.invokeExact((Addressable)symbol, _program, _programInterface, _index, _propCount, (java.lang.foreign.Addressable)_props, _bufSize, (java.lang.foreign.Addressable)_length, (java.lang.foreign.Addressable)_params);
            } catch (Throwable ex$) {
