...
public interface PFNGLRASTERPOS2XVOESPROC {
    ...
    static MemorySegment allocate(PFNGLRASTERPOS2XVOESPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLRASTERPOS2XVOESPROC.class, fi, constants$525.PFNGLRASTERPOS2XVOESPROC$FUNC, session);
    }
    static PFNGLRASTERPOS2XVOESPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _coords) -> {
            try {
                constants$525.PFNGLRASTERPOS2XVOESPROC$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_coords);
            } catch (Throwable ex$) {
