...
public interface PFNGLPOINTPARAMETERFSGISPROC {
    ...
    static MemorySegment allocate(PFNGLPOINTPARAMETERFSGISPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLPOINTPARAMETERFSGISPROC.class, fi, constants$973.PFNGLPOINTPARAMETERFSGISPROC$FUNC, session);
    }
    static PFNGLPOINTPARAMETERFSGISPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _pname, float _param) -> {
            try {
                constants$973.PFNGLPOINTPARAMETERFSGISPROC$MH.invokeExact((Addressable)symbol, _pname, _param);
            } catch (Throwable ex$) {
