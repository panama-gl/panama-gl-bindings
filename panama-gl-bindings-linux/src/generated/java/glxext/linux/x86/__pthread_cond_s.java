...
public class __pthread_cond_s {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.unionLayout(
            glxext_h.C_LONG_LONG.withName("__wseq"),
            __pthread_cond_s.__wseq32.layout().withName("__wseq32")
        ).withName("$anon$94:17"),
        MemoryLayout.unionLayout(
            glxext_h.C_LONG_LONG.withName("__g1_start"),
            __pthread_cond_s.__g1_start32.layout().withName("__g1_start32")
        ).withName("$anon$103:17"),
        MemoryLayout.sequenceLayout(2, glxext_h.C_INT).withName("__g_refs"),
        MemoryLayout.sequenceLayout(2, glxext_h.C_INT).withName("__g_size"),
        glxext_h.C_INT.withName("__g1_orig_size"),
        glxext_h.C_INT.withName("__wrefs"),
        MemoryLayout.sequenceLayout(2, glxext_h.C_INT).withName("__g_signals")
    ...
    public static class __wseq32 {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            glxext_h.C_INT.withName("__low"),
            glxext_h.C_INT.withName("__high")
        ).withName("$anon$97:5");
