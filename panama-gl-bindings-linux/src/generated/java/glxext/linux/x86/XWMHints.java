...
public class XWMHints {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glxext_h.C_INT.withName("input"),
        glxext_h.C_INT.withName("initial_state"),
        glxext_h.C_LONG.withName("icon_pixmap"),
        glxext_h.C_LONG.withName("icon_window"),
        glxext_h.C_INT.withName("icon_x"),
        glxext_h.C_INT.withName("icon_y"),
        glxext_h.C_LONG.withName("icon_mask"),
        glxext_h.C_LONG.withName("window_group")
    ).withName("$anon$119:9");
