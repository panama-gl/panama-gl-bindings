 ...
 * }
 */
public class PFNGLXGETFBCONFIGSPROC {
    ...
    private static final MethodHandle UP$MH = glxext_h.upcallHandle(PFNGLXGETFBCONFIGSPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLXGETFBCONFIGSPROC.Function fi, Arena arena) {
