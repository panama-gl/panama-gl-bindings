...
public class XColor {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        glxext_h.C_LONG.withName("pixel"),
        glxext_h.C_SHORT.withName("red"),
        glxext_h.C_SHORT.withName("green"),
        glxext_h.C_SHORT.withName("blue"),
        glxext_h.C_CHAR.withName("flags"),
        glxext_h.C_CHAR.withName("pad")
    ).withName("$anon$410:9");
