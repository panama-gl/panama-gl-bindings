...
public class XWindowAttributes {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glxext_h.C_INT.withName("border_width"),
        glxext_h.C_INT.withName("depth"),
        glxext_h.C_POINTER.withName("visual"),
        glxext_h.C_LONG.withName("root"),
        glxext_h.C_INT.withName("class"),
        glxext_h.C_INT.withName("bit_gravity"),
        glxext_h.C_INT.withName("win_gravity"),
        glxext_h.C_INT.withName("backing_store"),
        glxext_h.C_LONG.withName("backing_planes"),
        glxext_h.C_LONG.withName("backing_pixel"),
        glxext_h.C_INT.withName("save_under"),
        MemoryLayout.paddingLayout(4),
        glxext_h.C_LONG.withName("colormap"),
        glxext_h.C_INT.withName("map_installed"),
        glxext_h.C_INT.withName("map_state"),
        glxext_h.C_LONG.withName("all_event_masks"),
        glxext_h.C_LONG.withName("your_event_mask"),
        glxext_h.C_LONG.withName("do_not_propagate_mask"),
        glxext_h.C_INT.withName("override_redirect"),
        MemoryLayout.paddingLayout(4),
        glxext_h.C_POINTER.withName("screen")
    ).withName("$anon$308:9");
