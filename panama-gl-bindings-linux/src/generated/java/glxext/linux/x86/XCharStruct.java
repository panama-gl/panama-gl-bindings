...
public class XCharStruct {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        glxext_h.C_SHORT.withName("lbearing"),
        glxext_h.C_SHORT.withName("rbearing"),
        glxext_h.C_SHORT.withName("width"),
        glxext_h.C_SHORT.withName("ascent"),
        glxext_h.C_SHORT.withName("descent"),
        glxext_h.C_SHORT.withName("attributes")
