 ...
 * }
 */
public class PFNGLXGETPROCADDRESSPROC {
    ...
    private static final MethodHandle UP$MH = glxext_h.upcallHandle(PFNGLXGETPROCADDRESSPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLXGETPROCADDRESSPROC.Function fi, Arena arena) {
