...
public class XCrossingEvent {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glxext_h.C_LONG.withName("subwindow"),
        glxext_h.C_LONG.withName("time"),
        glxext_h.C_INT.withName("x"),
        glxext_h.C_INT.withName("y"),
        glxext_h.C_INT.withName("x_root"),
        glxext_h.C_INT.withName("y_root"),
        glxext_h.C_INT.withName("mode"),
        glxext_h.C_INT.withName("detail"),
        glxext_h.C_INT.withName("same_screen"),
        glxext_h.C_INT.withName("focus"),
        glxext_h.C_INT.withName("state"),
        MemoryLayout.paddingLayout(4)
    ).withName("$anon$610:9");
