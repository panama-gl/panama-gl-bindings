...
public class _XExtData {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        glxext_h.C_INT.withName("number"),
        MemoryLayout.paddingLayout(4),
        glxext_h.C_POINTER.withName("next"),
        glxext_h.C_POINTER.withName("free_private"),
        glxext_h.C_POINTER.withName("private_data")
    ).withName("_XExtData");
     ...
     * }
     */
    public static class free_private {
        ...
        private static final MethodHandle UP$MH = glxext_h.upcallHandle(free_private.Function.class, "apply", $DESC);
