 ...
 * }
 */
public class PFNGLXALLOCATEMEMORYNVPROC {
    ...
    private static final MethodHandle UP$MH = glxext_h.upcallHandle(PFNGLXALLOCATEMEMORYNVPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLXALLOCATEMEMORYNVPROC.Function fi, Arena arena) {
