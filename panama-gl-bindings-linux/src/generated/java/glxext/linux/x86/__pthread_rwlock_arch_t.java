...
public class __pthread_rwlock_arch_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        glxext_h.C_INT.withName("__readers"),
        glxext_h.C_INT.withName("__writers"),
        glxext_h.C_INT.withName("__wrphase_futex"),
        glxext_h.C_INT.withName("__writers_futex"),
        glxext_h.C_INT.withName("__pad3"),
        glxext_h.C_INT.withName("__pad4"),
        glxext_h.C_INT.withName("__cur_writer"),
        glxext_h.C_INT.withName("__shared"),
        glxext_h.C_CHAR.withName("__rwelision"),
        MemoryLayout.sequenceLayout(7, glxext_h.C_CHAR).withName("__pad1"),
        glxext_h.C_LONG.withName("__pad2"),
        glxext_h.C_INT.withName("__flags"),
