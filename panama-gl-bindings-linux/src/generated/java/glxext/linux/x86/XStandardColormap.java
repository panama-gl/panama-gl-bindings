...
public class XStandardColormap {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glxext_h.C_LONG.withName("red_max"),
        glxext_h.C_LONG.withName("red_mult"),
        glxext_h.C_LONG.withName("green_max"),
        glxext_h.C_LONG.withName("green_mult"),
        glxext_h.C_LONG.withName("blue_max"),
        glxext_h.C_LONG.withName("blue_mult"),
        glxext_h.C_LONG.withName("base_pixel"),
        glxext_h.C_LONG.withName("visualid"),
        glxext_h.C_LONG.withName("killid")
    ).withName("$anon$320:9");
