...
public class XSizeHints {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        glxext_h.C_LONG.withName("flags"),
        glxext_h.C_INT.withName("x"),
        glxext_h.C_INT.withName("y"),
        glxext_h.C_INT.withName("width"),
        glxext_h.C_INT.withName("height"),
        glxext_h.C_INT.withName("min_width"),
        glxext_h.C_INT.withName("min_height"),
        glxext_h.C_INT.withName("max_width"),
        glxext_h.C_INT.withName("max_height"),
        glxext_h.C_INT.withName("width_inc"),
        glxext_h.C_INT.withName("height_inc"),
        XSizeHints.min_aspect.layout().withName("min_aspect"),
        XSizeHints.min_aspect.layout().withName("max_aspect"),
        glxext_h.C_INT.withName("base_width"),
        glxext_h.C_INT.withName("base_height"),
