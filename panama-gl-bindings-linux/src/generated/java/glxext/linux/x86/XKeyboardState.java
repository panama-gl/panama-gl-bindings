...
public class XKeyboardState {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        glxext_h.C_INT.withName("key_click_percent"),
        glxext_h.C_INT.withName("bell_percent"),
        glxext_h.C_INT.withName("bell_pitch"),
        glxext_h.C_INT.withName("bell_duration"),
        glxext_h.C_LONG.withName("led_mask"),
        glxext_h.C_INT.withName("global_auto_repeat"),
        MemoryLayout.sequenceLayout(32, glxext_h.C_CHAR).withName("auto_repeats"),
