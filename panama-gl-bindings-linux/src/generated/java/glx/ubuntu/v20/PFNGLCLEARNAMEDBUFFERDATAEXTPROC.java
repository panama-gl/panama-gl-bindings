...
public interface PFNGLCLEARNAMEDBUFFERDATAEXTPROC {
    ...
    static MemorySegment allocate(PFNGLCLEARNAMEDBUFFERDATAEXTPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLCLEARNAMEDBUFFERDATAEXTPROC.class, fi, constants$694.PFNGLCLEARNAMEDBUFFERDATAEXTPROC$FUNC, session);
    }
    static PFNGLCLEARNAMEDBUFFERDATAEXTPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _buffer, int _internalformat, int _format, int _type, java.lang.foreign.MemoryAddress _data) -> {
            try {
                constants$694.PFNGLCLEARNAMEDBUFFERDATAEXTPROC$MH.invokeExact((Addressable)symbol, _buffer, _internalformat, _format, _type, (java.lang.foreign.Addressable)_data);
            } catch (Throwable ex$) {
