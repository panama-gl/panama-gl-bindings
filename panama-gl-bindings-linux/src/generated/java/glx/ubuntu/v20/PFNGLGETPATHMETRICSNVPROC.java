...
public interface PFNGLGETPATHMETRICSNVPROC {
    ...
    static MemorySegment allocate(PFNGLGETPATHMETRICSNVPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLGETPATHMETRICSNVPROC.class, fi, constants$883.PFNGLGETPATHMETRICSNVPROC$FUNC, session);
    }
    static PFNGLGETPATHMETRICSNVPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _metricQueryMask, int _numPaths, int _pathNameType, java.lang.foreign.MemoryAddress _paths, int _pathBase, int _stride, java.lang.foreign.MemoryAddress _metrics) -> {
            try {
                constants$883.PFNGLGETPATHMETRICSNVPROC$MH.invokeExact((Addressable)symbol, _metricQueryMask, _numPaths, _pathNameType, (java.lang.foreign.Addressable)_paths, _pathBase, _stride, (java.lang.foreign.Addressable)_metrics);
            } catch (Throwable ex$) {
