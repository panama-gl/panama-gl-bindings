...
class constants$552 {
    ...
    static final MethodHandle PFNGLPROGRAMUNIFORM4UI64VNVPROC$MH = RuntimeHelper.downcallHandle(
        constants$552.PFNGLPROGRAMUNIFORM4UI64VNVPROC$FUNC
    );
    ...
    static final MethodHandle PFNGLVERTEXATTRIBPARAMETERIAMDPROC$MH = RuntimeHelper.downcallHandle(
        constants$552.PFNGLVERTEXATTRIBPARAMETERIAMDPROC$FUNC
    );
    ...
    static final MethodHandle PFNGLMULTIDRAWARRAYSINDIRECTAMDPROC$MH = RuntimeHelper.downcallHandle(
        constants$552.PFNGLMULTIDRAWARRAYSINDIRECTAMDPROC$FUNC
    );
}
