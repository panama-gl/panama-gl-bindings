...
public interface PFNGLACQUIREKEYEDMUTEXWIN32EXTPROC {
    ...
    static MemorySegment allocate(PFNGLACQUIREKEYEDMUTEXWIN32EXTPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLACQUIREKEYEDMUTEXWIN32EXTPROC.class, fi, constants$782.PFNGLACQUIREKEYEDMUTEXWIN32EXTPROC$FUNC, session);
    }
    static PFNGLACQUIREKEYEDMUTEXWIN32EXTPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _memory, long _key, int _timeout) -> {
            try {
                return (byte)constants$782.PFNGLACQUIREKEYEDMUTEXWIN32EXTPROC$MH.invokeExact((Addressable)symbol, _memory, _key, _timeout);
            } catch (Throwable ex$) {
