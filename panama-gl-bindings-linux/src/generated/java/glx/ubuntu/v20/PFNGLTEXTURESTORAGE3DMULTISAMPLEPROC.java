...
public interface PFNGLTEXTURESTORAGE3DMULTISAMPLEPROC {
    ...
    static MemorySegment allocate(PFNGLTEXTURESTORAGE3DMULTISAMPLEPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLTEXTURESTORAGE3DMULTISAMPLEPROC.class, fi, constants$372.PFNGLTEXTURESTORAGE3DMULTISAMPLEPROC$FUNC, session);
    }
    static PFNGLTEXTURESTORAGE3DMULTISAMPLEPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _texture, int _samples, int _internalformat, int _width, int _height, int _depth, byte _fixedsamplelocations) -> {
            try {
                constants$372.PFNGLTEXTURESTORAGE3DMULTISAMPLEPROC$MH.invokeExact((Addressable)symbol, _texture, _samples, _internalformat, _width, _height, _depth, _fixedsamplelocations);
            } catch (Throwable ex$) {
