...
public interface PFNGLMAPNAMEDBUFFEREXTPROC {
    ...
    static MemorySegment allocate(PFNGLMAPNAMEDBUFFEREXTPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLMAPNAMEDBUFFEREXTPROC.class, fi, constants$656.PFNGLMAPNAMEDBUFFEREXTPROC$FUNC, session);
    }
    static PFNGLMAPNAMEDBUFFEREXTPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _buffer, int _access) -> {
            try {
                return (java.lang.foreign.Addressable)(java.lang.foreign.MemoryAddress)constants$656.PFNGLMAPNAMEDBUFFEREXTPROC$MH.invokeExact((Addressable)symbol, _buffer, _access);
            } catch (Throwable ex$) {
