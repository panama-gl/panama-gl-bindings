...
public interface PFNGLDELETEQUERYRESOURCETAGNVPROC {
    ...
    static MemorySegment allocate(PFNGLDELETEQUERYRESOURCETAGNVPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLDELETEQUERYRESOURCETAGNVPROC.class, fi, constants$897.PFNGLDELETEQUERYRESOURCETAGNVPROC$FUNC, session);
    }
    static PFNGLDELETEQUERYRESOURCETAGNVPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _n, java.lang.foreign.MemoryAddress _tagIds) -> {
            try {
                constants$897.PFNGLDELETEQUERYRESOURCETAGNVPROC$MH.invokeExact((Addressable)symbol, _n, (java.lang.foreign.Addressable)_tagIds);
            } catch (Throwable ex$) {
