...
public interface PFNGLWINDOWPOS2IMESAPROC {
    ...
    static MemorySegment allocate(PFNGLWINDOWPOS2IMESAPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLWINDOWPOS2IMESAPROC.class, fi, constants$798.PFNGLWINDOWPOS2IMESAPROC$FUNC, session);
    }
    static PFNGLWINDOWPOS2IMESAPROC ofAddress(MemoryAddress addr, MemorySession session) {
        MemorySegment symbol = MemorySegment.ofAddress(addr, 0, session);
        return (int _x, int _y) -> {
            try {
                constants$798.PFNGLWINDOWPOS2IMESAPROC$MH.invokeExact((Addressable)symbol, _x, _y);
            } catch (Throwable ex$) {
