...
public interface PFNGLAREPROGRAMSRESIDENTNVPROC {
    ...
    static MemorySegment allocate(PFNGLAREPROGRAMSRESIDENTNVPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLAREPROGRAMSRESIDENTNVPROC.class, fi, constants$935.PFNGLAREPROGRAMSRESIDENTNVPROC$FUNC, session);
    }
    static PFNGLAREPROGRAMSRESIDENTNVPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _n, java.lang.foreign.MemoryAddress _programs, java.lang.foreign.MemoryAddress _residences) -> {
            try {
                return (byte)constants$935.PFNGLAREPROGRAMSRESIDENTNVPROC$MH.invokeExact((Addressable)symbol, _n, (java.lang.foreign.Addressable)_programs, (java.lang.foreign.Addressable)_residences);
            } catch (Throwable ex$) {
