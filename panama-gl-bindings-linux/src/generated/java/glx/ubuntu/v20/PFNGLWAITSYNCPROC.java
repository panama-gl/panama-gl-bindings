...
public interface PFNGLWAITSYNCPROC {
    ...
    static MemorySegment allocate(PFNGLWAITSYNCPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLWAITSYNCPROC.class, fi, constants$266.PFNGLWAITSYNCPROC$FUNC, session);
    }
    static PFNGLWAITSYNCPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _sync, int _flags, long _timeout) -> {
            try {
                constants$266.PFNGLWAITSYNCPROC$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_sync, _flags, _timeout);
            } catch (Throwable ex$) {
