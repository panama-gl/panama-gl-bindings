...
public interface PFNGLCREATESYNCFROMCLEVENTARBPROC {
    ...
    static MemorySegment allocate(PFNGLCREATESYNCFROMCLEVENTARBPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLCREATESYNCFROMCLEVENTARBPROC.class, fi, constants$403.PFNGLCREATESYNCFROMCLEVENTARBPROC$FUNC, session);
    }
    static PFNGLCREATESYNCFROMCLEVENTARBPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _context, java.lang.foreign.MemoryAddress _event, int _flags) -> {
            try {
                return (java.lang.foreign.Addressable)(java.lang.foreign.MemoryAddress)constants$403.PFNGLCREATESYNCFROMCLEVENTARBPROC$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_context, (java.lang.foreign.Addressable)_event, _flags);
            } catch (Throwable ex$) {
