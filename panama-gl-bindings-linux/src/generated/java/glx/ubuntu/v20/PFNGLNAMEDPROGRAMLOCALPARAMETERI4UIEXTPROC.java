...
public interface PFNGLNAMEDPROGRAMLOCALPARAMETERI4UIEXTPROC {
    ...
    static MemorySegment allocate(PFNGLNAMEDPROGRAMLOCALPARAMETERI4UIEXTPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLNAMEDPROGRAMLOCALPARAMETERI4UIEXTPROC.class, fi, constants$673.PFNGLNAMEDPROGRAMLOCALPARAMETERI4UIEXTPROC$FUNC, session);
    }
    static PFNGLNAMEDPROGRAMLOCALPARAMETERI4UIEXTPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _program, int _target, int _index, int _x, int _y, int _z, int _w) -> {
            try {
                constants$673.PFNGLNAMEDPROGRAMLOCALPARAMETERI4UIEXTPROC$MH.invokeExact((Addressable)symbol, _program, _target, _index, _x, _y, _z, _w);
            } catch (Throwable ex$) {
