...
public interface PFNGLSECONDARYCOLORPOINTEREXTPROC {
    ...
    static MemorySegment allocate(PFNGLSECONDARYCOLORPOINTEREXTPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLSECONDARYCOLORPOINTEREXTPROC.class, fi, constants$745.PFNGLSECONDARYCOLORPOINTEREXTPROC$FUNC, session);
    }
    static PFNGLSECONDARYCOLORPOINTEREXTPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _size, int _type, int _stride, java.lang.foreign.MemoryAddress _pointer) -> {
            try {
                constants$745.PFNGLSECONDARYCOLORPOINTEREXTPROC$MH.invokeExact((Addressable)symbol, _size, _type, _stride, (java.lang.foreign.Addressable)_pointer);
            } catch (Throwable ex$) {
