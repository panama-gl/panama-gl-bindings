...
public interface PFNGLVERTEXWEIGHTPOINTEREXTPROC {
    ...
    static MemorySegment allocate(PFNGLVERTEXWEIGHTPOINTEREXTPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLVERTEXWEIGHTPOINTEREXTPROC.class, fi, constants$782.PFNGLVERTEXWEIGHTPOINTEREXTPROC$FUNC, session);
    }
    static PFNGLVERTEXWEIGHTPOINTEREXTPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _size, int _type, int _stride, java.lang.foreign.MemoryAddress _pointer) -> {
            try {
                constants$782.PFNGLVERTEXWEIGHTPOINTEREXTPROC$MH.invokeExact((Addressable)symbol, _size, _type, _stride, (java.lang.foreign.Addressable)_pointer);
            } catch (Throwable ex$) {
