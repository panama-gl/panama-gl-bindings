...
class constants$701 {
    ...
    static final MethodHandle PFNGLPROGRAMUNIFORMMATRIX4X3DVEXTPROC$MH = RuntimeHelper.downcallHandle(
        constants$701.PFNGLPROGRAMUNIFORMMATRIX4X3DVEXTPROC$FUNC
    );
    ...
    static final MethodHandle PFNGLTEXTUREBUFFERRANGEEXTPROC$MH = RuntimeHelper.downcallHandle(
        constants$701.PFNGLTEXTUREBUFFERRANGEEXTPROC$FUNC
    );
    ...
    static final MethodHandle PFNGLTEXTURESTORAGE1DEXTPROC$MH = RuntimeHelper.downcallHandle(
        constants$701.PFNGLTEXTURESTORAGE1DEXTPROC$FUNC
    );
}
