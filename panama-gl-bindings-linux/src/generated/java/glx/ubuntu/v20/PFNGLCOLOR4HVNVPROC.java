...
public interface PFNGLCOLOR4HVNVPROC {
    ...
    static MemorySegment allocate(PFNGLCOLOR4HVNVPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLCOLOR4HVNVPROC.class, fi, constants$853.PFNGLCOLOR4HVNVPROC$FUNC, session);
    }
    static PFNGLCOLOR4HVNVPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _v) -> {
            try {
                constants$853.PFNGLCOLOR4HVNVPROC$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_v);
            } catch (Throwable ex$) {
