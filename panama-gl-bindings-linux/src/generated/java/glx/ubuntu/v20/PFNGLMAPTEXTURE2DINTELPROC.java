...
public interface PFNGLMAPTEXTURE2DINTELPROC {
    ...
    static MemorySegment allocate(PFNGLMAPTEXTURE2DINTELPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLMAPTEXTURE2DINTELPROC.class, fi, constants$791.PFNGLMAPTEXTURE2DINTELPROC$FUNC, session);
    }
    static PFNGLMAPTEXTURE2DINTELPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _texture, int _level, int _access, java.lang.foreign.MemoryAddress _stride, java.lang.foreign.MemoryAddress _layout) -> {
            try {
                return (java.lang.foreign.Addressable)(java.lang.foreign.MemoryAddress)constants$791.PFNGLMAPTEXTURE2DINTELPROC$MH.invokeExact((Addressable)symbol, _texture, _level, _access, (java.lang.foreign.Addressable)_stride, (java.lang.foreign.Addressable)_layout);
            } catch (Throwable ex$) {
