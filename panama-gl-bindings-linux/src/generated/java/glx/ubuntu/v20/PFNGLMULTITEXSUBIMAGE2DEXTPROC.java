...
public interface PFNGLMULTITEXSUBIMAGE2DEXTPROC {
    ...
    static MemorySegment allocate(PFNGLMULTITEXSUBIMAGE2DEXTPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLMULTITEXSUBIMAGE2DEXTPROC.class, fi, constants$641.PFNGLMULTITEXSUBIMAGE2DEXTPROC$FUNC, session);
    }
    static PFNGLMULTITEXSUBIMAGE2DEXTPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _texunit, int _target, int _level, int _xoffset, int _yoffset, int _width, int _height, int _format, int _type, java.lang.foreign.MemoryAddress _pixels) -> {
            try {
                constants$641.PFNGLMULTITEXSUBIMAGE2DEXTPROC$MH.invokeExact((Addressable)symbol, _texunit, _target, _level, _xoffset, _yoffset, _width, _height, _format, _type, (java.lang.foreign.Addressable)_pixels);
            } catch (Throwable ex$) {
