...
public interface PFNGLPROGRAMLOCALPARAMETERSI4UIVNVPROC {
    ...
    static MemorySegment allocate(PFNGLPROGRAMLOCALPARAMETERSI4UIVNVPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLPROGRAMLOCALPARAMETERSI4UIVNVPROC.class, fi, constants$845.PFNGLPROGRAMLOCALPARAMETERSI4UIVNVPROC$FUNC, session);
    }
    static PFNGLPROGRAMLOCALPARAMETERSI4UIVNVPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _target, int _index, int _count, java.lang.foreign.MemoryAddress _params) -> {
            try {
                constants$845.PFNGLPROGRAMLOCALPARAMETERSI4UIVNVPROC$MH.invokeExact((Addressable)symbol, _target, _index, _count, (java.lang.foreign.Addressable)_params);
            } catch (Throwable ex$) {
