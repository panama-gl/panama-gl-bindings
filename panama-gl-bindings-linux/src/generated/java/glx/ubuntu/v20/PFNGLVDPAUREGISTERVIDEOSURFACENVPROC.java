...
public interface PFNGLVDPAUREGISTERVIDEOSURFACENVPROC {
    ...
    static MemorySegment allocate(PFNGLVDPAUREGISTERVIDEOSURFACENVPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLVDPAUREGISTERVIDEOSURFACENVPROC.class, fi, constants$921.PFNGLVDPAUREGISTERVIDEOSURFACENVPROC$FUNC, session);
    }
    static PFNGLVDPAUREGISTERVIDEOSURFACENVPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _vdpSurface, int _target, int _numTextureNames, java.lang.foreign.MemoryAddress _textureNames) -> {
            try {
                return (long)constants$921.PFNGLVDPAUREGISTERVIDEOSURFACENVPROC$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_vdpSurface, _target, _numTextureNames, (java.lang.foreign.Addressable)_textureNames);
            } catch (Throwable ex$) {
