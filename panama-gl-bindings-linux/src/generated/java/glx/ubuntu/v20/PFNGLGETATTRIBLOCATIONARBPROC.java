...
public interface PFNGLGETATTRIBLOCATIONARBPROC {
    ...
    static MemorySegment allocate(PFNGLGETATTRIBLOCATIONARBPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLGETATTRIBLOCATIONARBPROC.class, fi, constants$485.PFNGLGETATTRIBLOCATIONARBPROC$FUNC, session);
    }
    static PFNGLGETATTRIBLOCATIONARBPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _programObj, java.lang.foreign.MemoryAddress _name) -> {
            try {
                return (int)constants$485.PFNGLGETATTRIBLOCATIONARBPROC$MH.invokeExact((Addressable)symbol, _programObj, (java.lang.foreign.Addressable)_name);
            } catch (Throwable ex$) {
