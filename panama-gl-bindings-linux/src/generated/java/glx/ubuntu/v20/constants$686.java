...
class constants$686 {
    ...
    static final MethodHandle PFNGLNAMEDFRAMEBUFFERTEXTUREFACEEXTPROC$MH = RuntimeHelper.downcallHandle(
        constants$686.PFNGLNAMEDFRAMEBUFFERTEXTUREFACEEXTPROC$FUNC
    );
    ...
    static final MethodHandle PFNGLTEXTURERENDERBUFFEREXTPROC$MH = RuntimeHelper.downcallHandle(
        constants$686.PFNGLTEXTURERENDERBUFFEREXTPROC$FUNC
    );
    ...
    static final MethodHandle PFNGLMULTITEXRENDERBUFFEREXTPROC$MH = RuntimeHelper.downcallHandle(
        constants$686.PFNGLMULTITEXRENDERBUFFEREXTPROC$FUNC
    );
}
