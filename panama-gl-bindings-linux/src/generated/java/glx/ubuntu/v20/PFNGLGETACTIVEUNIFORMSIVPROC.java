...
public interface PFNGLGETACTIVEUNIFORMSIVPROC {
    ...
    static MemorySegment allocate(PFNGLGETACTIVEUNIFORMSIVPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLGETACTIVEUNIFORMSIVPROC.class, fi, constants$261.PFNGLGETACTIVEUNIFORMSIVPROC$FUNC, session);
    }
    static PFNGLGETACTIVEUNIFORMSIVPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _program, int _uniformCount, java.lang.foreign.MemoryAddress _uniformIndices, int _pname, java.lang.foreign.MemoryAddress _params) -> {
            try {
                constants$261.PFNGLGETACTIVEUNIFORMSIVPROC$MH.invokeExact((Addressable)symbol, _program, _uniformCount, (java.lang.foreign.Addressable)_uniformIndices, _pname, (java.lang.foreign.Addressable)_params);
            } catch (Throwable ex$) {
