...
public interface PFNGLWINDOWPOS3SVMESAPROC {
    ...
    static MemorySegment allocate(PFNGLWINDOWPOS3SVMESAPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLWINDOWPOS3SVMESAPROC.class, fi, constants$802.PFNGLWINDOWPOS3SVMESAPROC$FUNC, session);
    }
    static PFNGLWINDOWPOS3SVMESAPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _v) -> {
            try {
                constants$802.PFNGLWINDOWPOS3SVMESAPROC$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_v);
            } catch (Throwable ex$) {
