...
public interface PFNGLUNIFORM4IVPROC {
    ...
    static MemorySegment allocate(PFNGLUNIFORM4IVPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLUNIFORM4IVPROC.class, fi, constants$215.PFNGLUNIFORM4IVPROC$FUNC, session);
    }
    static PFNGLUNIFORM4IVPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _location, int _count, java.lang.foreign.MemoryAddress _value) -> {
            try {
                constants$215.PFNGLUNIFORM4IVPROC$MH.invokeExact((Addressable)symbol, _location, _count, (java.lang.foreign.Addressable)_value);
            } catch (Throwable ex$) {
