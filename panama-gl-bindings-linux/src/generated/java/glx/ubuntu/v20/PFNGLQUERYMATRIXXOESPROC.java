...
public interface PFNGLQUERYMATRIXXOESPROC {
    ...
    static MemorySegment allocate(PFNGLQUERYMATRIXXOESPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLQUERYMATRIXXOESPROC.class, fi, constants$533.PFNGLQUERYMATRIXXOESPROC$FUNC, session);
    }
    static PFNGLQUERYMATRIXXOESPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _mantissa, java.lang.foreign.MemoryAddress _exponent) -> {
            try {
                return (int)constants$533.PFNGLQUERYMATRIXXOESPROC$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_mantissa, (java.lang.foreign.Addressable)_exponent);
            } catch (Throwable ex$) {
