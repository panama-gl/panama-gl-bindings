...
public interface PFNGLCOLORTABLESGIPROC {
    ...
    static MemorySegment allocate(PFNGLCOLORTABLESGIPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLCOLORTABLESGIPROC.class, fi, constants$992.PFNGLCOLORTABLESGIPROC$FUNC, session);
    }
    static PFNGLCOLORTABLESGIPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _target, int _internalformat, int _width, int _format, int _type, java.lang.foreign.MemoryAddress _table) -> {
            try {
                constants$992.PFNGLCOLORTABLESGIPROC$MH.invokeExact((Addressable)symbol, _target, _internalformat, _width, _format, _type, (java.lang.foreign.Addressable)_table);
            } catch (Throwable ex$) {
