...
public interface PFNGLARETEXTURESRESIDENTEXTPROC {
    ...
    static MemorySegment allocate(PFNGLARETEXTURESRESIDENTEXTPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLARETEXTURESRESIDENTEXTPROC.class, fi, constants$755.PFNGLARETEXTURESRESIDENTEXTPROC$FUNC, session);
    }
    static PFNGLARETEXTURESRESIDENTEXTPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _n, java.lang.foreign.MemoryAddress _textures, java.lang.foreign.MemoryAddress _residences) -> {
            try {
                return (byte)constants$755.PFNGLARETEXTURESRESIDENTEXTPROC$MH.invokeExact((Addressable)symbol, _n, (java.lang.foreign.Addressable)_textures, (java.lang.foreign.Addressable)_residences);
            } catch (Throwable ex$) {
