...
public interface PFNGLCLEARBUFFERSUBDATAPROC {
    ...
    static MemorySegment allocate(PFNGLCLEARBUFFERSUBDATAPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLCLEARBUFFERSUBDATAPROC.class, fi, constants$338.PFNGLCLEARBUFFERSUBDATAPROC$FUNC, session);
    }
    static PFNGLCLEARBUFFERSUBDATAPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _target, int _internalformat, long _offset, long _size, int _format, int _type, java.lang.foreign.MemoryAddress _data) -> {
            try {
                constants$338.PFNGLCLEARBUFFERSUBDATAPROC$MH.invokeExact((Addressable)symbol, _target, _internalformat, _offset, _size, _format, _type, (java.lang.foreign.Addressable)_data);
            } catch (Throwable ex$) {
