...
public interface PFNGLSPRITEPARAMETERFVSGIXPROC {
    ...
    static MemorySegment allocate(PFNGLSPRITEPARAMETERFVSGIXPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLSPRITEPARAMETERFVSGIXPROC.class, fi, constants$991.PFNGLSPRITEPARAMETERFVSGIXPROC$FUNC, session);
    }
    static PFNGLSPRITEPARAMETERFVSGIXPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _pname, java.lang.foreign.MemoryAddress _params) -> {
            try {
                constants$991.PFNGLSPRITEPARAMETERFVSGIXPROC$MH.invokeExact((Addressable)symbol, _pname, (java.lang.foreign.Addressable)_params);
            } catch (Throwable ex$) {
