...
public interface PFNGLPUSHCLIENTATTRIBDEFAULTEXTPROC {
    ...
    static MemorySegment allocate(PFNGLPUSHCLIENTATTRIBDEFAULTEXTPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLPUSHCLIENTATTRIBDEFAULTEXTPROC.class, fi, constants$626.PFNGLPUSHCLIENTATTRIBDEFAULTEXTPROC$FUNC, session);
    }
    static PFNGLPUSHCLIENTATTRIBDEFAULTEXTPROC ofAddress(MemoryAddress addr, MemorySession session) {
        MemorySegment symbol = MemorySegment.ofAddress(addr, 0, session);
        return (int _mask) -> {
            try {
                constants$626.PFNGLPUSHCLIENTATTRIBDEFAULTEXTPROC$MH.invokeExact((Addressable)symbol, _mask);
            } catch (Throwable ex$) {
