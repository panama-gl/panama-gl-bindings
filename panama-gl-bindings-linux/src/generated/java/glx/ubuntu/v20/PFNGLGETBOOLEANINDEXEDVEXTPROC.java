...
public interface PFNGLGETBOOLEANINDEXEDVEXTPROC {
    ...
    static MemorySegment allocate(PFNGLGETBOOLEANINDEXEDVEXTPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLGETBOOLEANINDEXEDVEXTPROC.class, fi, constants$649.PFNGLGETBOOLEANINDEXEDVEXTPROC$FUNC, session);
    }
    static PFNGLGETBOOLEANINDEXEDVEXTPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _target, int _index, java.lang.foreign.MemoryAddress _data) -> {
            try {
                constants$649.PFNGLGETBOOLEANINDEXEDVEXTPROC$MH.invokeExact((Addressable)symbol, _target, _index, (java.lang.foreign.Addressable)_data);
            } catch (Throwable ex$) {
