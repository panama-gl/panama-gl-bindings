...
public interface PFNGLLOADMATRIXXOESPROC {
    ...
    static MemorySegment allocate(PFNGLLOADMATRIXXOESPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLLOADMATRIXXOESPROC.class, fi, constants$505.PFNGLLOADMATRIXXOESPROC$FUNC, session);
    }
    static PFNGLLOADMATRIXXOESPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _m) -> {
            try {
                constants$505.PFNGLLOADMATRIXXOESPROC$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_m);
            } catch (Throwable ex$) {
