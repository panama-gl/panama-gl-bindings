...
public interface PFNGLMULTIDRAWARRAYSINDIRECTAMDPROC {
    ...
    static MemorySegment allocate(PFNGLMULTIDRAWARRAYSINDIRECTAMDPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLMULTIDRAWARRAYSINDIRECTAMDPROC.class, fi, constants$552.PFNGLMULTIDRAWARRAYSINDIRECTAMDPROC$FUNC, session);
    }
    static PFNGLMULTIDRAWARRAYSINDIRECTAMDPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _mode, java.lang.foreign.MemoryAddress _indirect, int _primcount, int _stride) -> {
            try {
                constants$552.PFNGLMULTIDRAWARRAYSINDIRECTAMDPROC$MH.invokeExact((Addressable)symbol, _mode, (java.lang.foreign.Addressable)_indirect, _primcount, _stride);
            } catch (Throwable ex$) {
