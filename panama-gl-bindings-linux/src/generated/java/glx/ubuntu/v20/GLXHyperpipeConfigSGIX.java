...
public class GLXHyperpipeConfigSGIX {
    ...
    static final  GroupLayout $struct$LAYOUT = MemoryLayout.structLayout(
        ...
        Constants$root.C_INT$LAYOUT.withName("channel"),
        Constants$root.C_INT$LAYOUT.withName("participationType"),
        Constants$root.C_INT$LAYOUT.withName("timeSlice")
    );
    ...
    static final VarHandle participationType$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("participationType"));
    ...
    static final VarHandle timeSlice$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("timeSlice"));
