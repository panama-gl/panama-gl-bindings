...
public interface PFNGLGETBUFFERSUBDATAARBPROC {
    ...
    static MemorySegment allocate(PFNGLGETBUFFERSUBDATAARBPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLGETBUFFERSUBDATAARBPROC.class, fi, constants$468.PFNGLGETBUFFERSUBDATAARBPROC$FUNC, session);
    }
    static PFNGLGETBUFFERSUBDATAARBPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _target, long _offset, long _size, java.lang.foreign.MemoryAddress _data) -> {
            try {
                constants$468.PFNGLGETBUFFERSUBDATAARBPROC$MH.invokeExact((Addressable)symbol, _target, _offset, _size, (java.lang.foreign.Addressable)_data);
            } catch (Throwable ex$) {
