...
public interface PFNGLSCISSORARRAYVPROC {
    ...
    static MemorySegment allocate(PFNGLSCISSORARRAYVPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLSCISSORARRAYVPROC.class, fi, constants$331.PFNGLSCISSORARRAYVPROC$FUNC, session);
    }
    static PFNGLSCISSORARRAYVPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _first, int _count, java.lang.foreign.MemoryAddress _v) -> {
            try {
                constants$331.PFNGLSCISSORARRAYVPROC$MH.invokeExact((Addressable)symbol, _first, _count, (java.lang.foreign.Addressable)_v);
            } catch (Throwable ex$) {
