...
public interface PFNGLVERTEXSTREAM2SATIPROC {
    ...
    static MemorySegment allocate(PFNGLVERTEXSTREAM2SATIPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLVERTEXSTREAM2SATIPROC.class, fi, constants$588.PFNGLVERTEXSTREAM2SATIPROC$FUNC, session);
    }
    static PFNGLVERTEXSTREAM2SATIPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _stream, short _x, short _y) -> {
            try {
                constants$588.PFNGLVERTEXSTREAM2SATIPROC$MH.invokeExact((Addressable)symbol, _stream, _x, _y);
            } catch (Throwable ex$) {
