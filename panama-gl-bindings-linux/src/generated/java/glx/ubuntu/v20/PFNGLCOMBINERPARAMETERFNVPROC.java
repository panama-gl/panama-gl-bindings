...
public interface PFNGLCOMBINERPARAMETERFNVPROC {
    ...
    static MemorySegment allocate(PFNGLCOMBINERPARAMETERFNVPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLCOMBINERPARAMETERFNVPROC.class, fi, constants$898.PFNGLCOMBINERPARAMETERFNVPROC$FUNC, session);
    }
    static PFNGLCOMBINERPARAMETERFNVPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _pname, float _param) -> {
            try {
                constants$898.PFNGLCOMBINERPARAMETERFNVPROC$MH.invokeExact((Addressable)symbol, _pname, _param);
            } catch (Throwable ex$) {
