...
public interface PFNGLMULTIDRAWRANGEELEMENTARRAYAPPLEPROC {
    ...
    static MemorySegment allocate(PFNGLMULTIDRAWRANGEELEMENTARRAYAPPLEPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLMULTIDRAWRANGEELEMENTARRAYAPPLEPROC.class, fi, constants$561.PFNGLMULTIDRAWRANGEELEMENTARRAYAPPLEPROC$FUNC, session);
    }
    static PFNGLMULTIDRAWRANGEELEMENTARRAYAPPLEPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _mode, int _start, int _end, java.lang.foreign.MemoryAddress _first, java.lang.foreign.MemoryAddress _count, int _primcount) -> {
            try {
                constants$561.PFNGLMULTIDRAWRANGEELEMENTARRAYAPPLEPROC$MH.invokeExact((Addressable)symbol, _mode, _start, _end, (java.lang.foreign.Addressable)_first, (java.lang.foreign.Addressable)_count, _primcount);
            } catch (Throwable ex$) {
