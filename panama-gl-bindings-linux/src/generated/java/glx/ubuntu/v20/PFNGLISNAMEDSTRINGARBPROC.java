...
public interface PFNGLISNAMEDSTRINGARBPROC {
    ...
    static MemorySegment allocate(PFNGLISNAMEDSTRINGARBPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLISNAMEDSTRINGARBPROC.class, fi, constants$457.PFNGLISNAMEDSTRINGARBPROC$FUNC, session);
    }
    static PFNGLISNAMEDSTRINGARBPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _namelen, java.lang.foreign.MemoryAddress _name) -> {
            try {
                return (byte)constants$457.PFNGLISNAMEDSTRINGARBPROC$MH.invokeExact((Addressable)symbol, _namelen, (java.lang.foreign.Addressable)_name);
            } catch (Throwable ex$) {
