...
public class GLXPbufferClobberEvent {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        glx_h.C_INT.withName("event_type"),
        glx_h.C_INT.withName("draw_type"),
