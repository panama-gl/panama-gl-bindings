...
public class XGCValues {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        glx_h.C_INT.withName("function"),
        MemoryLayout.paddingLayout(4),
        glx_h.C_LONG.withName("plane_mask"),
        glx_h.C_LONG.withName("foreground"),
        glx_h.C_LONG.withName("background"),
        glx_h.C_INT.withName("line_width"),
        glx_h.C_INT.withName("line_style"),
        glx_h.C_INT.withName("cap_style"),
        glx_h.C_INT.withName("join_style"),
        glx_h.C_INT.withName("fill_style"),
        glx_h.C_INT.withName("fill_rule"),
        glx_h.C_INT.withName("arc_mode"),
        MemoryLayout.paddingLayout(4),
        glx_h.C_LONG.withName("tile"),
        glx_h.C_LONG.withName("stipple"),
        glx_h.C_INT.withName("ts_x_origin"),
        glx_h.C_INT.withName("ts_y_origin"),
        glx_h.C_LONG.withName("font"),
        glx_h.C_INT.withName("subwindow_mode"),
        glx_h.C_INT.withName("graphics_exposures"),
        glx_h.C_INT.withName("clip_x_origin"),
        glx_h.C_INT.withName("clip_y_origin"),
        glx_h.C_LONG.withName("clip_mask"),
        glx_h.C_INT.withName("dash_offset"),
        glx_h.C_CHAR.withName("dashes"),
