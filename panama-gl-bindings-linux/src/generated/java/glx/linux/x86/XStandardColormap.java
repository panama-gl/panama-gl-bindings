...
public class XStandardColormap {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glx_h.C_LONG.withName("red_max"),
        glx_h.C_LONG.withName("red_mult"),
        glx_h.C_LONG.withName("green_max"),
        glx_h.C_LONG.withName("green_mult"),
        glx_h.C_LONG.withName("blue_max"),
        glx_h.C_LONG.withName("blue_mult"),
        glx_h.C_LONG.withName("base_pixel"),
        glx_h.C_LONG.withName("visualid"),
        glx_h.C_LONG.withName("killid")
    ).withName("$anon$320:9");
