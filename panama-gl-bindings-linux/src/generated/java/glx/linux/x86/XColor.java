...
public class XColor {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        glx_h.C_LONG.withName("pixel"),
        glx_h.C_SHORT.withName("red"),
        glx_h.C_SHORT.withName("green"),
        glx_h.C_SHORT.withName("blue"),
        glx_h.C_CHAR.withName("flags"),
        glx_h.C_CHAR.withName("pad")
    ).withName("$anon$410:9");
