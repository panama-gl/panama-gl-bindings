...
public class XWMHints {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glx_h.C_INT.withName("input"),
        glx_h.C_INT.withName("initial_state"),
        glx_h.C_LONG.withName("icon_pixmap"),
        glx_h.C_LONG.withName("icon_window"),
        glx_h.C_INT.withName("icon_x"),
        glx_h.C_INT.withName("icon_y"),
        glx_h.C_LONG.withName("icon_mask"),
        glx_h.C_LONG.withName("window_group")
    ).withName("$anon$119:9");
