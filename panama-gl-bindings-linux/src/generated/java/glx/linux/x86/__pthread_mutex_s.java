...
public class __pthread_mutex_s {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        glx_h.C_INT.withName("__lock"),
        glx_h.C_INT.withName("__count"),
        glx_h.C_INT.withName("__owner"),
        glx_h.C_INT.withName("__nusers"),
        glx_h.C_INT.withName("__kind"),
        glx_h.C_SHORT.withName("__spins"),
        glx_h.C_SHORT.withName("__elision"),
