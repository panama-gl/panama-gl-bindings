...
public class XFontStruct {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glx_h.C_LONG.withName("fid"),
        glx_h.C_INT.withName("direction"),
        glx_h.C_INT.withName("min_char_or_byte2"),
        glx_h.C_INT.withName("max_char_or_byte2"),
        glx_h.C_INT.withName("min_byte1"),
        glx_h.C_INT.withName("max_byte1"),
        glx_h.C_INT.withName("all_chars_exist"),
        glx_h.C_INT.withName("default_char"),
        glx_h.C_INT.withName("n_properties"),
        glx_h.C_POINTER.withName("properties"),
        XCharStruct.layout().withName("min_bounds"),
        XCharStruct.layout().withName("max_bounds"),
        glx_h.C_POINTER.withName("per_char"),
        glx_h.C_INT.withName("ascent"),
        glx_h.C_INT.withName("descent")
