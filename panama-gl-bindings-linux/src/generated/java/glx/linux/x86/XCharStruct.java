...
public class XCharStruct {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        glx_h.C_SHORT.withName("lbearing"),
        glx_h.C_SHORT.withName("rbearing"),
        glx_h.C_SHORT.withName("width"),
        glx_h.C_SHORT.withName("ascent"),
        glx_h.C_SHORT.withName("descent"),
        glx_h.C_SHORT.withName("attributes")
