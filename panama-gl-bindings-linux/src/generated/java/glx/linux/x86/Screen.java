...
public class Screen {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glx_h.C_LONG.withName("root"),
        glx_h.C_INT.withName("width"),
        glx_h.C_INT.withName("height"),
        glx_h.C_INT.withName("mwidth"),
        glx_h.C_INT.withName("mheight"),
        glx_h.C_INT.withName("ndepths"),
        MemoryLayout.paddingLayout(4),
        glx_h.C_POINTER.withName("depths"),
        glx_h.C_INT.withName("root_depth"),
        MemoryLayout.paddingLayout(4),
        glx_h.C_POINTER.withName("root_visual"),
        glx_h.C_POINTER.withName("default_gc"),
        glx_h.C_LONG.withName("cmap"),
        glx_h.C_LONG.withName("white_pixel"),
        glx_h.C_LONG.withName("black_pixel"),
        glx_h.C_INT.withName("max_maps"),
        glx_h.C_INT.withName("min_maps"),
        glx_h.C_INT.withName("backing_store"),
        glx_h.C_INT.withName("save_unders"),
        glx_h.C_LONG.withName("root_input_mask")
    ).withName("$anon$257:9");
