...
public class XClientMessageEvent {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glx_h.C_LONG.withName("message_type"),
    ...
    public static class data {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
            MemoryLayout.sequenceLayout(20, glx_h.C_CHAR).withName("b"),
            MemoryLayout.sequenceLayout(10, glx_h.C_SHORT).withName("s"),
            MemoryLayout.sequenceLayout(5, glx_h.C_LONG).withName("l")
        ).withName("$anon$905:2");
