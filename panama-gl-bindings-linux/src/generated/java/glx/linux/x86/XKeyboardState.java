...
public class XKeyboardState {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        glx_h.C_INT.withName("key_click_percent"),
        glx_h.C_INT.withName("bell_percent"),
        glx_h.C_INT.withName("bell_pitch"),
        glx_h.C_INT.withName("bell_duration"),
        glx_h.C_LONG.withName("led_mask"),
        glx_h.C_INT.withName("global_auto_repeat"),
        MemoryLayout.sequenceLayout(32, glx_h.C_CHAR).withName("auto_repeats"),
