...
public class XWindowAttributes {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glx_h.C_INT.withName("map_installed"),
        glx_h.C_INT.withName("map_state"),
        glx_h.C_LONG.withName("all_event_masks"),
        glx_h.C_LONG.withName("your_event_mask"),
        glx_h.C_LONG.withName("do_not_propagate_mask"),
        glx_h.C_INT.withName("override_redirect"),
        MemoryLayout.paddingLayout(4),
        glx_h.C_POINTER.withName("screen")
    ).withName("$anon$308:9");
