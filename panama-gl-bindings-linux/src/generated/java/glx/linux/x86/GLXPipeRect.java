...
public class GLXPipeRect {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glx_h.C_INT.withName("srcXOrigin"),
        glx_h.C_INT.withName("srcYOrigin"),
        glx_h.C_INT.withName("srcWidth"),
        glx_h.C_INT.withName("srcHeight"),
        glx_h.C_INT.withName("destXOrigin"),
        glx_h.C_INT.withName("destYOrigin"),
        glx_h.C_INT.withName("destWidth"),
        glx_h.C_INT.withName("destHeight")
    ).withName("$anon$778:9");
