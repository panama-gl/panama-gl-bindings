...
public class __pthread_rwlock_arch_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        glx_h.C_INT.withName("__readers"),
        glx_h.C_INT.withName("__writers"),
        glx_h.C_INT.withName("__wrphase_futex"),
        glx_h.C_INT.withName("__writers_futex"),
        glx_h.C_INT.withName("__pad3"),
        glx_h.C_INT.withName("__pad4"),
        glx_h.C_INT.withName("__cur_writer"),
        glx_h.C_INT.withName("__shared"),
        glx_h.C_CHAR.withName("__rwelision"),
        MemoryLayout.sequenceLayout(7, glx_h.C_CHAR).withName("__pad1"),
        glx_h.C_LONG.withName("__pad2"),
        glx_h.C_INT.withName("__flags"),
