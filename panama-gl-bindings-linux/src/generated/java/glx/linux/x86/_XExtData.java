...
public class _XExtData {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        glx_h.C_INT.withName("number"),
        MemoryLayout.paddingLayout(4),
        glx_h.C_POINTER.withName("next"),
        glx_h.C_POINTER.withName("free_private"),
        glx_h.C_POINTER.withName("private_data")
    ).withName("_XExtData");
    ...
    public static class free_private {
        ...
        private static final MethodHandle UP$MH = glx_h.upcallHandle(free_private.Function.class, "apply", $DESC);
