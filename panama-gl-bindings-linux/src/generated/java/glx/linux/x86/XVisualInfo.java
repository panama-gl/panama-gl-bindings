...
public class XVisualInfo {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        glx_h.C_POINTER.withName("visual"),
        glx_h.C_LONG.withName("visualid"),
        glx_h.C_INT.withName("screen"),
        glx_h.C_INT.withName("depth"),
        glx_h.C_INT.withName("class"),
        MemoryLayout.paddingLayout(4),
        glx_h.C_LONG.withName("red_mask"),
        glx_h.C_LONG.withName("green_mask"),
        glx_h.C_LONG.withName("blue_mask"),
        glx_h.C_INT.withName("colormap_size"),
        glx_h.C_INT.withName("bits_per_rgb")
    ).withName("$anon$287:9");
