...
public class XCrossingEvent {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        glx_h.C_LONG.withName("subwindow"),
        glx_h.C_LONG.withName("time"),
        glx_h.C_INT.withName("x"),
        glx_h.C_INT.withName("y"),
        glx_h.C_INT.withName("x_root"),
        glx_h.C_INT.withName("y_root"),
        glx_h.C_INT.withName("mode"),
        glx_h.C_INT.withName("detail"),
        glx_h.C_INT.withName("same_screen"),
        glx_h.C_INT.withName("focus"),
        glx_h.C_INT.withName("state"),
        MemoryLayout.paddingLayout(4)
    ).withName("$anon$610:9");
