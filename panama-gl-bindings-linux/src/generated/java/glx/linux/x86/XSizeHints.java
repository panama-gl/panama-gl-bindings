...
public class XSizeHints {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        glx_h.C_LONG.withName("flags"),
        glx_h.C_INT.withName("x"),
        glx_h.C_INT.withName("y"),
        glx_h.C_INT.withName("width"),
        glx_h.C_INT.withName("height"),
        glx_h.C_INT.withName("min_width"),
        glx_h.C_INT.withName("min_height"),
        glx_h.C_INT.withName("max_width"),
        glx_h.C_INT.withName("max_height"),
        glx_h.C_INT.withName("width_inc"),
        glx_h.C_INT.withName("height_inc"),
        XSizeHints.min_aspect.layout().withName("min_aspect"),
        XSizeHints.min_aspect.layout().withName("max_aspect"),
        glx_h.C_INT.withName("base_width"),
        glx_h.C_INT.withName("base_height"),
