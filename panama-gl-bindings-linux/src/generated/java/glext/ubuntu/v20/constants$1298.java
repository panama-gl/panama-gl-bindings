...
class constants$1298 {
    ...
    static final MethodHandle PFNGLGETFRAGMENTMATERIALFVSGIXPROC$MH = RuntimeHelper.downcallHandle(
        constants$1298.PFNGLGETFRAGMENTMATERIALFVSGIXPROC$FUNC
    );
    ...
    static final MethodHandle PFNGLGETFRAGMENTMATERIALIVSGIXPROC$MH = RuntimeHelper.downcallHandle(
        constants$1298.PFNGLGETFRAGMENTMATERIALIVSGIXPROC$FUNC
    );
    ...
    static final MethodHandle PFNGLLIGHTENVISGIXPROC$MH = RuntimeHelper.downcallHandle(
        constants$1298.PFNGLLIGHTENVISGIXPROC$FUNC
    );
    static final FunctionDescriptor glFragmentColorMaterialSGIX$FUNC = FunctionDescriptor.ofVoid(
        Constants$root.C_INT$LAYOUT,
        Constants$root.C_INT$LAYOUT
    );
    static final MethodHandle glFragmentColorMaterialSGIX$MH = RuntimeHelper.downcallHandle(
        "glFragmentColorMaterialSGIX",
        constants$1298.glFragmentColorMaterialSGIX$FUNC
    );
}
