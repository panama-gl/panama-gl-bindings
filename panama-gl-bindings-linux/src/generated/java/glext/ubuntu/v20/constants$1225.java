...
class constants$1225 {
    ...
    static final MethodHandle PFNGLVERTEXATTRIBFORMATNVPROC$MH = RuntimeHelper.downcallHandle(
        constants$1225.PFNGLVERTEXATTRIBFORMATNVPROC$FUNC
    );
    ...
    static final MethodHandle PFNGLVERTEXATTRIBIFORMATNVPROC$MH = RuntimeHelper.downcallHandle(
        constants$1225.PFNGLVERTEXATTRIBIFORMATNVPROC$FUNC
    );
    ...
    static final MethodHandle PFNGLGETINTEGERUI64I_VNVPROC$MH = RuntimeHelper.downcallHandle(
        constants$1225.PFNGLGETINTEGERUI64I_VNVPROC$FUNC
    );
    static final FunctionDescriptor glBufferAddressRangeNV$FUNC = FunctionDescriptor.ofVoid(
        Constants$root.C_INT$LAYOUT,
        Constants$root.C_INT$LAYOUT,
        Constants$root.C_LONG_LONG$LAYOUT,
        Constants$root.C_LONG_LONG$LAYOUT
    );
    static final MethodHandle glBufferAddressRangeNV$MH = RuntimeHelper.downcallHandle(
        "glBufferAddressRangeNV",
        constants$1225.glBufferAddressRangeNV$FUNC
    );
}
