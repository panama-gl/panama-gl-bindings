...
class constants$1091 {
    ...
    static final MethodHandle PFNGLPROGRAMLOCALPARAMETERSI4IVNVPROC$MH = RuntimeHelper.downcallHandle(
        constants$1091.PFNGLPROGRAMLOCALPARAMETERSI4IVNVPROC$FUNC
    );
    ...
    static final MethodHandle PFNGLPROGRAMLOCALPARAMETERI4UINVPROC$MH = RuntimeHelper.downcallHandle(
        constants$1091.PFNGLPROGRAMLOCALPARAMETERI4UINVPROC$FUNC
    );
    ...
    static final MethodHandle PFNGLPROGRAMLOCALPARAMETERI4UIVNVPROC$MH = RuntimeHelper.downcallHandle(
        constants$1091.PFNGLPROGRAMLOCALPARAMETERI4UIVNVPROC$FUNC
    );
}
