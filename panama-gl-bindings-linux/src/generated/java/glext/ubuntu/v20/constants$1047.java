...
class constants$1047 {
    ...
    static final MethodHandle PFNGLPROGRAMUNIFORMHANDLEUI64VNVPROC$MH = RuntimeHelper.downcallHandle(
        constants$1047.PFNGLPROGRAMUNIFORMHANDLEUI64VNVPROC$FUNC
    );
    ...
    static final MethodHandle PFNGLISTEXTUREHANDLERESIDENTNVPROC$MH = RuntimeHelper.downcallHandle(
        constants$1047.PFNGLISTEXTUREHANDLERESIDENTNVPROC$FUNC
    );
    ...
    static final MethodHandle PFNGLISIMAGEHANDLERESIDENTNVPROC$MH = RuntimeHelper.downcallHandle(
        constants$1047.PFNGLISIMAGEHANDLERESIDENTNVPROC$FUNC
    );
    static final FunctionDescriptor glGetTextureHandleNV$FUNC = FunctionDescriptor.of(Constants$root.C_LONG_LONG$LAYOUT,
        Constants$root.C_INT$LAYOUT
    );
    static final MethodHandle glGetTextureHandleNV$MH = RuntimeHelper.downcallHandle(
        "glGetTextureHandleNV",
        constants$1047.glGetTextureHandleNV$FUNC
    );
}
