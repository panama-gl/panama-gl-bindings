...
public interface PFNGLTEXCOORD2HVNVPROC {
    ...
    static MemorySegment allocate(PFNGLTEXCOORD2HVNVPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLTEXCOORD2HVNVPROC.class, fi, constants$1104.PFNGLTEXCOORD2HVNVPROC$FUNC, session);
    }
    static PFNGLTEXCOORD2HVNVPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _v) -> {
            try {
                constants$1104.PFNGLTEXCOORD2HVNVPROC$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_v);
            } catch (Throwable ex$) {
