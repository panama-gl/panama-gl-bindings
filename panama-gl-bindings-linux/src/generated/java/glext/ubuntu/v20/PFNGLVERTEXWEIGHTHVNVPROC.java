...
public interface PFNGLVERTEXWEIGHTHVNVPROC {
    ...
    static MemorySegment allocate(PFNGLVERTEXWEIGHTHVNVPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLVERTEXWEIGHTHVNVPROC.class, fi, constants$1110.PFNGLVERTEXWEIGHTHVNVPROC$FUNC, session);
    }
    static PFNGLVERTEXWEIGHTHVNVPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _weight) -> {
            try {
                constants$1110.PFNGLVERTEXWEIGHTHVNVPROC$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_weight);
            } catch (Throwable ex$) {
