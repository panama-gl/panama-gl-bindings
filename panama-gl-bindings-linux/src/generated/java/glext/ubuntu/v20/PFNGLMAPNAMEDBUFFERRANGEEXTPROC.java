...
public interface PFNGLMAPNAMEDBUFFERRANGEEXTPROC {
    ...
    static MemorySegment allocate(PFNGLMAPNAMEDBUFFERRANGEEXTPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLMAPNAMEDBUFFERRANGEEXTPROC.class, fi, constants$829.PFNGLMAPNAMEDBUFFERRANGEEXTPROC$FUNC, session);
    }
    static PFNGLMAPNAMEDBUFFERRANGEEXTPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _buffer, long _offset, long _length, int _access) -> {
            try {
                return (java.lang.foreign.Addressable)(java.lang.foreign.MemoryAddress)constants$829.PFNGLMAPNAMEDBUFFERRANGEEXTPROC$MH.invokeExact((Addressable)symbol, _buffer, _offset, _length, _access);
            } catch (Throwable ex$) {
