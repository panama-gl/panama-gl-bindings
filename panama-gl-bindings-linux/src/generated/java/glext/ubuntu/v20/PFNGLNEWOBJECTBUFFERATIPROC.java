...
public interface PFNGLNEWOBJECTBUFFERATIPROC {
    ...
    static MemorySegment allocate(PFNGLNEWOBJECTBUFFERATIPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLNEWOBJECTBUFFERATIPROC.class, fi, constants$495.PFNGLNEWOBJECTBUFFERATIPROC$FUNC, session);
    }
    static PFNGLNEWOBJECTBUFFERATIPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _size, java.lang.foreign.MemoryAddress _pointer, int _usage) -> {
            try {
                return (int)constants$495.PFNGLNEWOBJECTBUFFERATIPROC$MH.invokeExact((Addressable)symbol, _size, (java.lang.foreign.Addressable)_pointer, _usage);
            } catch (Throwable ex$) {
