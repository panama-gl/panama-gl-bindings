...
class constants$1314 {
    ...
    static final MethodHandle PFNGLTAGSAMPLEBUFFERSGIXPROC$MH = RuntimeHelper.downcallHandle(
        constants$1314.PFNGLTAGSAMPLEBUFFERSGIXPROC$FUNC
    );
    static final FunctionDescriptor glTagSampleBufferSGIX$FUNC = FunctionDescriptor.ofVoid();
    static final MethodHandle glTagSampleBufferSGIX$MH = RuntimeHelper.downcallHandle(
        "glTagSampleBufferSGIX",
        constants$1314.glTagSampleBufferSGIX$FUNC
    );
    ...
    static final MethodHandle PFNGLCOLORTABLESGIPROC$MH = RuntimeHelper.downcallHandle(
        constants$1314.PFNGLCOLORTABLESGIPROC$FUNC
    );
    ...
    static final MethodHandle PFNGLCOLORTABLEPARAMETERFVSGIPROC$MH = RuntimeHelper.downcallHandle(
        constants$1314.PFNGLCOLORTABLEPARAMETERFVSGIPROC$FUNC
    );
}
