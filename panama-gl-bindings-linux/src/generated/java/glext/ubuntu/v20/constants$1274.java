...
class constants$1274 {
    ...
    static final MethodHandle PFNGLVIDEOCAPTURENVPROC$MH = RuntimeHelper.downcallHandle(
        constants$1274.PFNGLVIDEOCAPTURENVPROC$FUNC
    );
    ...
    static final MethodHandle PFNGLVIDEOCAPTURESTREAMPARAMETERIVNVPROC$MH = RuntimeHelper.downcallHandle(
        constants$1274.PFNGLVIDEOCAPTURESTREAMPARAMETERIVNVPROC$FUNC
    );
    ...
    static final MethodHandle PFNGLVIDEOCAPTURESTREAMPARAMETERFVNVPROC$MH = RuntimeHelper.downcallHandle(
        constants$1274.PFNGLVIDEOCAPTURESTREAMPARAMETERFVNVPROC$FUNC
    );
}
