...
class constants$1056 {
    ...
    static final MethodHandle PFNGLLISTDRAWCOMMANDSSTATESCLIENTNVPROC$MH = RuntimeHelper.downcallHandle(
        constants$1056.PFNGLLISTDRAWCOMMANDSSTATESCLIENTNVPROC$FUNC
    );
    ...
    static final MethodHandle PFNGLCOMMANDLISTSEGMENTSNVPROC$MH = RuntimeHelper.downcallHandle(
        constants$1056.PFNGLCOMMANDLISTSEGMENTSNVPROC$FUNC
    );
    ...
    static final MethodHandle PFNGLCOMPILECOMMANDLISTNVPROC$MH = RuntimeHelper.downcallHandle(
        constants$1056.PFNGLCOMPILECOMMANDLISTNVPROC$FUNC
    );
