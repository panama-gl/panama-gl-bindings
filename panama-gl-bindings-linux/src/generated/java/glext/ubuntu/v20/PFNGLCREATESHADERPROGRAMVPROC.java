...
public interface PFNGLCREATESHADERPROGRAMVPROC {
    ...
    static MemorySegment allocate(PFNGLCREATESHADERPROGRAMVPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFNGLCREATESHADERPROGRAMVPROC.class, fi, constants$286.PFNGLCREATESHADERPROGRAMVPROC$FUNC, session);
    }
    static PFNGLCREATESHADERPROGRAMVPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _type, int _count, java.lang.foreign.MemoryAddress _strings) -> {
            try {
                return (int)constants$286.PFNGLCREATESHADERPROGRAMVPROC$MH.invokeExact((Addressable)symbol, _type, _count, (java.lang.foreign.Addressable)_strings);
            } catch (Throwable ex$) {
