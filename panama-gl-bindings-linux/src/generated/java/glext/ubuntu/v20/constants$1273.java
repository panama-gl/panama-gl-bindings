...
class constants$1273 {
    ...
    static final MethodHandle PFNGLGETVIDEOCAPTURESTREAMIVNVPROC$MH = RuntimeHelper.downcallHandle(
        constants$1273.PFNGLGETVIDEOCAPTURESTREAMIVNVPROC$FUNC
    );
    ...
    static final MethodHandle PFNGLGETVIDEOCAPTURESTREAMFVNVPROC$MH = RuntimeHelper.downcallHandle(
        constants$1273.PFNGLGETVIDEOCAPTURESTREAMFVNVPROC$FUNC
    );
    ...
    static final MethodHandle PFNGLGETVIDEOCAPTURESTREAMDVNVPROC$MH = RuntimeHelper.downcallHandle(
        constants$1273.PFNGLGETVIDEOCAPTURESTREAMDVNVPROC$FUNC
    );
}
