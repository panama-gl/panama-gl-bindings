...
class constants$1081 {
    ...
    static final MethodHandle PFNGLCOVERAGEMODULATIONTABLENVPROC$MH = RuntimeHelper.downcallHandle(
        constants$1081.PFNGLCOVERAGEMODULATIONTABLENVPROC$FUNC
    );
    ...
    static final MethodHandle PFNGLGETCOVERAGEMODULATIONTABLENVPROC$MH = RuntimeHelper.downcallHandle(
        constants$1081.PFNGLGETCOVERAGEMODULATIONTABLENVPROC$FUNC
    );
    ...
    static final MethodHandle PFNGLCOVERAGEMODULATIONNVPROC$MH = RuntimeHelper.downcallHandle(
        constants$1081.PFNGLCOVERAGEMODULATIONNVPROC$FUNC
    );
    static final FunctionDescriptor glCoverageModulationTableNV$FUNC = FunctionDescriptor.ofVoid(
        Constants$root.C_INT$LAYOUT,
        Constants$root.C_POINTER$LAYOUT
    );
    static final MethodHandle glCoverageModulationTableNV$MH = RuntimeHelper.downcallHandle(
        "glCoverageModulationTableNV",
        constants$1081.glCoverageModulationTableNV$FUNC
    );
}
