...
class constants$1083 {
    ...
    static final MethodHandle PFNGLPROGRAMVERTEXLIMITNVPROC$MH = RuntimeHelper.downcallHandle(
        constants$1083.PFNGLPROGRAMVERTEXLIMITNVPROC$FUNC
    );
    ...
    static final MethodHandle PFNGLFRAMEBUFFERTEXTUREEXTPROC$MH = RuntimeHelper.downcallHandle(
        constants$1083.PFNGLFRAMEBUFFERTEXTUREEXTPROC$FUNC
    );
    ...
    static final MethodHandle PFNGLFRAMEBUFFERTEXTUREFACEEXTPROC$MH = RuntimeHelper.downcallHandle(
        constants$1083.PFNGLFRAMEBUFFERTEXTUREFACEEXTPROC$FUNC
    );
    static final FunctionDescriptor glProgramVertexLimitNV$FUNC = FunctionDescriptor.ofVoid(
        Constants$root.C_INT$LAYOUT,
        Constants$root.C_INT$LAYOUT
    );
    static final MethodHandle glProgramVertexLimitNV$MH = RuntimeHelper.downcallHandle(
        "glProgramVertexLimitNV",
        constants$1083.glProgramVertexLimitNV$FUNC
    );
}
