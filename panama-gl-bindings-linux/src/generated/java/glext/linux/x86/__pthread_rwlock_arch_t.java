...
public class __pthread_rwlock_arch_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        glext_h.C_INT.withName("__readers"),
        glext_h.C_INT.withName("__writers"),
        glext_h.C_INT.withName("__wrphase_futex"),
        glext_h.C_INT.withName("__writers_futex"),
        glext_h.C_INT.withName("__pad3"),
        glext_h.C_INT.withName("__pad4"),
        glext_h.C_INT.withName("__cur_writer"),
        glext_h.C_INT.withName("__shared"),
        glext_h.C_CHAR.withName("__rwelision"),
        MemoryLayout.sequenceLayout(7, glext_h.C_CHAR).withName("__pad1"),
        glext_h.C_LONG.withName("__pad2"),
        glext_h.C_INT.withName("__flags"),
