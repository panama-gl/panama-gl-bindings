...
public class __pthread_mutex_s {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        glext_h.C_INT.withName("__lock"),
        glext_h.C_INT.withName("__count"),
        glext_h.C_INT.withName("__owner"),
        glext_h.C_INT.withName("__nusers"),
        glext_h.C_INT.withName("__kind"),
        glext_h.C_SHORT.withName("__spins"),
        glext_h.C_SHORT.withName("__elision"),
