...
public class drand48_data {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(3, glext_h.C_SHORT).withName("__x"),
        MemoryLayout.sequenceLayout(3, glext_h.C_SHORT).withName("__old_x"),
        glext_h.C_SHORT.withName("__c"),
        glext_h.C_SHORT.withName("__init"),
        glext_h.C_LONG_LONG.withName("__a")
