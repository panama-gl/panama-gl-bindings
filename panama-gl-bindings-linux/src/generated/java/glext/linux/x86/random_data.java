...
public class random_data {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        glext_h.C_POINTER.withName("fptr"),
        glext_h.C_POINTER.withName("rptr"),
        glext_h.C_POINTER.withName("state"),
        glext_h.C_INT.withName("rand_type"),
        glext_h.C_INT.withName("rand_deg"),
        glext_h.C_INT.withName("rand_sep"),
        MemoryLayout.paddingLayout(4),
        glext_h.C_POINTER.withName("end_ptr")
